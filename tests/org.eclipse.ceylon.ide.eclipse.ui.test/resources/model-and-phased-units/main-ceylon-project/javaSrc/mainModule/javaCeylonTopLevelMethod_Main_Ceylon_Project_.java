...
@Ceylon(major = 8) 
@Method
public class javaCeylonTopLevelMethod_Main_Ceylon_Project_ {

	private javaCeylonTopLevelMethod_Main_Ceylon_Project_() {}

    public static void javaCeylonTopLevelMethod_Main_Ceylon_Project() {
    }
