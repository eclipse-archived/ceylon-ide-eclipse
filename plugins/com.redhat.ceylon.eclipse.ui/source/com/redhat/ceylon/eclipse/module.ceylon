...
module com.redhat.ceylon.eclipse "1.3.3" {
    shared import com.redhat.ceylon.model "1.3.3";
    shared import com.redhat.ceylon.typechecker "1.3.3";
    shared import com.redhat.ceylon.compiler.java "1.3.3";
    shared import com.redhat.ceylon.compiler.js "1.3.3";
    shared import "com.redhat.ceylon.module-resolver" "1.3.3";
    shared import ceylon.runtime  "1.3.3";
    shared import ceylon.bootstrap  "1.3.3";
    shared import ceylon.collection "1.3.3";
    shared import ceylon.formatter "1.3.3";
    shared import ceylon.interop.java "1.3.3";
    shared import java.base "7";
    shared import java.compiler "7";
    shared import javax.xml "7";
    shared import com.redhat.ceylon.ide.common "1.3.3";
    shared import com.redhat.ceylon.eclipseDependencies "1.3.3";
    shared import com.redhat.ceylon.dist "1.3.3";
    ...
    shared import ceylon.tool.converter.java2ceylon "1.3.3";
