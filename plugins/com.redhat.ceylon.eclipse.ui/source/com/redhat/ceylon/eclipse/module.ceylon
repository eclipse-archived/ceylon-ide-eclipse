...
module com.redhat.ceylon.eclipse "1.3.1" {
    shared import com.redhat.ceylon.model "1.3.1";
    shared import com.redhat.ceylon.typechecker "1.3.1";
    shared import com.redhat.ceylon.compiler.java "1.3.1";
    shared import com.redhat.ceylon.compiler.js "1.3.1";
    shared import "com.redhat.ceylon.module-resolver" "1.3.1";
    shared import ceylon.runtime  "1.3.1";
    shared import ceylon.bootstrap  "1.3.1";
    shared import ceylon.collection "1.3.1";
    shared import ceylon.formatter "1.3.1";
    ...
    shared import ceylon.tool.converter.java2ceylon "1.3.1";
