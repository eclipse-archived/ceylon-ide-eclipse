...
module com.redhat.ceylon.eclipse "1.3.2" {
    shared import com.redhat.ceylon.model "1.3.2-SNAPSHOT";
    ...
    shared import ceylon.runtime  "1.3.2-SNAPSHOT";
    shared import ceylon.bootstrap  "1.3.2-SNAPSHOT";
    shared import ceylon.collection "1.3.2-SNAPSHOT";
    shared import ceylon.formatter "1.3.2-SNAPSHOT";
    shared import ceylon.interop.java "1.3.2-SNAPSHOT";
    shared import java.base "7";
    shared import java.compiler "7";
    shared import javax.xml "7";
    shared import com.redhat.ceylon.ide.common "1.3.2-SNAPSHOT";
    ...
    shared import ceylon.tool.converter.java2ceylon "1.3.2-SNAPSHOT";
