...
by("David Festal")
native("jvm")
module com.redhat.ceylon.eclipse "1.3.1" {
    shared import com.redhat.ceylon.model "1.3.1-SNAPSHOT";
    shared import com.redhat.ceylon.typechecker "1.3.1-SNAPSHOT";
    shared import com.redhat.ceylon.compiler.java "1.3.1-SNAPSHOT";
    shared import com.redhat.ceylon.compiler.js "1.3.1-SNAPSHOT";
    shared import "com.redhat.ceylon.module-resolver" "1.3.1-SNAPSHOT";
    shared import ceylon.runtime  "1.3.1-SNAPSHOT";
    shared import ceylon.bootstrap  "1.3.1-SNAPSHOT";
    shared import ceylon.collection "1.3.1-SNAPSHOT";
    shared import ceylon.formatter "1.3.1-SNAPSHOT";
    ...
    shared import com.redhat.ceylon.eclipseDependencies "1.3.1";
    shared import com.redhat.ceylon.dist "1.3.1-SNAPSHOT";
