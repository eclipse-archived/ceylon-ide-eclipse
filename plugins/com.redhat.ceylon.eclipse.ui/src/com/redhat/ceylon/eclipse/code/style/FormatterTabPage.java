...
public abstract class FormatterTabPage implements IModifyDialogTabPage {
    ...
    protected abstract class Preference extends Observable {
        ...
        /**
         * To be implemented in subclasses. Update the SWT widgets when the
         * state of this object has changed (enabled, key, ...).
         */
    ...
    protected class ButtonPreference extends Preference {
         ...
         * @param values
         *            An array of two elements indicating the values to store on
         *            unchecked/checked.
         * @param text
    ...
    protected final class ComboPreference extends Preference {
         ...
         *            The key to store the values.
         * @param values
         *            An array of n elements indicating the values to store for
         *            each selection.
         * @param text
         *            The label text for this Preference.
         * @param items
         *            An array of n elements indicating the text to be written
         *            in the combo box.
         */
    ...
    protected final class NumberPreference extends Preference {
        ...
        public NumberPreference(Composite composite, int numColumns,
                FormatterPreferences workingValues, String key, int minValue,
                int maxValue, String text) {
            super(workingValues, key);
    ...
    protected final class StringPreference extends Preference {
         ...
         *            the composite on which the SWT widgets are added.
         * @param numColumns
         *            the number of columns in the composite's
         *            {@link GridLayout}
         * @param workingValues
         *            the map to store the values.
         * @param key
     ...
     * focus over multiple modify sessions. Each FormatterTabPage has its own
    ...
    /*
     * Create a new <code>FormatterTabPage</code>
     */
    ...
    /**
     * This method is called after all controls have been allocated, including
    ...
    protected Group createGroup(int numColumns, Composite parent, String text) {
        ...
        // layout.marginHeight=
        // fPixelConverter.convertVerticalDLUsToPixels(IDialogConstants.VERTICAL_MARGIN);
        // layout.marginWidth=
    ...
    protected NumberPreference createNumberPref(Composite composite,
        ...
        final NumberPreference pref = new NumberPreference(composite,
                numColumns, workingValues, key, minValue, maxValue, name);
