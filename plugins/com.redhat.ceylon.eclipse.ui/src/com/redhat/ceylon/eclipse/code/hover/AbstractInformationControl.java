...
public abstract class AbstractInformationControl implements IInformationControl, 
	 ...
	 */
	public AbstractInformationControl(Shell parentShell, ToolBarManager toolBarManager, Color color) {
		this(parentShell, SWT.TOOL | SWT.ON_TOP | SWT.RESIZE, null, toolBarManager, color);
	}
	 ...
	 */
	public AbstractInformationControl(Shell parentShell, boolean isResizable, Color color) {
		this(parentShell, SWT.TOOL | SWT.ON_TOP | (isResizable ? SWT.RESIZE : 0), null, null, color);
	}
	 ...
	 *
	 */
	private AbstractInformationControl(Shell parentShell, int shellStyle, final String statusFieldText, 
			final ToolBarManager toolBarManager, Color color) {
