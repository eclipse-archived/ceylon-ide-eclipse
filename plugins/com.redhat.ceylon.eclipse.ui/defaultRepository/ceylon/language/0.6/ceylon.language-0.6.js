...
Iterable.$$metamodel$$={mod:$$METAMODEL$$,$tp:{Element:{'var':'out',},Absent:{'var':'out','satisfies':[{t:Null}],'def':{t:Null}}},satisfies:[{t:Container,a:{Absent:'Absent',Element:'Element'}}],$an:function(){return[see([Collection].reifyCeylonType({Absent:{t:Null},Element:{t:Anything}})),by([String$("Gavin",5)].reifyCeylonType({Absent:{t:Null},Element:{t:String$}})),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Iterable']};
...
function $init$Iterable(){
    if (Iterable.$$===undefined){
        ...
        (function($$iterable){
            ...
            $$iterable.$map.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:Iterable,a:{Absent:'Absent',Element:'Result'}},$ps:[{$nm:'collecting',$mt:'prm',$t:'Result'}],$tp:{Result:{}},$an:function(){return[see([$$iterable.collect].reifyCeylonType({Absent:{t:Null},Element:{t:Anything}})),shared(),$default()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Iterable']['$m']['map']};
            ...
            $$iterable.$sort.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:Sequential,a:{Element:'Element'}},$ps:[{$nm:'comparing',$mt:'prm',$t:{t:Comparison}}],$an:function(){return[see([byIncreasing,byDecreasing].reifyCeylonType({Absent:{t:Null},Element:{t:Anything}})),shared(),$default()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Iterable']['$m']['sort']};
            ...
            $$iterable.collect.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:Sequential,a:{Element:'Result'}},$ps:[{$nm:'collecting',$mt:'prm',$t:'Result'}],$tp:{Result:{}},$an:function(){return[see([$$iterable.$map].reifyCeylonType({Absent:{t:Null},Element:{t:Anything}})),shared(),$default()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Iterable']['$m']['collect']};
...
Empty.$$metamodel$$={mod:$$METAMODEL$$,satisfies:[{t:Sequential,a:{Element:{t:Nothing}}},{t:Ranged,a:{Index:{t:Integer},Span:{t:Empty}}},{t:Cloneable,a:{Clone:{t:Empty}}}],$an:function(){return[see([Sequence].reifyCeylonType({Absent:{t:Null},Element:{t:Anything}})),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Empty']};
exports.Empty=Empty;
function $init$Empty(){
    if (Empty.$$===undefined){
...
Correspondence.$$metamodel$$={mod:$$METAMODEL$$,$tp:{Key:{'var':'in','satisfies':[{t:Object$}]},Item:{'var':'out',}},satisfies:[],$an:function(){return[see([Map,List,Category].reifyCeylonType({Absent:{t:Null},Element:{ t:'u', l:[{t:Anything},{t:Anything}]}})),by([String$("Gavin",5)].reifyCeylonType({Absent:{t:Null},Element:{t:String$}})),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Correspondence']};
...
function $init$Correspondence(){
    if (Correspondence.$$===undefined){
        ...
        (function($$correspondence){
            ...
            };$$correspondence.definesAny.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:Boolean$},$ps:[{$nm:'keys',$mt:'prm',$t:{t:Iterable,a:{Absent:{t:Null},Element:'Key'}}}],$an:function(){return[see([$JsCallable($$correspondence.defines,[{$nm:'key',$mt:'prm',$t:'Key'}],{Arguments:{t:Tuple,a:{Rest:{t:Empty},First:$$correspondence.$$targs$$.Key,Element:$$correspondence.$$targs$$.Key}},Return:{t:Boolean$}})].reifyCeylonType({Absent:{t:Null},Element:{t:Callable,a:{Arguments:{t:Tuple,a:{Rest:{t:Empty},First:$$correspondence.$$targs$$.Key,Element:$$correspondence.$$targs$$.Key}},Return:{t:Boolean$}}}})),shared(),$default()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Correspondence']['$m']['definesAny']};$$correspondence.items=function (keys$199){
                var $$correspondence=this;
                return Comprehension(function(){
...
Finished.$$metamodel$$={mod:$$METAMODEL$$,'super':{t:Basic},satisfies:[],$an:function(){return[see([Iterator].reifyCeylonType({Absent:{t:Null},Element:{t:Anything}})),shared(),abstract()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Finished']};
...
Ranged.$$metamodel$$={mod:$$METAMODEL$$,$tp:{Index:{'var':'in','satisfies':[{t:Comparable,a:{Other:'Index'}}]},Span:{'var':'out',}},satisfies:[],$an:function(){return[see([List,Sequence,$JsCallable(String,[],{Arguments:{t:Tuple,a:{Rest:{t:Empty},First:{t:String$},Element:{t:String$}}},Return:{t:String$}})].reifyCeylonType({Absent:{t:Null},Element:{t:Anything}})),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Ranged']};
...
Container.$$metamodel$$={mod:$$METAMODEL$$,$tp:{Element:{'var':'out',},Absent:{'var':'out','satisfies':[{t:Null}],'def':{t:Null}}},satisfies:[{t:Category}],$an:function(){return[see([Category].reifyCeylonType({Absent:{t:Null},Element:{t:Anything}})),by([String$("Gavin",5)].reifyCeylonType({Absent:{t:Null},Element:{t:String$}})),deprecated(String$("Will be removed in Ceylon 1.0.",30)),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Container']};
...
Iterator.$$metamodel$$={mod:$$METAMODEL$$,$tp:{Element:{'var':'out',}},satisfies:[],$an:function(){return[see([Iterable].reifyCeylonType({Absent:{t:Null},Element:{t:Anything}})),by([String$("Gavin",5)].reifyCeylonType({Absent:{t:Null},Element:{t:String$}})),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Iterator']};
...
Category.$$metamodel$$={mod:$$METAMODEL$$,satisfies:[],$an:function(){return[see([].reifyCeylonType({Absent:{t:Null},Element:{t:Anything}})),by([String$("Gavin",5)].reifyCeylonType({Absent:{t:Null},Element:{t:String$}})),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Category']};
...
function $init$Category(){
    if (Category.$$===undefined){
        ...
        (function($$category){
            ...
            };$$category.containsAny.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:Boolean$},$ps:[{$nm:'elements',$mt:'prm',$t:{t:Iterable,a:{Absent:{t:Null},Element:{t:Object$}}}}],$an:function(){return[see([$JsCallable($$category.contains,[{$nm:'element',$mt:'prm',$t:{t:Object$}}],{Arguments:{t:Tuple,a:{Rest:{t:Empty},First:{t:Object$},Element:{t:Object$}}},Return:{t:Boolean$}})].reifyCeylonType({Absent:{t:Null},Element:{t:Callable,a:{Arguments:{t:Tuple,a:{Rest:{t:Empty},First:{t:Object$},Element:{t:Object$}}},Return:{t:Boolean$}}}})),shared(),$default()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Category']['$m']['containsAny']};
        })(Category.$$.prototype);
    }
    return Category;
}
    ...
    if (List.$$===undefined){
        ...
        (function($$list){
            ...
            defineAttr($$list,'last',function()/*anotaciones:ceylon.language::Shared,ceylon.language::Actual,ceylon.language::Default,*/{
                ...
                return seq$245;
            };$$list.withLeading.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:Sequence,a:{Element:{ t:'u', l:['Element','Other']}}},$ps:[{$nm:'element',$mt:'prm',$t:'Other'}],$tp:{Other:{}},$an:function(){return[see([$$list.following].reifyCeylonType({Absent:{t:Null},Element:{t:Anything}})),shared(),$default()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['List']['$m']['withLeading']};$$list.withTrailing=function withTrailing(element$246,$$$mptypes){
                var $$list=this;
...
InitializationException.$$metamodel$$={mod:$$METAMODEL$$,'super':{t:Exception},satisfies:[],$an:function(){return[see([$JsCallable(late,[],{Arguments:{t:Empty},Return:{t:Late}})].reifyCeylonType({Absent:{t:Null},Element:{t:Callable,a:{Arguments:{t:Empty},Return:{t:Late}}}})),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['InitializationException']};
...
;
byDecreasing.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:Comparison},$ps:[{$nm:'comparable',$mt:'prm',$t:'Value'}],$tp:{Element:{},Value:{'satisfies':[{t:Comparable,a:{Other:'Value'}}]}},$an:function(){return[see([byIncreasing].reifyCeylonType({Absent:{t:Null},Element:{t:Anything}})),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['byDecreasing']};
...
;
byIncreasing.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:Comparison},$ps:[{$nm:'comparable',$mt:'prm',$t:'Value'}],$tp:{Element:{},Value:{'satisfies':[{t:Comparable,a:{Other:'Value'}}]}},$an:function(){return[see([byDecreasing].reifyCeylonType({Absent:{t:Null},Element:{t:Anything}})),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['byIncreasing']};
...
;
byItem.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:Comparison},$ps:[{$nm:'comparing',$mt:'prm',$t:{t:Comparison}}],$tp:{Item:{'satisfies':[{t:Object$}]}},$an:function(){return[see([byKey].reifyCeylonType({Absent:{t:Null},Element:{t:Anything}})),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['byItem']};
...
;
byKey.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:Comparison},$ps:[{$nm:'comparing',$mt:'prm',$t:{t:Comparison}}],$tp:{Key:{'satisfies':[{t:Object$}]}},$an:function(){return[see([byItem].reifyCeylonType({Absent:{t:Null},Element:{t:Anything}})),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['byKey']};
exports.byKey=byKey;
...
;
forItem.$$metamodel$$={mod:$$METAMODEL$$,$t:'Result',$ps:[{$nm:'resulting',$mt:'prm',$t:'Result'}],$tp:{Item:{'satisfies':[{t:Object$}]},Result:{}},$an:function(){return[see([forKey].reifyCeylonType({Absent:{t:Null},Element:{t:Anything}})),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['forItem']};
...
;
forKey.$$metamodel$$={mod:$$METAMODEL$$,$t:'Result',$ps:[{$nm:'resulting',$mt:'prm',$t:'Result'}],$tp:{Key:{'satisfies':[{t:Object$}]},Result:{}},$an:function(){return[see([forItem].reifyCeylonType({Absent:{t:Null},Element:{t:Anything}})),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['forKey']};
...
largest.$$metamodel$$={mod:$$METAMODEL$$,$t:'Element',$ps:[{$nm:'x',$mt:'prm',$t:'Element'},{$nm:'y',$mt:'prm',$t:'Element'}],$tp:{Element:{'satisfies':[{t:Comparable,a:{Other:'Element'}}]}},$an:function(){return[see([Comparable,smallest,max].reifyCeylonType({Absent:{t:Null},Element:{t:Anything}})),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['largest']};
...
smallest.$$metamodel$$={mod:$$METAMODEL$$,$t:'Element',$ps:[{$nm:'x',$mt:'prm',$t:'Element'},{$nm:'y',$mt:'prm',$t:'Element'}],$tp:{Element:{'satisfies':[{t:Comparable,a:{Other:'Element'}}]}},$an:function(){return[see([Comparable,largest,min].reifyCeylonType({Absent:{t:Null},Element:{t:Anything}})),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['smallest']};
...
plus.$$metamodel$$={mod:$$METAMODEL$$,$t:'Value',$ps:[{$nm:'x',$mt:'prm',$t:'Value'},{$nm:'y',$mt:'prm',$t:'Value'}],$tp:{Value:{'satisfies':[{t:Summable,a:{Other:'Value'}}]}},$an:function(){return[see([times,sum].reifyCeylonType({Absent:{t:Null},Element:{t:Anything}})),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['plus']};
exports.plus=plus;
var times=function (x$680,y$681,$$$mptypes){
    return x$680.times(y$681);
};
times.$$metamodel$$={mod:$$METAMODEL$$,$t:'Value',$ps:[{$nm:'x',$mt:'prm',$t:'Value'},{$nm:'y',$mt:'prm',$t:'Value'}],$tp:{Value:{'satisfies':[{t:Numeric,a:{Other:'Value'}}]}},$an:function(){return[see([plus,product].reifyCeylonType({Absent:{t:Null},Element:{t:Anything}})),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['times']};
exports.times=times;
