...
$init$Variable();
function ProducedType($$producedType){
}
exports.ProducedType=ProducedType;
function $init$ProducedType(){
    if (ProducedType.$$===undefined){
        initTypeProto(ProducedType,'ceylon.language.metamodel::ProducedType');
    }
    ProducedType.$$metamodel$$={$nm:'ProducedType',$mt:'ifc','satisfies':[]};
    return ProducedType;
}
exports.$init$ProducedType=$init$ProducedType;
$init$ProducedType();
function AppliedProducedType($$appliedProducedType){
}
exports.AppliedProducedType=AppliedProducedType;
function $init$AppliedProducedType(){
    if (AppliedProducedType.$$===undefined){
        initTypeProto(AppliedProducedType,'ceylon.language.metamodel::AppliedProducedType');
    }
    AppliedProducedType.$$metamodel$$={$nm:'AppliedProducedType',$mt:'ifc','satisfies':[]};
    return AppliedProducedType;
}
exports.$init$AppliedProducedType=$init$AppliedProducedType;
$init$AppliedProducedType();
function TypeParameterType($$typeParameterType){
    ProducedType($$typeParameterType);
}
exports.TypeParameterType=TypeParameterType;
function $init$TypeParameterType(){
    if (TypeParameterType.$$===undefined){
        initTypeProto(TypeParameterType,'ceylon.language.metamodel::TypeParameterType',$init$ProducedType());
        (function($$typeParameterType){
        })(TypeParameterType.$$.prototype);
    }
    TypeParameterType.$$metamodel$$={$nm:'TypeParameterType',$mt:'ifc','satisfies':[{t:ProducedType}]};
    return TypeParameterType;
}
exports.$init$TypeParameterType=$init$TypeParameterType;
$init$TypeParameterType();
function ClassOrInterfaceType($$classOrInterfaceType){
    ProducedType($$classOrInterfaceType);
}
exports.ClassOrInterfaceType=ClassOrInterfaceType;
function $init$ClassOrInterfaceType(){
    if (ClassOrInterfaceType.$$===undefined){
        initTypeProto(ClassOrInterfaceType,'ceylon.language.metamodel::ClassOrInterfaceType',$init$ProducedType());
        (function($$classOrInterfaceType){
        })(ClassOrInterfaceType.$$.prototype);
    }
    ClassOrInterfaceType.$$metamodel$$={$nm:'ClassOrInterfaceType',$mt:'ifc','satisfies':[{t:ProducedType}]};
    return ClassOrInterfaceType;
}
exports.$init$ClassOrInterfaceType=$init$ClassOrInterfaceType;
$init$ClassOrInterfaceType();
...
function $init$ClassType(){
    if (ClassType.$$===undefined){
        initTypeProto(ClassType,'ceylon.language.metamodel::ClassType',$init$ClassOrInterfaceType());
        (function($$classType){
        })(ClassType.$$.prototype);
    }
    ClassType.$$metamodel$$={$nm:'ClassType',$mt:'ifc','satisfies':[{t:ClassOrInterfaceType}]};
    return ClassType;
}
exports.$init$ClassType=$init$ClassType;
$init$ClassType();
function InterfaceType($$interfaceType){
    ClassOrInterfaceType($$interfaceType);
}
exports.InterfaceType=InterfaceType;
function $init$InterfaceType(){
    if (InterfaceType.$$===undefined){
        initTypeProto(InterfaceType,'ceylon.language.metamodel::InterfaceType',$init$ClassOrInterfaceType());
        (function($$interfaceType){
        })(InterfaceType.$$.prototype);
    }
    InterfaceType.$$metamodel$$={$nm:'InterfaceType',$mt:'ifc','satisfies':[{t:ClassOrInterfaceType}]};
    return InterfaceType;
}
exports.$init$InterfaceType=$init$InterfaceType;
$init$InterfaceType();
...
function $init$UnionType(){
    if (UnionType.$$===undefined){
        initTypeProto(UnionType,'ceylon.language.metamodel::UnionType',$init$ProducedType());
        (function($$unionType){
        })(UnionType.$$.prototype);
    }
    UnionType.$$metamodel$$={$nm:'UnionType',$mt:'ifc','satisfies':[{t:ProducedType}]};
    return UnionType;
}
exports.$init$UnionType=$init$UnionType;
$init$UnionType();
function IntersectionType($$intersectionType){
    ProducedType($$intersectionType);
}
exports.IntersectionType=IntersectionType;
function $init$IntersectionType(){
    if (IntersectionType.$$===undefined){
        initTypeProto(IntersectionType,'ceylon.language.metamodel::IntersectionType',$init$ProducedType());
        (function($$intersectionType){
        })(IntersectionType.$$.prototype);
    }
    IntersectionType.$$metamodel$$={$nm:'IntersectionType',$mt:'ifc','satisfies':[{t:ProducedType}]};
    return IntersectionType;
}
exports.$init$IntersectionType=$init$IntersectionType;
$init$IntersectionType();
function nothingType$696(){
    var $$nothingType=new nothingType$696.$$;
    ProducedType($$nothingType);
    return $$nothingType;
}
function $init$nothingType$696(){
    if (nothingType$696.$$===undefined){
        initTypeProto(nothingType$696,'ceylon.language.metamodel::nothingType',Basic,$init$ProducedType());
    }
    nothingType$696.$$metamodel$$={$nm:'nothingType',$mt:'cls','super':{t:.Basic},'satisfies':[{t:ProducedType}]};
    return nothingType$696;
}
exports.$init$nothingType$696=$init$nothingType$696;
$init$nothingType$696();
var nothingType$697=nothingType$696();
var getNothingType=function(){
    return nothingType$697;
}
exports.getNothingType=getNothingType;
function AppliedClassOrInterfaceType($$appliedClassOrInterfaceType){
    AppliedProducedType($$appliedClassOrInterfaceType);
}
exports.AppliedClassOrInterfaceType=AppliedClassOrInterfaceType;
function $init$AppliedClassOrInterfaceType(){
    if (AppliedClassOrInterfaceType.$$===undefined){
        initTypeProto(AppliedClassOrInterfaceType,'ceylon.language.metamodel::AppliedClassOrInterfaceType',$init$AppliedProducedType());
        (function($$appliedClassOrInterfaceType){
        })(AppliedClassOrInterfaceType.$$.prototype);
    }
    AppliedClassOrInterfaceType.$$metamodel$$={$nm:'AppliedClassOrInterfaceType',$mt:'ifc',$tp:{Type:{'var':'out',}},'satisfies':[{t:AppliedProducedType}]};
    return AppliedClassOrInterfaceType;
}
exports.$init$AppliedClassOrInterfaceType=$init$AppliedClassOrInterfaceType;
$init$AppliedClassOrInterfaceType();
function AppliedClassType($$appliedClassType){
    AppliedClassOrInterfaceType($$appliedClassType);
    Callable($$appliedClassType);
}
exports.AppliedClassType=AppliedClassType;
function $init$AppliedClassType(){
    if (AppliedClassType.$$===undefined){
        initTypeProto(AppliedClassType,'ceylon.language.metamodel::AppliedClassType',$init$AppliedClassOrInterfaceType(),$init$Callable());
        (function($$appliedClassType){
        })(AppliedClassType.$$.prototype);
    }
    AppliedClassType.$$metamodel$$={$nm:'AppliedClassType',$mt:'ifc',$tp:{Type:{'var':'out',},Arguments:{'var':'in','satisfies':[{t:.Sequential}]}},'satisfies':[{t:AppliedClassOrInterfaceType},{t:.Callable}]};
    return AppliedClassType;
}
exports.$init$AppliedClassType=$init$AppliedClassType;
$init$AppliedClassType();
function AppliedInterfaceType($$appliedInterfaceType){
    AppliedClassOrInterfaceType($$appliedInterfaceType);
}
exports.AppliedInterfaceType=AppliedInterfaceType;
function $init$AppliedInterfaceType(){
    if (AppliedInterfaceType.$$===undefined){
        initTypeProto(AppliedInterfaceType,'ceylon.language.metamodel::AppliedInterfaceType',$init$AppliedClassOrInterfaceType());
        (function($$appliedInterfaceType){
        })(AppliedInterfaceType.$$.prototype);
    }
    AppliedInterfaceType.$$metamodel$$={$nm:'AppliedInterfaceType',$mt:'ifc',$tp:{Type:{'var':'out',}},'satisfies':[{t:AppliedClassOrInterfaceType}]};
    return AppliedInterfaceType;
}
exports.$init$AppliedInterfaceType=$init$AppliedInterfaceType;
$init$AppliedInterfaceType();
function AppliedUnionType($$appliedUnionType){
    AppliedProducedType($$appliedUnionType);
}
exports.AppliedUnionType=AppliedUnionType;
function $init$AppliedUnionType(){
    if (AppliedUnionType.$$===undefined){
        initTypeProto(AppliedUnionType,'ceylon.language.metamodel::AppliedUnionType',$init$AppliedProducedType());
        (function($$appliedUnionType){
        })(AppliedUnionType.$$.prototype);
    }
    AppliedUnionType.$$metamodel$$={$nm:'AppliedUnionType',$mt:'ifc','satisfies':[{t:AppliedProducedType}]};
    return AppliedUnionType;
}
exports.$init$AppliedUnionType=$init$AppliedUnionType;
$init$AppliedUnionType();
function AppliedIntersectionType($$appliedIntersectionType){
    AppliedProducedType($$appliedIntersectionType);
}
exports.AppliedIntersectionType=AppliedIntersectionType;
function $init$AppliedIntersectionType(){
    if (AppliedIntersectionType.$$===undefined){
        initTypeProto(AppliedIntersectionType,'ceylon.language.metamodel::AppliedIntersectionType',$init$AppliedProducedType());
        (function($$appliedIntersectionType){
        })(AppliedIntersectionType.$$.prototype);
    }
    AppliedIntersectionType.$$metamodel$$={$nm:'AppliedIntersectionType',$mt:'ifc','satisfies':[{t:AppliedProducedType}]};
    return AppliedIntersectionType;
}
exports.$init$AppliedIntersectionType=$init$AppliedIntersectionType;
$init$AppliedIntersectionType();
function appliedNothingType$698(){
    var $$appliedNothingType=new appliedNothingType$698.$$;
    AppliedProducedType($$appliedNothingType);
    return $$appliedNothingType;
}
function $init$appliedNothingType$698(){
    if (appliedNothingType$698.$$===undefined){
        initTypeProto(appliedNothingType$698,'ceylon.language.metamodel::appliedNothingType',Basic,$init$AppliedProducedType());
    }
    appliedNothingType$698.$$metamodel$$={$nm:'appliedNothingType',$mt:'cls','super':{t:.Basic},'satisfies':[{t:AppliedProducedType}]};
    return appliedNothingType$698;
}
exports.$init$appliedNothingType$698=$init$appliedNothingType$698;
$init$appliedNothingType$698();
var appliedNothingType$699=appliedNothingType$698();
var getAppliedNothingType=function(){
    return appliedNothingType$699;
}
exports.getAppliedNothingType=getAppliedNothingType;
function AppliedFunction($$appliedFunction){
    Callable($$appliedFunction);
}
exports.AppliedFunction=AppliedFunction;
function $init$AppliedFunction(){
    if (AppliedFunction.$$===undefined){
        initTypeProto(AppliedFunction,'ceylon.language.metamodel::AppliedFunction',$init$Callable());
        (function($$appliedFunction){
        })(AppliedFunction.$$.prototype);
    }
    AppliedFunction.$$metamodel$$={$nm:'AppliedFunction',$mt:'ifc',$tp:{Type:{'var':'out',},Arguments:{'var':'in','satisfies':[{t:.Sequential}]}},'satisfies':[{t:.Callable}]};
    return AppliedFunction;
}
exports.$init$AppliedFunction=$init$AppliedFunction;
$init$AppliedFunction();
...
function $init$ConstrainedAnnotation(){
    if (ConstrainedAnnotation.$$===undefined){
        ...
        (function($$constrainedAnnotation){
            $$constrainedAnnotation.occurs=function occurs(programElement$700){
...
function $init$ClassOrInterface(){
    if (ClassOrInterface.$$===undefined){
        initTypeProto(ClassOrInterface,'ceylon.language.metamodel::ClassOrInterface',$init$Declaration(),$init$Parameterised());
...
function annotations(annotationType$701,programElement$702,$$$mptypes){
    throw Exception();
}
...
function optionalAnnotation(annotationType$703,programElement$704,$$$mptypes){
    return annotations(annotationType$703,programElement$704,{Values:{ t:'u', l:[{t:.Null},$$$mptypes.Value]},Value:$$$mptypes.Value,ProgramElement:$$$mptypes.ProgramElement});
}
...
function sequencedAnnotations(annotationType$705,programElement$706,$$$mptypes){
    return annotations(annotationType$705,programElement$706,{Values:{t:.Sequential,a:{Element:$$$mptypes.Value}},Value:$$$mptypes.Value,ProgramElement:$$$mptypes.ProgramElement});
}
...
function $init$Parameterised(){
    if (Parameterised.$$===undefined){
        initTypeProto(Parameterised,'ceylon.language.metamodel::Parameterised');
...
function $init$Package(){
    if (Package.$$===undefined){
        initTypeProto(Package,'ceylon.language.metamodel::Package');
        (function($$package){
        })(Package.$$.prototype);
    }
    Package.$$metamodel$$={$nm:'Package',$mt:'ifc','satisfies':[]};
    return Package;
}
...
function $init$Class(){
    if (Class.$$===undefined){
        initTypeProto(Class,'ceylon.language.metamodel::Class',$init$ClassOrInterface(),$init$Declaration());
        (function($$class){
        })(Class.$$.prototype);
    }
    Class.$$metamodel$$={$nm:'Class',$mt:'ifc','satisfies':[{t:ClassOrInterface},{t:Declaration}]};
    return Class;
}
...
function $init$TypeParameter(){
    if (TypeParameter.$$===undefined){
        initTypeProto(TypeParameter,'ceylon.language.metamodel::TypeParameter',$init$Declaration());
    }
    TypeParameter.$$metamodel$$={$nm:'TypeParameter',$mt:'ifc','satisfies':[{t:Declaration}]};
...
function $init$Function(){
    if (Function.$$===undefined){
        initTypeProto(Function,'ceylon.language.metamodel::Function',$init$Declaration(),$init$Parameterised());
        (function($$function){
        })(Function.$$.prototype);
    }
