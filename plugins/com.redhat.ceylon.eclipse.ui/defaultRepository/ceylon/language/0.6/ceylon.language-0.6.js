...
function $init$Exception(){
    if (Exception.$$===undefined){
        ...
        (function($$exception){
            ...
            },undefined,function(){return{mod:$$METAMODEL$$,$t:{t:String$},$cont:Exception,$an:function(){return[see([$init$OpenValue()('cause',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),false,Exception.$$.prototype.$prop$cause)].reifyCeylonType({Absent:{t:Null},Element:{t:ValueDeclaration$model$declaration}})),shared(),$default()];},d:['ceylon.language','Exception','$at','message']};});
...
Iterable.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$tp:{Element:{'var':'out'},Absent:{'var':'out','satisfies':[{t:Null}],'def':{t:Null}}},satisfies:[{t:Container,a:{Absent:'Absent',Element:'Element'}}],$an:function(){return[see([$init$OpenInterface()('Collection',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),true,Collection)].reifyCeylonType({Absent:{t:Null},Element:{t:InterfaceDeclaration$model$declaration}})),by([String$("Gavin",5)].reifyCeylonType({Absent:{t:Null},Element:{t:String$}})),shared()];},d:['ceylon.language','Iterable']};};
    ...
    if (Iterable.$$===undefined){
        ...
        (function($$iterable){
            ...
            $$iterable.longerThan=function longerThan(length$7){
                ...
                return false;
            };$$iterable.longerThan.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$t:{t:Boolean$},$ps:[{$nm:'length',$mt:'prm',$t:{t:Integer}}],$cont:Iterable,$an:function(){return[see([$init$OpenValue()('size',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),false,Iterable.$$.prototype.$prop$size)].reifyCeylonType({Absent:{t:Null},Element:{t:ValueDeclaration$model$declaration}})),shared(),$default()];},d:['ceylon.language','Iterable','$m','longerThan']};};
            $$iterable.shorterThan=function shorterThan(length$13){
                ...
                return true;
            };$$iterable.shorterThan.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$t:{t:Boolean$},$ps:[{$nm:'length',$mt:'prm',$t:{t:Integer}}],$cont:Iterable,$an:function(){return[see([$init$OpenValue()('size',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),false,Iterable.$$.prototype.$prop$size)].reifyCeylonType({Absent:{t:Null},Element:{t:ValueDeclaration$model$declaration}})),shared(),$default()];},d:['ceylon.language','Iterable','$m','shorterThan']};};
            ...
            $$iterable.$map.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$t:{t:Iterable,a:{Absent:'Absent',Element:'Result'}},$ps:[{$nm:'collecting',$mt:'prm',$t:'Result'}],$cont:Iterable,$tp:{Result:{}},$an:function(){return[see([$init$OpenFunction()('collect',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),false,Iterable.$$.prototype.collect)].reifyCeylonType({Absent:{t:Null},Element:{t:FunctionDeclaration$model$declaration}})),shared(),$default()];},d:['ceylon.language','Iterable','$m','map']};};
            ...
            $$iterable.$filter.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$t:{t:Iterable,a:{Absent:{t:Null},Element:'Element'}},$ps:[{$nm:'selecting',$mt:'prm',$t:{t:Boolean$}}],$cont:Iterable,$an:function(){return[see([$init$OpenFunction()('select',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),false,Iterable.$$.prototype.select)].reifyCeylonType({Absent:{t:Null},Element:{t:FunctionDeclaration$model$declaration}})),shared(),$default()];},d:['ceylon.language','Iterable','$m','filter']};};
            ...
            $$iterable.select.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$t:{t:Sequential,a:{Element:'Element'}},$ps:[{$nm:'selecting',$mt:'prm',$t:{t:Boolean$}}],$cont:Iterable,$an:function(){return[see([$init$OpenFunction()('filter',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),false,Iterable.$$.prototype.$filter)].reifyCeylonType({Absent:{t:Null},Element:{t:FunctionDeclaration$model$declaration}})),shared(),$default()];},d:['ceylon.language','Iterable','$m','select']};};
            ...
            },undefined,function(){return{mod:$$METAMODEL$$,$t:{t:Iterable,a:{Absent:'Absent',Element:'Element'}},$cont:Iterable,$an:function(){return[see([$init$OpenFunction()('cycle',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),false,Iterable.$$.prototype.cycle)].reifyCeylonType({Absent:{t:Null},Element:{t:FunctionDeclaration$model$declaration}})),shared(),$default()];},d:['ceylon.language','Iterable','$at','cycled']};});$$iterable.cycle=function cycle(times$170){
                var $$iterable=this;
            ...
            };$$iterable.repeat.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$t:{t:List,a:{Element:'Element'}},$ps:[{$nm:'times',$mt:'prm',$t:{t:Integer}}],$cont:Iterable,$an:function(){return[see([$init$OpenFunction()('cycle',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),false,Iterable.$$.prototype.cycle)].reifyCeylonType({Absent:{t:Null},Element:{t:FunctionDeclaration$model$declaration}})),shared(),$default()];},d:['ceylon.language','Iterable','$m','repeat']};};
        })(Iterable.$$.prototype);
    }
    return Iterable;
}
...
Sequence.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$tp:{Element:{'var':'out'}},satisfies:[{t:Sequential,a:{Element:'Element'}},{t:Iterable,a:{Absent:{t:Nothing},Element:'Element'}},{t:Cloneable,a:{Clone:{t:Sequence,a:{Element:'Element'}}}}],$an:function(){return[see([$init$OpenInterface()('Empty',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),true,Empty)].reifyCeylonType({Absent:{t:Null},Element:{t:InterfaceDeclaration$model$declaration}})),by([String$("Gavin",5)].reifyCeylonType({Absent:{t:Null},Element:{t:String$}})),shared()];},d:['ceylon.language','Sequence']};};
...
function $init$Correspondence(){
    if (Correspondence.$$===undefined){
        ...
        (function($$correspondence){
            ...
            },undefined,function(){return{mod:$$METAMODEL$$,$t:{t:Category},$cont:Correspondence,$an:function(){return[see([$init$OpenFunction()('defines',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),false,Correspondence.$$.prototype.defines)].reifyCeylonType({Absent:{t:Null},Element:{t:FunctionDeclaration$model$declaration}})),shared(),$default()];},d:['ceylon.language','Correspondence','$at','keys']};});
            ...
            };$$correspondence.definesAny.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$t:{t:Boolean$},$ps:[{$nm:'keys',$mt:'prm',$t:{t:Iterable,a:{Absent:{t:Null},Element:'Key'}}}],$cont:Correspondence,$an:function(){return[see([$init$OpenFunction()('defines',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),false,Correspondence.$$.prototype.defines)].reifyCeylonType({Absent:{t:Null},Element:{t:FunctionDeclaration$model$declaration}})),shared(),$default()];},d:['ceylon.language','Correspondence','$m','definesAny']};};
...
Finished.$$metamodel$$=function(){return{mod:$$METAMODEL$$,'super':{t:Basic},satisfies:[],$an:function(){return[see([$init$OpenInterface()('Iterator',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),true,Iterator)].reifyCeylonType({Absent:{t:Null},Element:{t:InterfaceDeclaration$model$declaration}})),shared(),abstract()];},d:['ceylon.language','Finished']};};
...
exports.getFinished.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$t:{t:finished$263},$an:function(){return[see([$init$OpenInterface()('Iterator',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),true,Iterator)].reifyCeylonType({Absent:{t:Null},Element:{t:InterfaceDeclaration$model$declaration}})),shared()];},d:['ceylon.language','finished']};};
function Binary($$targs$$,$$binary){
    set_type_args($$binary,$$targs$$);
    $$binary.set$defs$bit=function(index$265,bit$266){return true;};
}
Binary.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$tp:{Other:{'satisfies':[{t:Binary,a:{Other:'Other'}}]}},satisfies:[],$an:function(){return[see([$init$OpenClass()('Integer',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),true,Integer)].reifyCeylonType({Absent:{t:Null},Element:{t:ClassDeclaration$model$declaration}})),by([String$("Stef",4)].reifyCeylonType({Absent:{t:Null},Element:{t:String$}})),shared()];},d:['ceylon.language','Binary']};};
...
Category.$$metamodel$$=function(){return{mod:$$METAMODEL$$,satisfies:[],$an:function(){return[see([$init$OpenInterface()('Container',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),true,Container)].reifyCeylonType({Absent:{t:Null},Element:{t:InterfaceDeclaration$model$declaration}})),by([String$("Gavin",5)].reifyCeylonType({Absent:{t:Null},Element:{t:String$}})),shared()];},d:['ceylon.language','Category']};};
...
List.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$tp:{Element:{'var':'out'}},satisfies:[{t:Collection,a:{Element:'Element'}},{t:Correspondence,a:{Key:{t:Integer},Item:'Element'}},{t:Ranged,a:{Index:{t:Integer},Span:{t:List,a:{Element:'Element'}}}},{t:Cloneable,a:{Clone:{t:List,a:{Element:'Element'}}}}],$an:function(){return[see([$init$OpenInterface()('Sequence',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),true,Sequence),$init$OpenInterface()('Empty',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),true,Empty),$init$OpenClass()('Array',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),true,Array)].reifyCeylonType({Absent:{t:Null},Element:{ t:'u', l:[{t:InterfaceDeclaration$model$declaration},{t:ClassDeclaration$model$declaration}]}})),shared()];},d:['ceylon.language','List']};};
exports.List=List;
function $init$List(){
    if (List.$$===undefined){
        ...
        (function($$list){
            ...
            defineAttr($$list,'last',function(){
                ...
                return seq$314;
            };$$list.withLeading.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$t:{t:Sequence,a:{Element:{ t:'u', l:['Element','Other']}}},$ps:[{$nm:'element',$mt:'prm',$t:'Other'}],$cont:List,$tp:{Other:{}},$an:function(){return[see([$init$OpenFunction()('following',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),false,Iterable.$$.prototype.following)].reifyCeylonType({Absent:{t:Null},Element:{t:FunctionDeclaration$model$declaration}})),shared(),$default()];},d:['ceylon.language','List','$m','withLeading']};};
                ...
                return Comprehension(function(){
                    ...
                    var next$index$391=function(){
                        while((index$391=it$390.next())!==getFinished()){
                            if(selecting$389((opt$395=$$list.get(index$391),opt$395!==null?opt$395:))){
                                return index$391;
                            }
                        }
                        return getFinished();
            ...
            $$list.trim=function trim(trimming$398){
                ...
                if((l$399=$$list.lastIndex)!==null){
                    ...
                    var index$405;while ((index$405=it$404.next())!==getFinished()){
                        if((!trimming$398((opt$406=$$list.get(index$405),opt$406!==null?opt$406:)))){
                            from$400=index$405;
                            break;
                        }
                        var opt$406;
                    ...
                    var index$408;while ((index$408=it$407.next())!==getFinished()){
                        if((!trimming$398((opt$409=$$list.get(index$408),opt$409!==null?opt$409:)))){
                            to$402=index$408;
                            break;
                        }
                        var opt$409;
            ...
            $$list.trimLeading=function trimLeading(trimming$410){
                ...
                if((l$411=$$list.lastIndex)!==null){
                    ...
                    var index$413;while ((index$413=it$412.next())!==getFinished()){
                        if((!trimming$410((opt$414=$$list.get(index$413),opt$414!==null?opt$414:)))){
            ...
            $$list.trimTrailing=function trimTrailing(trimming$415){
                ...
                if((l$416=$$list.lastIndex)!==null){
                    ...
                    var index$418;while ((index$418=it$417.next())!==getFinished()){
                        if((!trimming$415((opt$419=$$list.get(index$418),opt$419!==null?opt$419:)))){
            ...
            $$list.initial.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$t:{t:List,a:{Element:'Element'}},$ps:[{$nm:'length',$mt:'prm',$t:{t:Integer}}],$cont:List,$an:function(){return[see([$init$OpenFunction()('terminal',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),false,List.$$.prototype.terminal)].reifyCeylonType({Absent:{t:Null},Element:{t:FunctionDeclaration$model$declaration}})),shared(),$default()];},d:['ceylon.language','List','$m','initial']};};
            ...
            };$$list.terminal.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$t:{t:List,a:{Element:'Element'}},$ps:[{$nm:'length',$mt:'prm',$t:{t:Integer}}],$cont:List,$an:function(){return[see([$init$OpenFunction()('initial',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),false,List.$$.prototype.initial)].reifyCeylonType({Absent:{t:Null},Element:{t:FunctionDeclaration$model$declaration}})),shared(),$default()];},d:['ceylon.language','List','$m','terminal']};};
        })(List.$$.prototype);
    }
    return List;
}
...
Invertable.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$tp:{Inverse:{'var':'out','satisfies':[{t:Invertable,a:{Inverse:'Inverse'}}]}},satisfies:[],$an:function(){return[see([$init$OpenClass()('Integer',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),true,Integer),$init$OpenClass()('Float',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),true,Float)].reifyCeylonType({Absent:{t:Null},Element:{t:ClassDeclaration$model$declaration}})),by([String$("Gavin",5)].reifyCeylonType({Absent:{t:Null},Element:{t:String$}})),shared()];},d:['ceylon.language','Invertable']};};
...
Numeric.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$tp:{Other:{'satisfies':[{t:Numeric,a:{Other:'Other'}}]}},satisfies:[{t:Summable,a:{Other:'Other'}},{t:Invertable,a:{Inverse:'Other'}}],$an:function(){return[see([$init$OpenClass()('Integer',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),true,Integer),$init$OpenClass()('Float',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),true,Float),$init$OpenInterface()('Comparable',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),true,Comparable)].reifyCeylonType({Absent:{t:Null},Element:{ t:'u', l:[{t:ClassDeclaration$model$declaration},{t:InterfaceDeclaration$model$declaration}]}})),by([String$("Gavin",5)].reifyCeylonType({Absent:{t:Null},Element:{t:String$}})),shared()];},d:['ceylon.language','Numeric']};};
...
Scalar.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$tp:{Other:{'satisfies':[{t:Scalar,a:{Other:'Other'}}]}},satisfies:[{t:Numeric,a:{Other:'Other'}},{t:Comparable,a:{Other:'Other'}},{t:Number$}],$an:function(){return[see([$init$OpenClass()('Integer',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),true,Integer),$init$OpenClass()('Float',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),true,Float)].reifyCeylonType({Absent:{t:Null},Element:{t:ClassDeclaration$model$declaration}})),by([String$("Gavin",5)].reifyCeylonType({Absent:{t:Null},Element:{t:String$}})),shared()];},d:['ceylon.language','Scalar']};};
...
Exponentiable.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$tp:{This:{'satisfies':[{t:Exponentiable,a:{Other:'Other',This:'This'}}]},Other:{'satisfies':[{t:Numeric,a:{Other:'Other'}}]}},satisfies:[{t:Numeric,a:{Other:'This'}}],$an:function(){return[see([$init$OpenClass()('Integer',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),true,Integer),$init$OpenClass()('Float',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),true,Float)].reifyCeylonType({Absent:{t:Null},Element:{t:ClassDeclaration$model$declaration}})),shared()];},d:['ceylon.language','Exponentiable']};};
...
Integral.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$tp:{Other:{'satisfies':[{t:Integral,a:{Other:'Other'}}]}},satisfies:[{t:Numeric,a:{Other:'Other'}},{t:Enumerable,a:{Other:'Other'}}],$an:function(){return[see([$init$OpenClass()('Integer',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),true,Integer)].reifyCeylonType({Absent:{t:Null},Element:{t:ClassDeclaration$model$declaration}})),by([String$("Gavin",5)].reifyCeylonType({Absent:{t:Null},Element:{t:String$}})),shared()];},d:['ceylon.language','Integral']};};
...
InitializationException.$$metamodel$$=function(){return{mod:$$METAMODEL$$,'super':{t:Exception},satisfies:[],$an:function(){return[see([$init$OpenFunction()('late',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),true,late)].reifyCeylonType({Absent:{t:Null},Element:{t:FunctionDeclaration$model$declaration}})),shared()];},d:['ceylon.language','InitializationException']};};
...
;
byDecreasing.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$t:{t:Comparison},$ps:[{$nm:'comparable',$mt:'prm',$t:'Value'}],$tp:{Element:{},Value:{'satisfies':[{t:Comparable,a:{Other:'Value'}}]}},$an:function(){return[see([$init$OpenFunction()('byIncreasing',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),true,byIncreasing)].reifyCeylonType({Absent:{t:Null},Element:{t:FunctionDeclaration$model$declaration}})),shared()];},d:['ceylon.language','byDecreasing']};};
...
;
byItem.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$t:{t:Comparison},$ps:[{$nm:'comparing',$mt:'prm',$t:{t:Comparison}}],$tp:{Item:{'satisfies':[{t:Object$}]}},$an:function(){return[see([$init$OpenFunction()('byKey',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),true,byKey)].reifyCeylonType({Absent:{t:Null},Element:{t:FunctionDeclaration$model$declaration}})),shared()];},d:['ceylon.language','byItem']};};
...
;
byKey.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$t:{t:Comparison},$ps:[{$nm:'comparing',$mt:'prm',$t:{t:Comparison}}],$tp:{Key:{'satisfies':[{t:Object$}]}},$an:function(){return[see([$init$OpenFunction()('byItem',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),true,byItem)].reifyCeylonType({Absent:{t:Null},Element:{t:FunctionDeclaration$model$declaration}})),shared()];},d:['ceylon.language','byKey']};};
exports.byKey=byKey;
...
emptyOrSingleton.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$t:{t:Sequential,a:{Element:'Element'}},$ps:[{$nm:'element',$mt:'prm',$t:{ t:'u', l:[{t:Null},'Element']}}],$tp:{Element:{'satisfies':[{t:Object$}]}},$an:function(){return[see([$init$OpenClass()('Singleton',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),true,Singleton),$init$OpenInterface()('Empty',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),true,Empty)].reifyCeylonType({Absent:{t:Null},Element:{ t:'u', l:[{t:ClassDeclaration$model$declaration},{t:InterfaceDeclaration$model$declaration}]}})),shared()];},d:['ceylon.language','emptyOrSingleton']};};
...
exports.every=every;
every.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$t:{t:Boolean$},$ps:[{$nm:'values',$mt:'prm',$t:{t:Iterable,a:{Absent:{t:Null},Element:{t:Boolean$}}}}],$an:function(){return[see([$init$OpenFunction()('any',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),true,any)].reifyCeylonType({Absent:{t:Null},Element:{t:FunctionDeclaration$model$declaration}})),shared()];},d:['ceylon.language','every']};};
...
;
forItem.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$t:'Result',$ps:[{$nm:'resulting',$mt:'prm',$t:'Result'}],$tp:{Item:{'satisfies':[{t:Object$}]},Result:{}},$an:function(){return[see([$init$OpenFunction()('forKey',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),true,forKey)].reifyCeylonType({Absent:{t:Null},Element:{t:FunctionDeclaration$model$declaration}})),shared()];},d:['ceylon.language','forItem']};};
...
product.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$t:'Value',$ps:[{$nm:'values',$mt:'prm',$t:{t:Iterable,a:{Absent:{t:Nothing},Element:'Value'}}}],$tp:{Value:{'satisfies':[{t:Numeric,a:{Other:'Value'}}]}},$an:function(){return[see([$init$OpenFunction()('sum',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),true,sum)].reifyCeylonType({Absent:{t:Null},Element:{t:FunctionDeclaration$model$declaration}})),shared()];},d:['ceylon.language','product']};};
...
identical.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$t:{t:Boolean$},$ps:[{$nm:'x',$mt:'prm',$t:{t:Identifiable}},{$nm:'y',$mt:'prm',$t:{t:Identifiable}}],$an:function(){return[see([$init$OpenFunction()('identityHash',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),true,identityHash)].reifyCeylonType({Absent:{t:Null},Element:{t:FunctionDeclaration$model$declaration}})),shared()];},d:['ceylon.language','identical']};};
...
compose.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$t:{t:Callable,a:{Arguments:'Args',Return:'X'}},$ps:[{$nm:'x',$mt:'prm',$t:{t:Callable,a:{Arguments:{t:Tuple,a:{Rest:{t:Empty},First:'Y',Element:'Y'}},Return:'X'}}},{$nm:'y',$mt:'prm',$t:{t:Callable,a:{Arguments:'Args',Return:'Y'}}}],$tp:{X:{},Y:{},Args:{'satisfies':[{t:Sequential,a:{Element:{t:Anything}}}]}},$an:function(){return[see([$init$OpenFunction()('curry',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),true,curry),$init$OpenFunction()('uncurry',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),true,uncurry)].reifyCeylonType({Absent:{t:Null},Element:{t:FunctionDeclaration$model$declaration}})),shared()];},d:['ceylon.language','compose']};};
...
plus.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$t:'Value',$ps:[{$nm:'x',$mt:'prm',$t:'Value'},{$nm:'y',$mt:'prm',$t:'Value'}],$tp:{Value:{'satisfies':[{t:Summable,a:{Other:'Value'}}]}},$an:function(){return[see([$init$OpenFunction()('times',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),true,times),$init$OpenFunction()('sum',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),true,sum)].reifyCeylonType({Absent:{t:Null},Element:{t:FunctionDeclaration$model$declaration}})),shared()];},d:['ceylon.language','plus']};};
exports.plus=plus;
var times=function (x$869,y$870,$$$mptypes){
    return x$869.times(y$870);
};
times.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$t:'Value',$ps:[{$nm:'x',$mt:'prm',$t:'Value'},{$nm:'y',$mt:'prm',$t:'Value'}],$tp:{Value:{'satisfies':[{t:Numeric,a:{Other:'Value'}}]}},$an:function(){return[see([$init$OpenFunction()('plus',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),true,plus),$init$OpenFunction()('product',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),true,product)].reifyCeylonType({Absent:{t:Null},Element:{t:FunctionDeclaration$model$declaration}})),shared()];},d:['ceylon.language','times']};};
exports.times=times;
...
sort.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$t:{t:Sequential,a:{Element:'Element'}},$ps:[{$nm:'elements',$mt:'prm',$t:{t:Iterable,a:{Absent:{t:Null},Element:'Element'}}}],$tp:{Element:{'satisfies':[{t:Comparable,a:{Other:'Element'}}]}},$an:function(){return[see([$init$OpenInterface()('Comparable',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),true,Comparable)].reifyCeylonType({Absent:{t:Null},Element:{t:InterfaceDeclaration$model$declaration}})),shared()];},d:['ceylon.language','sort']};};
exports.sort=sort;
