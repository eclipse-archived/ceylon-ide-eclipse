...
Basic.$$metamodel$$={mod:$$METAMODEL$$,'super':{t:Object$},satisfies:[{t:Identifiable}],$an:function(){return[doc(String$("The default superclass when no superclass is explicitly\nspecified using `extends`. For the sake of convenience, \nthis class inherits a default definition of value\nequality from `Identifiable`.",192)),by([String$("Gavin",5)].reifyCeylonType({Absent:{t:Null},Element:{t:String$}})),shared(),abstract()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Basic']};
exports.Basic=Basic;
function $init$Basic(){
    if (Basic.$$===undefined){
...
Exception.$$metamodel$$={mod:$$METAMODEL$$,'super':{t:Basic},satisfies:[],$an:function(){return[doc(String$("The supertype of all exceptions. A subclass represents\na more specific kind of problem, and may define \nadditional attributes which propagate information about\nproblems of that kind.",182)),by([String$("Gavin",5),String$("Tom",3)].reifyCeylonType({Absent:{t:Null},Element:{t:String$}})),shared(),$native()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Exception']};
...
Iterable.$$metamodel$$={mod:$$METAMODEL$$,$tp:{Element:{'var':'out',},Absent:{'var':'out','satisfies':[{t:Null}],'def':{t:Null}}},satisfies:[{t:Container,a:{Absent:'Absent',Element:'Element'}}],$an:function(){return[doc(String$("Abstract supertype of containers whose elements may be \niterated. An iterable container need not be finite, but\nits elements must at least be countable. There may not\nbe a well-defined iteration order, and so the order of\niterated elements may not be stable.\n\nThe type `Iterable<Element,Null>`, usually abbreviated\n`{Element*}` represents a possibly-empty iterable \ncontainer. The type `Iterable<Element,Nothing>`, \nusually abbreviated `{Element+}` represents a nonempty \niterable container.\n\nAn instance of `Iterable` may be constructed by \nsurrounding a value list in braces:\n\n    {String+} words = { \"hello\", \"world\" };\n\nAn instance of `Iterable` may be iterated using a `for`\nloop:\n\n    for (c in \"hello world\") { ... }\n\n`Iterable` and its subtypes define various operations\nthat return other iterable objects. Such operations \ncome in two flavors:\n\n- _Lazy_ operations return a \"view\" of the receiving\n  iterable object. If the underlying iterable object is\n  mutable, then changes to the underlying object will\n  be reflected in the resulting view. Lazy operations\n  are usually efficient, avoiding memory allocation or\n  iteration of the receiving iterable object.\n  \n- _Eager_ operations return an immutable object. If the\n  receiving iterable object is mutable, changes to this\n  object will not be reflected in the resulting \n  immutable object. Eager operations are often \n  expensive, involving memory allocation and iteration\n  of the receiving iterable object.\n\nLazy operations are preferred, because they can be \nefficiently chained. For example:\n\n    string.filter((Character c) => c.letter)\n          .map((Character c) => c.uppercased)\n\nis much less expensive than:\n\n    string.select((Character c) => c.letter)\n          .collect((Character c) => c.uppercased)\n\nFurthermore, it is always easy to produce a new \nimmutable iterable object given the view produced by a\nlazy operation. For example:\n\n    [ *string.filter((Character c) => c.letter)\n            .map((Character c) => c.uppercased) ]\n\nLazy operations normally return an instance of \n`Iterable` or `Map`.\n\nHowever, there are certain scenarios where an eager \noperation is more useful, more convenient, or no more \nexpensive than a lazy operation, including:\n\n- sorting operations, which are eager by nature,\n- operations which preserve emptiness/nonemptiness of\n  the receiving iterable object.\n\nEager operations normally return a sequence.",2418)),see([Collection].reifyCeylonType({Absent:{t:Null},Element:{t:Anything}})),by([String$("Gavin",5)].reifyCeylonType({Absent:{t:Null},Element:{t:String$}})),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Iterable']};
...
function $init$Iterable(){
    if (Iterable.$$===undefined){
        ...
        (function($$iterable){
            ...
            $$iterable.$map.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:Iterable,a:{Absent:'Absent',Element:'Result'}},$ps:[{$nm:'collecting',$mt:'prm',$t:'Result'}],$tp:{Result:{}},$an:function(){return[doc(String$("An `Iterable` containing the results of applying\nthe given mapping to the elements of to this \ncontainer.",105)),see([$$iterable.collect].reifyCeylonType({Absent:{t:Null},Element:{t:Anything}})),shared(),$default()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Iterable']['$m']['map']};
            ...
            $$iterable.fold=function fold(initial$29,accumulating$30,$$$mptypes){
                ...
                return r$31;
            };$$iterable.fold.$$metamodel$$={mod:$$METAMODEL$$,$t:'Result',$ps:[{$nm:'initial',$mt:'prm',$t:'Result'},{$nm:'accumulating',$mt:'prm',$t:'Result'}],$tp:{Result:{}},$an:function(){return[doc(String$("The result of applying the accumulating function to \neach element of this container in turn.",92)),shared(),$default()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Iterable']['$m']['fold']};$$iterable.find=function find(selecting$35){
                var $$iterable=this;
                ...
                return null;
            };$$iterable.find.$$metamodel$$={mod:$$METAMODEL$$,$t:{ t:'u', l:[{t:Null},'Element']},$ps:[{$nm:'selecting',$mt:'prm',$t:{t:Boolean$}}],$an:function(){return[doc(String$("The first element which satisfies the given \npredicate, if any, or `null` otherwise.",84)),shared(),$default()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Iterable']['$m']['find']};$$iterable.findLast=function findLast(selecting$38){
                var $$iterable=this;
                var last$39=null;
                ...
                return last$39;
            };$$iterable.findLast.$$metamodel$$={mod:$$METAMODEL$$,$t:{ t:'u', l:[{t:Null},'Element']},$ps:[{$nm:'selecting',$mt:'prm',$t:{t:Boolean$}}],$an:function(){return[doc(String$("The last element which satisfies the given\npredicate, if any, or `null` otherwise.",82)),shared(),$default()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Iterable']['$m']['findLast']};$$iterable.$sort=function (comparing$43){
                var $$iterable=this;
            ...
            $$iterable.$sort.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:Sequential,a:{Element:'Element'}},$ps:[{$nm:'comparing',$mt:'prm',$t:{t:Comparison}}],$an:function(){return[doc(String$("A sequence containing the elements of this\ncontainer, sorted according to a function \nimposing a partial order upon the elements.\n\nFor convenience, the functions `byIncreasing()` \nand `byDecreasing()` produce a suitable \ncomparison function:\n\n    \"Hello World!\".sort(byIncreasing((Character c) => c.lowercased))\n\nThis operation is eager by nature.",347)),see([byIncreasing,byDecreasing].reifyCeylonType({Absent:{t:Null},Element:{t:Anything}})),shared(),$default()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Iterable']['$m']['sort']};
            ...
            $$iterable.collect.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:Sequential,a:{Element:'Result'}},$ps:[{$nm:'collecting',$mt:'prm',$t:'Result'}],$tp:{Result:{}},$an:function(){return[doc(String$("A sequence containing the results of applying the\ngiven mapping to the elements of this container. An \neager counterpart to `map()`.",132)),see([$$iterable.$map].reifyCeylonType({Absent:{t:Null},Element:{t:Anything}})),shared(),$default()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Iterable']['$m']['collect']};
            ...
            $$iterable.select.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:Sequential,a:{Element:'Element'}},$ps:[{$nm:'selecting',$mt:'prm',$t:{t:Boolean$}}],$an:function(){return[doc(String$("A sequence containing the elements of this \ncontainer that satisfy the given predicate. An \neager counterpart to `filter()`.",124)),see([$JsCallable($$iterable.$filter,[{$nm:'selecting',$mt:'prm',$t:{t:Boolean$}}],{Arguments:{t:Tuple,a:{Rest:{t:Empty},First:{t:Callable,a:{Arguments:{t:Tuple,a:{Rest:{t:Empty},First:$$iterable.$$targs$$.Element,Element:$$iterable.$$targs$$.Element}},Return:{t:Boolean$}}},Element:{t:Callable,a:{Arguments:{t:Tuple,a:{Rest:{t:Empty},First:$$iterable.$$targs$$.Element,Element:$$iterable.$$targs$$.Element}},Return:{t:Boolean$}}}}},Return:{t:Iterable,a:{Absent:{t:Null},Element:$$iterable.$$targs$$.Element}}})].reifyCeylonType({Absent:{t:Null},Element:{t:Callable,a:{Arguments:{t:Tuple,a:{Rest:{t:Empty},First:{t:Callable,a:{Arguments:{t:Tuple,a:{Rest:{t:Empty},First:$$iterable.$$targs$$.Element,Element:$$iterable.$$targs$$.Element}},Return:{t:Boolean$}}},Element:{t:Callable,a:{Arguments:{t:Tuple,a:{Rest:{t:Empty},First:$$iterable.$$targs$$.Element,Element:$$iterable.$$targs$$.Element}},Return:{t:Boolean$}}}}},Return:{t:Iterable,a:{Absent:{t:Null},Element:$$iterable.$$targs$$.Element}}}}})),shared(),$default()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Iterable']['$m']['select']};
            $$iterable.any=function any(selecting$46){
                ...
                return false;
            };$$iterable.any.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:Boolean$},$ps:[{$nm:'selecting',$mt:'prm',$t:{t:Boolean$}}],$an:function(){return[doc(String$("Return `true` if at least one element satisfies the\npredicate function.",71)),shared(),$default()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Iterable']['$m']['any']};$$iterable.$every=function $every(selecting$49){
                var $$iterable=this;
                ...
                return true;
            };$$iterable.$every.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:Boolean$},$ps:[{$nm:'selecting',$mt:'prm',$t:{t:Boolean$}}],$an:function(){return[doc(String$("Return `true` if all elements satisfy the predicate\nfunction.",61)),shared(),$default()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Iterable']['$m']['every']};$$iterable.skipping=function skipping(skip$52){
                var $$iterable=this;
            ...
            };$$iterable.skipping.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:Iterable,a:{Absent:{t:Null},Element:'Element'}},$ps:[{$nm:'skip',$mt:'prm',$t:{t:Integer}}],$an:function(){return[doc(String$("Produce an `Iterable` containing the elements of\nthis iterable object, after skipping the first \n`skip` elements. If this iterable object does not \ncontain more elements than the specified number of \nelements, the `Iterable` contains no elements.",246)),shared(),$default()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Iterable']['$m']['skipping']};$$iterable.taking=function taking(take$63){
                var $$iterable=this;
            ...
            };$$iterable.taking.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:Iterable,a:{Absent:{t:Null},Element:'Element'}},$ps:[{$nm:'take',$mt:'prm',$t:{t:Integer}}],$an:function(){return[doc(String$("Produce an `Iterable` containing the first `take`\nelements of this iterable object. If the specified \nnumber of elements is larger than the number of \nelements of this iterable object, the `Iterable` \ncontains the same elements as this iterable object.",252)),shared(),$default()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Iterable']['$m']['taking']};$$iterable.by=function by(step$75){
                var $$iterable=this;
                ...
                return count$88;
            };$$iterable.count.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:Integer},$ps:[{$nm:'selecting',$mt:'prm',$t:{t:Boolean$}}],$an:function(){return[doc(String$("Return the number of elements in this `Iterable` \nthat satisfy the predicate function.",86)),shared(),$default()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Iterable']['$m']['count']};defineAttr($$iterable,'coalesced',function(){
                var $$iterable=this;
                return Comprehension(function(){
                    var e$96;
            ...
            defineAttr($$iterable,'indexed',function()/*anotaciones:ceylon.language::Doc,ceylon.language::Shared,ceylon.language::Default,*/{
                ...
                return getCons$120();
            };$$iterable.following.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:Iterable,a:{Absent:{t:Nothing},Element:{ t:'u', l:['Element','Other']}}},$ps:[{$nm:'head',$mt:'prm',$t:'Other'}],$tp:{Other:{}},$an:function(){return[doc(String$("An `Iterable` with the given inital element followed \nby the elements of this iterable object.",94)),shared(),$default()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Iterable']['$m']['following']};$$iterable.chain=function chain(other$121,$$$mptypes){
                var $$iterable=this;
            ...
            };$$iterable.chain.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:Iterable,a:{Absent:{ t:'i', l:['Absent','OtherAbsent']},Element:{ t:'u', l:['Element','Other']}}},$ps:[{$nm:'other',$mt:'prm',$t:{t:Iterable,a:{Absent:'OtherAbsent',Element:'Other'}}}],$tp:{Other:{},OtherAbsent:{'satisfies':[{t:Null}]}},$an:function(){return[doc(String$("The elements of this iterable object, in their\noriginal order, followed by the elements of the \ngiven iterable object also in their original order.",147)),shared(),$default()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Iterable']['$m']['chain']};$$iterable.defaultNullElements=function (defaultValue$124,$$$mptypes){
                var $$iterable=this;
                return Comprehension(function(){
            ...
            $$iterable.defaultNullElements.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:Iterable,a:{Absent:'Absent',Element:{ t:'u', l:[{ t:'i', l:['Element',{t:Object$}]},'Default']}}},$ps:[{$nm:'defaultValue',$mt:'prm',$t:'Default'}],$tp:{Default:{}},$an:function(){return[doc(String$("An `Iterable` that produces the elements of this \niterable object, replacing every `null` element \nwith the given default value. The resulting iterable\nobject does not produce the value `null`.",193)),shared(),$default()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Iterable']['$m']['defaultNullElements']};
...
Sequential.$$metamodel$$={mod:$$METAMODEL$$,$tp:{Element:{'var':'out',}},satisfies:[{t:List,a:{Element:'Element'}},{t:Ranged,a:{Index:{t:Integer},Span:{t:Sequential,a:{Element:'Element'}}}},{t:Cloneable,a:{Clone:{t:Sequential,a:{Element:'Element'}}}}],$an:function(){return[doc(String$("A possibly-empty, immutable sequence of values. The \ntype `Sequential<Element>` may be abbreviated \n`[Element*]` or `Element[]`. \n\n`Sequential` has two enumerated subtypes:\n\n- `Empty`, abbreviated `[]`, represents an empty \n   sequence, and\n- `Sequence<Element>`, abbreviated `[Element+]` \n   represents a non-empty sequence, and has the very\n   important subclass `Tuple`.",373)),see([Tuple].reifyCeylonType({Absent:{t:Null},Element:{t:Anything}})),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Sequential']};
...
Sequence.$$metamodel$$={mod:$$METAMODEL$$,$tp:{Element:{'var':'out',}},satisfies:[{t:Sequential,a:{Element:'Element'}},{t:Iterable,a:{Absent:{t:Nothing},Element:'Element'}},{t:Cloneable,a:{Clone:{t:Sequence,a:{Element:'Element'}}}}],$an:function(){return[doc(String$("A nonempty, immutable sequence of values. The type \n`Sequence<Element>`, may be abbreviated `[Element+]`.\n\nGiven a possibly-empty sequence of type `[Element*]`, \nthe `if (nonempty ...)` construct, or, alternatively,\nthe `assert (nonempty ...)` construct, may be used to \nnarrow to a nonempty sequence type:\n\n    [Integer*] nums = ... ;\n    if (nonempty nums) {\n        Integer first = nums.first;\n        Integer max = max(nums);\n        [Integer+] squares = nums.collect((Integer i) i**2));\n        [Integer+] sorted = nums.sort(byIncreasing((Integer i) i));\n    }\n\nOperations like `first`, `max()`, `collect()`, and \n`sort()`, which polymorphically produce a nonempty or \nnon-null output when given a nonempty input are called \n_emptiness-preserving_.",753)),see([Empty].reifyCeylonType({Absent:{t:Null},Element:{t:Anything}})),by([String$("Gavin",5)].reifyCeylonType({Absent:{t:Null},Element:{t:String$}})),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Sequence']};
    ...
    if (Sequence.$$===undefined){
        ...
        (function($$sequence){
            ...
            $$sequence.$sort=function $sort(comparing$152){
                ...
                return s$154;
            };$$sequence.$sort.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:Sequence,a:{Element:'Element'}},$ps:[{$nm:'comparing',$mt:'prm',$t:{t:Comparison}}],$an:function(){return[doc(String$("A nonempty sequence containing the elements of this\ncontainer, sorted according to a function \nimposing a partial order upon the elements.",138)),shared(),$default(),actual()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Sequence']['$m']['sort']};$$sequence.collect=function collect(collecting$155,$$$mptypes){
                var $$sequence=this;
                ...
                return s$157;
            };$$sequence.collect.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:Sequence,a:{Element:'Result'}},$ps:[{$nm:'collecting',$mt:'prm',$t:'Result'}],$tp:{Result:{}},$an:function(){return[doc(String$("A nonempty sequence containing the results of \napplying the given mapping to the elements of this\nsequence.",107)),shared(),$default(),actual()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Sequence']['$m']['collect']};defineAttr($$sequence,'clone',function(){
                var $$sequence=this;
                return $$sequence;
            });
...
Empty.$$metamodel$$={mod:$$METAMODEL$$,satisfies:[{t:Sequential,a:{Element:{t:Nothing}}},{t:Ranged,a:{Index:{t:Integer},Span:{t:Empty}}},{t:Cloneable,a:{Clone:{t:Empty}}}],$an:function(){return[doc(String$("A sequence with no elements. The type `Empty` may be\nabbreviated `[]`, and an instance is produced by the \nexpression `[]`. That is, in the following expression,\n`e` has type `[]` and refers to the value `[]`:\n\n    [] none = [];\n\n(Whether the syntax `[]` refers to the type or the \nvalue depends upon how it occurs grammatically.)",330)),see([Sequence].reifyCeylonType({Absent:{t:Null},Element:{t:Anything}})),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Empty']};
exports.Empty=Empty;
function $init$Empty(){
    if (Empty.$$===undefined){
        ...
        (function($$empty){
            ...
            $$empty.iterator.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:Iterator,a:{Element:{t:Nothing}}},$ps:[],$an:function(){return[doc(String$("Returns an iterator that is already exhausted.",46)),shared(),actual()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Empty']['$m']['iterator']};
            $$empty.get=function (index$158){
                var $$empty=this;
                return null;
            };
            $$empty.get.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:Null},$ps:[{$nm:'index',$mt:'prm',$t:{t:Integer}}],$an:function(){return[doc(String$("Returns `null` for any given index.",35)),shared(),actual()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Empty']['$m']['get']};
            $$empty.segment=function (from$159,length$160){
                var $$empty=this;
                return $$empty;
            };
            $$empty.segment.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:Empty},$ps:[{$nm:'from',$mt:'prm',$t:{t:Integer}},{$nm:'length',$mt:'prm',$t:{t:Integer}}],$an:function(){return[doc(String$("Returns an `Empty` for any given segment.",41)),shared(),actual()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Empty']['$m']['segment']};
            $$empty.span=function (from$161,to$162){
                var $$empty=this;
                return $$empty;
            };
            $$empty.span.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:Empty},$ps:[{$nm:'from',$mt:'prm',$t:{t:Integer}},{$nm:'to',$mt:'prm',$t:{t:Integer}}],$an:function(){return[doc(String$("Returns an `Empty` for any given span.",38)),shared(),actual()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Empty']['$m']['span']};
            $$empty.spanTo=function (to$163){
                var $$empty=this;
                return $$empty;
            };
            $$empty.spanTo.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:Empty},$ps:[{$nm:'to',$mt:'prm',$t:{t:Integer}}],$an:function(){return[doc(String$("Returns an `Empty` for any given span.",38)),shared(),actual()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Empty']['$m']['spanTo']};
            $$empty.spanFrom=function (from$164){
                var $$empty=this;
                return $$empty;
            };
            $$empty.spanFrom.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:Empty},$ps:[{$nm:'from',$mt:'prm',$t:{t:Integer}}],$an:function(){return[doc(String$("Returns an `Empty` for any given span.",38)),shared(),actual()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Empty']['$m']['spanFrom']};
            ...
            $$empty.chain.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:Iterable,a:{Absent:'OtherAbsent',Element:'Other'}},$ps:[{$nm:'other',$mt:'prm',$t:{t:Iterable,a:{Absent:'OtherAbsent',Element:'Other'}}}],$tp:{Other:{},OtherAbsent:{'satisfies':[{t:Null}]}},$an:function(){return[doc(String$("Returns `other`.",16)),shared(),actual()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Empty']['$m']['chain']};
            $$empty.contains=function (element$166){
                var $$empty=this;
                return false;
            };
            $$empty.contains.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:Boolean$},$ps:[{$nm:'element',$mt:'prm',$t:{t:Object$}}],$an:function(){return[doc(String$("Returns `false` for any given element.",38)),shared(),actual()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Empty']['$m']['contains']};
            $$empty.count=function (selecting$167){
                var $$empty=this;
                return (0);
            };
            $$empty.count.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:Integer},$ps:[{$nm:'selecting',$mt:'prm',$t:{t:Boolean$}}],$an:function(){return[doc(String$("Returns 0 for any given predicate.",34)),shared(),actual()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Empty']['$m']['count']};
...
Correspondence.$$metamodel$$={mod:$$METAMODEL$$,$tp:{Key:{'var':'in','satisfies':[{t:Object$}]},Item:{'var':'out',}},satisfies:[],$an:function(){return[doc(String$("Abstract supertype of objects which associate values \nwith keys. `Correspondence` does not satisfy `Category`,\nsince in some cases&mdash;`List`, for example&mdash;it is \nconvenient to consider the subtype a `Category` of its\nvalues, and in other cases&mdash;`Map`, for example&mdash;it \nis convenient to treat the subtype as a `Category` of its\nentries.\n\nThe item corresponding to a given key may be obtained \nfrom a `Correspondence` using the item operator:\n\n    value bg = settings[\"backgroundColor\"] else white;\n\nThe `get()` operation and item operator result in an\noptional type, to reflect the possibility that there is\nno item for the given key.",651)),see([Map,List,Category].reifyCeylonType({Absent:{t:Null},Element:{ t:'u', l:[{t:Anything},{t:Anything}]}})),by([String$("Gavin",5)].reifyCeylonType({Absent:{t:Null},Element:{t:String$}})),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Correspondence']};
...
function $init$Correspondence(){
    if (Correspondence.$$===undefined){
        ...
        (function($$correspondence){
            ...
            };$$correspondence.definesAny.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:Boolean$},$ps:[{$nm:'keys',$mt:'prm',$t:{t:Iterable,a:{Absent:{t:Null},Element:'Key'}}}],$an:function(){return[doc(String$("Determines if this `Correspondence` defines a value\nfor any one of the given keys.",82)),see([$JsCallable($$correspondence.defines,[{$nm:'key',$mt:'prm',$t:'Key'}],{Arguments:{t:Tuple,a:{Rest:{t:Empty},First:$$correspondence.$$targs$$.Key,Element:$$correspondence.$$targs$$.Key}},Return:{t:Boolean$}})].reifyCeylonType({Absent:{t:Null},Element:{t:Callable,a:{Arguments:{t:Tuple,a:{Rest:{t:Empty},First:$$correspondence.$$targs$$.Key,Element:$$correspondence.$$targs$$.Key}},Return:{t:Boolean$}}}})),shared(),$default()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Correspondence']['$m']['definesAny']};$$correspondence.items=function (keys$199){
                var $$correspondence=this;
                return Comprehension(function(){
            ...
            $$correspondence.items.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:Sequential,a:{Element:{ t:'u', l:[{t:Null},'Item']}}},$ps:[{$nm:'keys',$mt:'prm',$t:{t:Iterable,a:{Absent:{t:Null},Element:'Key'}}}],$an:function(){return[doc(String$("Returns the items defined for the given keys, in\nthe same order as the corresponding keys.",90)),see([$JsCallable($$correspondence.get,[{$nm:'key',$mt:'prm',$t:'Key'}],{Arguments:{t:Tuple,a:{Rest:{t:Empty},First:$$correspondence.$$targs$$.Key,Element:$$correspondence.$$targs$$.Key}},Return:{ t:'u', l:[{t:Null},$$correspondence.$$targs$$.Item]}})].reifyCeylonType({Absent:{t:Null},Element:{t:Callable,a:{Arguments:{t:Tuple,a:{Rest:{t:Empty},First:$$correspondence.$$targs$$.Key,Element:$$correspondence.$$targs$$.Key}},Return:{ t:'u', l:[{t:Null},$$correspondence.$$targs$$.Item]}}}})),shared(),$default()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Correspondence']['$m']['items']};
...
Finished.$$metamodel$$={mod:$$METAMODEL$$,'super':{t:Basic},satisfies:[],$an:function(){return[doc(String$("The type of the value that indicates that \nan `Iterator` is exhausted and has no more \nvalues to return.",104)),see([Iterator].reifyCeylonType({Absent:{t:Null},Element:{t:Anything}})),shared(),abstract()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Finished']};
...
Binary.$$metamodel$$={mod:$$METAMODEL$$,$tp:{Other:{'satisfies':[{t:Binary,a:{Other:'Other'}}]}},satisfies:[],$an:function(){return[doc(String$("Abstraction of numeric types that consist in\na sequence of bits, like `Integer`.",80)),see([$JsCallable(Integer,[],{Arguments:{t:Tuple,a:{Rest:{t:Empty},First:{t:Integer},Element:{t:Integer}}},Return:{t:Integer}})].reifyCeylonType({Absent:{t:Null},Element:{t:Callable,a:{Arguments:{t:Tuple,a:{Rest:{t:Empty},First:{t:Integer},Element:{t:Integer}}},Return:{t:Integer}}}})),by([String$("Stef",4)].reifyCeylonType({Absent:{t:Null},Element:{t:String$}})),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Binary']};
...
function $init$Binary(){
    if (Binary.$$===undefined){
        ...
        (function($$binary){
            ...
            };$$binary.clear.$$metamodel$$={mod:$$METAMODEL$$,$t:'Other',$ps:[{$nm:'index',$mt:'prm',$t:{t:Integer}}],$an:function(){return[doc(String$("Returns a new number with the given bit set to 0.\nBits are indexed from right to left.",86)),shared(),$default()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Binary']['$m']['clear']};
        })(Binary.$$.prototype);
    }
    return Binary;
}
...
Cloneable.$$metamodel$$={mod:$$METAMODEL$$,$tp:{Clone:{'var':'out','satisfies':[{t:Cloneable,a:{Clone:'Clone'}}]}},satisfies:[],$an:function(){return[doc(String$("Abstract supertype of objects whose value can be \ncloned.",57)),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Cloneable']};
...
Closeable.$$metamodel$$={mod:$$METAMODEL$$,satisfies:[],$an:function(){return[doc(String$("Abstract supertype of types which may appear\nas the expression type of a resource expression\nin a `try` statement.",114)),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Closeable']};
...
Ranged.$$metamodel$$={mod:$$METAMODEL$$,$tp:{Index:{'var':'in','satisfies':[{t:Comparable,a:{Other:'Index'}}]},Span:{'var':'out',}},satisfies:[],$an:function(){return[doc(String$("Abstract supertype of ranged objects which map a range\nof `Comparable` keys to ranges of values. The type\nparameter `Span` abstracts the type of the resulting\nrange.\n\nA span may be obtained from an instance of `Ranged`\nusing the span operator:\n\n    print(\"hello world\"[0..5])\n",276)),see([List,Sequence,$JsCallable(String,[],{Arguments:{t:Tuple,a:{Rest:{t:Empty},First:{t:String$},Element:{t:String$}}},Return:{t:String$}})].reifyCeylonType({Absent:{t:Null},Element:{t:Anything}})),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Ranged']};
...
Container.$$metamodel$$={mod:$$METAMODEL$$,$tp:{Element:{'var':'out',},Absent:{'var':'out','satisfies':[{t:Null}],'def':{t:Null}}},satisfies:[{t:Category}],$an:function(){return[doc(String$("Abstract supertype of objects which may or may not\ncontain one of more other values, called *elements*,\nand provide an operation for accessing the first \nelement, if any. A container which may or may not be \nempty is a `Container<Element,Null>`. A container which \nis always empty is a `Container<Nothing,Null>`. A \ncontainer which is never empty is a \n`Container<Element,Nothing>`.",382)),see([Category].reifyCeylonType({Absent:{t:Null},Element:{t:Anything}})),by([String$("Gavin",5)].reifyCeylonType({Absent:{t:Null},Element:{t:String$}})),deprecated(String$("Will be removed in Ceylon 1.0.",30)),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Container']};
...
Iterator.$$metamodel$$={mod:$$METAMODEL$$,$tp:{Element:{'var':'out',}},satisfies:[],$an:function(){return[doc(String$("Produces elements of an `Iterable` object. Classes that \nimplement this interface should be immutable.",102)),see([Iterable].reifyCeylonType({Absent:{t:Null},Element:{t:Anything}})),by([String$("Gavin",5)].reifyCeylonType({Absent:{t:Null},Element:{t:String$}})),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Iterator']};
...
Collection.$$metamodel$$={mod:$$METAMODEL$$,$tp:{Element:{'var':'out',}},satisfies:[{t:Iterable,a:{Absent:{t:Null},Element:'Element'}},{t:Cloneable,a:{Clone:{t:Collection,a:{Element:'Element'}}}}],$an:function(){return[doc(String$("Represents an iterable collection of elements of finite \nsize. `Collection` is the abstract supertype of `List`,\n`Map`, and `Set`.\n\nA `Collection` forms a `Category` of its elements.\n\nAll `Collection`s are `Cloneable`. If a collection is\nimmutable, it is acceptable that `clone` produce a\nreference to the collection itself. If a collection is\nmutable, `clone` should produce an immutable collection\ncontaining references to the same elements, with the\nsame structure as the original collection&mdash;that \nis, it should produce an immutable shallow copy of the\ncollection.",573)),see([List,Map,Set].reifyCeylonType({Absent:{t:Null},Element:{t:Anything}})),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Collection']};
...
function $init$Collection(){
    if (Collection.$$===undefined){
        ...
        (function($$collection){
            ...
            };$$collection.contains.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:Boolean$},$ps:[{$nm:'element',$mt:'prm',$t:{t:Object$}}],$an:function(){return[doc(String$("Return `true` if the given object is an element of\nthis collection. In this default implementation,\nand in most refining implementations, return `false`\notherwise. An acceptable refining implementation\nmay return `true` for objects which are not \nelements of the collection, but this is not \nrecommended. (For example, the `contains()` method \nof `String` returns `true` for any substring of the\nstring.)",404)),shared(),actual(),$default()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Collection']['$m']['contains']};defineAttr($$collection,'string',function(){
                var $$collection=this;
...
Category.$$metamodel$$={mod:$$METAMODEL$$,satisfies:[],$an:function(){return[doc(String$("Abstract supertype of objects that contain other \nvalues, called *elements*, where it is possible to \nefficiently determine if a given value is an element. \n`Category` does not satisfy `Container`, because it is \nconceptually possible to have a `Category` whose \nemptiness cannot be computed.\n\nThe `in` operator may be used to determine if a value\nbelongs to a `Category`:\n\n    if (\"hello\" in \"hello world\") { ... }\n    if (69 in 0..100) { ... }\n    if (key->value in { for (n in 0..100) n.string->n**2 }) { ... }\n\nOrdinarily, `x==y` implies that `x in cat == y in cat`.\nBut this contract is not required since it is possible\nto form a meaningful `Category` using a different\nequivalence relation. For example, an `IdentitySet` is\na meaningful `Category`.",755)),see([Container].reifyCeylonType({Absent:{t:Null},Element:{t:Anything}})),by([String$("Gavin",5)].reifyCeylonType({Absent:{t:Null},Element:{t:String$}})),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Category']};
...
function $init$Category(){
    if (Category.$$===undefined){
        ...
        (function($$category){
            ...
            };$$category.containsEvery.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:Boolean$},$ps:[{$nm:'elements',$mt:'prm',$t:{t:Iterable,a:{Absent:{t:Null},Element:{t:Object$}}}}],$an:function(){return[doc(String$("Determines if every one of the given values belongs\nto this `Category`.",71)),see([$JsCallable($$category.contains,[{$nm:'element',$mt:'prm',$t:{t:Object$}}],{Arguments:{t:Tuple,a:{Rest:{t:Empty},First:{t:Object$},Element:{t:Object$}}},Return:{t:Boolean$}})].reifyCeylonType({Absent:{t:Null},Element:{t:Callable,a:{Arguments:{t:Tuple,a:{Rest:{t:Empty},First:{t:Object$},Element:{t:Object$}}},Return:{t:Boolean$}}}})),shared(),$default()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Category']['$m']['containsEvery']};$$category.containsAny=function containsAny(elements$215){
                var $$category=this;
            ...
            };$$category.containsAny.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:Boolean$},$ps:[{$nm:'elements',$mt:'prm',$t:{t:Iterable,a:{Absent:{t:Null},Element:{t:Object$}}}}],$an:function(){return[doc(String$("Determines if any one of the given values belongs \nto this `Category`",69)),see([$JsCallable($$category.contains,[{$nm:'element',$mt:'prm',$t:{t:Object$}}],{Arguments:{t:Tuple,a:{Rest:{t:Empty},First:{t:Object$},Element:{t:Object$}}},Return:{t:Boolean$}})].reifyCeylonType({Absent:{t:Null},Element:{t:Callable,a:{Arguments:{t:Tuple,a:{Rest:{t:Empty},First:{t:Object$},Element:{t:Object$}}},Return:{t:Boolean$}}}})),shared(),$default()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Category']['$m']['containsAny']};
        })(Category.$$.prototype);
    }
    return Category;
}
...
function $init$List(){
    if (List.$$===undefined){
        ...
        (function($$list){
            ...
            $$list.defines.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:Boolean$},$ps:[{$nm:'index',$mt:'prm',$t:{t:Integer}}],$an:function(){return[doc(String$("Determines if the given index refers to an element\nof this sequence, that is, if\n`index<=sequence.lastIndex`.",109)),shared(),actual(),$default()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['List']['$m']['defines']};
            $$list.iterator=function iterator(){
                ...
                (function($$listIterator$221){
                    ...
                    $$listIterator$221.next=function next(){
                        ...
                        if(($$listIterator$221.index$222.compare((opt$224=$$list.lastIndex,opt$224!==null?opt$224:(-(1))))!==getLarger())){
                            ...
                            var elem$225;
                            if (!(isOfType((elem$225=$$list.get((oldindex$226=$$listIterator$221.index$222,$$listIterator$221.index$222=oldindex$226.successor,oldindex$226))),$$list.$$targs$$.Element))) { throw AssertionException('Assertion failed: \'is Element elem = outer.get(index++)\' at List.ceylon (61:27-61:64)'); }
                            var oldindex$226;
                            return elem$225;
                        }else {
                            return getFinished();
                ...
                return false;
            };$$list.equals.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:Boolean$},$ps:[{$nm:'that',$mt:'prm',$t:{t:Object$}}],$an:function(){return[doc(String$("Two `List`s are considered equal iff they have the \nsame `size` and _entry sets_. The entry set of a \nlist `l` is the set of elements of `l.indexed`. \nThis definition is equivalent to the more intuitive \nnotion that two lists are equal iff they have the \nsame `size` and for every index either:\n\n- the lists both have the element `null`, or\n- the lists both have a non-null element, and the\n  two elements are equal.",416)),shared(),actual(),$default()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['List']['$m']['equals']};defineAttr($$list,'hash',function()/*anotaciones:ceylon.language::Shared,ceylon.language::Actual,ceylon.language::Default,*/{
                var $$list=this;
                var hash$237=(1);
            ...
            defineAttr($$list,'last',function()/*anotaciones:ceylon.language::Doc,ceylon.language::Shared,ceylon.language::Actual,ceylon.language::Default,*/{
                ...
                var seq$245;
                if (!(nonempty((seq$245=sb$244.sequence)))) { throw AssertionException('Assertion failed: \'nonempty seq=sb.sequence\' at List.ceylon (163:15-163:40)'); }
                return seq$245;
            };$$list.withLeading.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:Sequence,a:{Element:{ t:'u', l:['Element','Other']}}},$ps:[{$nm:'element',$mt:'prm',$t:'Other'}],$tp:{Other:{}},$an:function(){return[doc(String$("Returns a new `List` that starts with the specified\nelement, followed by the elements of this `List`.",101)),see([$$list.following].reifyCeylonType({Absent:{t:Null},Element:{t:Anything}})),shared(),$default()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['List']['$m']['withLeading']};$$list.withTrailing=function withTrailing(element$246,$$$mptypes){
                var $$list=this;
                ...
                var seq$248;
                if (!(nonempty((seq$248=sb$247.sequence)))) { throw AssertionException('Assertion failed: \'nonempty seq=sb.sequence\' at List.ceylon (178:15-178:40)'); }
                return seq$248;
            };$$list.withTrailing.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:Sequence,a:{Element:{ t:'u', l:['Element','Other']}}},$ps:[{$nm:'element',$mt:'prm',$t:'Other'}],$tp:{Other:{}},$an:function(){return[doc(String$("Returns a new `List` that contains the specified\nelement appended to the end of the elements of this \n`List`.",109)),shared(),$default()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['List']['$m']['withTrailing']};
        })(List.$$.prototype);
    }
    return List;
}
...
ChainedIterator.$$metamodel$$={mod:$$METAMODEL$$,'super':{t:Basic},$tp:{Element:{'var':'out',},Other:{'var':'out',}},satisfies:[{t:Iterator,a:{Element:{ t:'u', l:['Element','Other']}}}],$an:function(){return[doc(String$("An `Iterator` that returns the elements of two\n`Iterable`s, as if they were chained together.",93)),by([String$("Enrique Zamudio",15)].reifyCeylonType({Absent:{t:Null},Element:{t:String$}}))];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['ChainedIterator']};
...
Entry.$$metamodel$$={mod:$$METAMODEL$$,'super':{t:Object$},$tp:{Key:{'var':'out','satisfies':[{t:Object$}]},Item:{'var':'out','satisfies':[{t:Object$}]}},satisfies:[],$an:function(){return[doc(String$("A pair containing a _key_ and an associated value called \nthe _item_. Used primarily to represent the elements of \na `Map`. The type `Entry<Key,Item>` may be abbreviated \n`Key->Item`. An instance of `Entry` may be constructed \nusing the `->` operator:\n\n    String->Person entry = person.name->person;\n",301)),by([String$("Gavin",5)].reifyCeylonType({Absent:{t:Null},Element:{t:String$}})),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Entry']};
exports.Entry=Entry;
function $init$Entry(){
    if (Entry.$$===undefined){
        ...
        (function($$entry){
            ...
            };$$entry.equals.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:Boolean$},$ps:[{$nm:'that',$mt:'prm',$t:{t:Object$}}],$an:function(){return[doc(String$("Determines if this entry is equal to the given\nentry. Two entries are equal if they have the same\nkey and the same value.",121)),shared(),actual()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Entry']['$m']['equals']};defineAttr($$entry,'hash',function(){
                var $$entry=this;
...
Comparable.$$metamodel$$={mod:$$METAMODEL$$,$tp:{Other:{'var':'in','satisfies':[{t:Comparable,a:{Other:'Other'}}]}},satisfies:[],$an:function(){return[doc(String$("The general contract for values whose magnitude can be \ncompared. `Comparable` imposes a total ordering upon\ninstances of any type that satisfies the interface.\nIf a type `T` satisfies `Comparable<T>`, then instances\nof `T` may be compared using the comparison operators\n`<`, `>`, `<=`, >=`, and `<=>`.\n\nThe total order of a type must be consistent with the \ndefinition of equality for the type. That is, there\nare three mutually exclusive possibilities:\n\n- `x<y`,\n- `x>y`, or\n- `x==y`",485)),by([String$("Gavin",5)].reifyCeylonType({Absent:{t:Null},Element:{t:String$}})),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Comparable']};
...
Invertable.$$metamodel$$={mod:$$METAMODEL$$,$tp:{Inverse:{'var':'out',}},satisfies:[],$an:function(){return[doc(String$("Abstraction of types which support a unary additive inversion\noperation. For a numeric type, this should return the \nnegative of the argument value. Note that the type \nparameter of this interface is not restricted to be a \nself type, in order to accommodate the possibility of \ntypes whose additive inverse can only be expressed in terms of \na wider type.",356)),see([$JsCallable(Integer,[],{Arguments:{t:Tuple,a:{Rest:{t:Empty},First:{t:Integer},Element:{t:Integer}}},Return:{t:Integer}}),$JsCallable(Float,[],{Arguments:{t:Tuple,a:{Rest:{t:Empty},First:{t:Float},Element:{t:Float}}},Return:{t:Float}})].reifyCeylonType({Absent:{t:Null},Element:{ t:'u', l:[{t:Callable,a:{Arguments:{t:Tuple,a:{Rest:{t:Empty},First:{t:Integer},Element:{t:Integer}}},Return:{t:Integer}}},{t:Callable,a:{Arguments:{t:Tuple,a:{Rest:{t:Empty},First:{t:Float},Element:{t:Float}}},Return:{t:Float}}}]}})),by([String$("Gavin",5)].reifyCeylonType({Absent:{t:Null},Element:{t:String$}})),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Invertable']};
...
Summable.$$metamodel$$={mod:$$METAMODEL$$,$tp:{Other:{'satisfies':[{t:Summable,a:{Other:'Other'}}]}},satisfies:[],$an:function(){return[doc(String$("Abstraction of types which support a binary addition\noperator. For numeric types, this is just familiar \nnumeric addition. For strings, it is string \nconcatenation. In general, the addition operation \nshould be a binary associative operation.",242)),see([$JsCallable(String,[],{Arguments:{t:Tuple,a:{Rest:{t:Empty},First:{t:String$},Element:{t:String$}}},Return:{t:String$}}),Numeric].reifyCeylonType({Absent:{t:Null},Element:{t:Anything}})),by([String$("Gavin",5)].reifyCeylonType({Absent:{t:Null},Element:{t:String$}})),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Summable']};
...
Ordinal.$$metamodel$$={mod:$$METAMODEL$$,$tp:{Other:{'var':'out','satisfies':[{t:Ordinal,a:{Other:'Other'}}]}},satisfies:[],$an:function(){return[doc(String$("Abstraction of ordinal types, that is, types with \nsuccessor and predecessor operations, including\n`Integer` and other `Integral` numeric types.\n`Character` is also considered an ordinal type. \n`Ordinal` types may be used to generate a `Range`.",244)),see([$JsCallable(Character,[],{Arguments:{t:Tuple,a:{Rest:{t:Empty},First:{t:Character},Element:{t:Character}}},Return:{t:Character}}),$JsCallable(Integer,[],{Arguments:{t:Tuple,a:{Rest:{t:Empty},First:{t:Integer},Element:{t:Integer}}},Return:{t:Integer}}),Integral,Range].reifyCeylonType({Absent:{t:Null},Element:{t:Anything}})),by([String$("Gavin",5)].reifyCeylonType({Absent:{t:Null},Element:{t:String$}})),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Ordinal']};
...
Enumerable.$$metamodel$$={mod:$$METAMODEL$$,$tp:{Other:{'var':'out','satisfies':[{t:Enumerable,a:{Other:'Other'}}]}},satisfies:[{t:Ordinal,a:{Other:'Other'}}],$an:function(){return[doc(String$("Abstraction of ordinal types whose instances can be \nmapped to the integers or to a range of integers.",102)),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Enumerable']};
...
Numeric.$$metamodel$$={mod:$$METAMODEL$$,$tp:{Other:{'satisfies':[{t:Numeric,a:{Other:'Other'}}]}},satisfies:[{t:Summable,a:{Other:'Other'}},{t:Invertable,a:{Inverse:'Other'}}],$an:function(){return[doc(String$("Abstraction of numeric types supporting addition,\nsubtraction, multiplication, and division, including\n`Integer` and `Float`. Additionally, a numeric type \nis expected to define a total order via an \nimplementation of `Comparable`.",231)),see([$JsCallable(Integer,[],{Arguments:{t:Tuple,a:{Rest:{t:Empty},First:{t:Integer},Element:{t:Integer}}},Return:{t:Integer}}),$JsCallable(Float,[],{Arguments:{t:Tuple,a:{Rest:{t:Empty},First:{t:Float},Element:{t:Float}}},Return:{t:Float}}),Comparable].reifyCeylonType({Absent:{t:Null},Element:{t:Anything}})),by([String$("Gavin",5)].reifyCeylonType({Absent:{t:Null},Element:{t:String$}})),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Numeric']};
...
Scalar.$$metamodel$$={mod:$$METAMODEL$$,$tp:{Other:{'satisfies':[{t:Scalar,a:{Other:'Other'}}]}},satisfies:[{t:Numeric,a:{Other:'Other'}},{t:Comparable,a:{Other:'Other'}},{t:Number$}],$an:function(){return[doc(String$("Abstraction of numeric types representing scalar\nvalues, including `Integer` and `Float`.",89)),see([$JsCallable(Integer,[],{Arguments:{t:Tuple,a:{Rest:{t:Empty},First:{t:Integer},Element:{t:Integer}}},Return:{t:Integer}}),$JsCallable(Float,[],{Arguments:{t:Tuple,a:{Rest:{t:Empty},First:{t:Float},Element:{t:Float}}},Return:{t:Float}})].reifyCeylonType({Absent:{t:Null},Element:{ t:'u', l:[{t:Callable,a:{Arguments:{t:Tuple,a:{Rest:{t:Empty},First:{t:Integer},Element:{t:Integer}}},Return:{t:Integer}}},{t:Callable,a:{Arguments:{t:Tuple,a:{Rest:{t:Empty},First:{t:Float},Element:{t:Float}}},Return:{t:Float}}}]}})),by([String$("Gavin",5)].reifyCeylonType({Absent:{t:Null},Element:{t:String$}})),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Scalar']};
...
Exponentiable.$$metamodel$$={mod:$$METAMODEL$$,$tp:{This:{'satisfies':[{t:Exponentiable,a:{Other:'Other',This:'This'}}]},Other:{'satisfies':[{t:Numeric,a:{Other:'Other'}}]}},satisfies:[{t:Numeric,a:{Other:'This'}}],$an:function(){return[doc(String$("Abstraction of numeric types that may be raised to a\npower. Note that the type of the exponent may be\ndifferent to the numeric type which can be \nexponentiated.",160)),see([$JsCallable(Integer,[],{Arguments:{t:Tuple,a:{Rest:{t:Empty},First:{t:Integer},Element:{t:Integer}}},Return:{t:Integer}}),$JsCallable(Float,[],{Arguments:{t:Tuple,a:{Rest:{t:Empty},First:{t:Float},Element:{t:Float}}},Return:{t:Float}})].reifyCeylonType({Absent:{t:Null},Element:{ t:'u', l:[{t:Callable,a:{Arguments:{t:Tuple,a:{Rest:{t:Empty},First:{t:Integer},Element:{t:Integer}}},Return:{t:Integer}}},{t:Callable,a:{Arguments:{t:Tuple,a:{Rest:{t:Empty},First:{t:Float},Element:{t:Float}}},Return:{t:Float}}}]}})),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Exponentiable']};
...
Integral.$$metamodel$$={mod:$$METAMODEL$$,$tp:{Other:{'satisfies':[{t:Integral,a:{Other:'Other'}}]}},satisfies:[{t:Numeric,a:{Other:'Other'}},{t:Enumerable,a:{Other:'Other'}}],$an:function(){return[doc(String$("Abstraction of integral numeric types. That is, types \nwith no fractional part, including `Integer`. The \ndivision operation for integral numeric types results \nin a remainder. Therefore, integral numeric types have \nan operation to determine the remainder of any division \noperation.",284)),see([$JsCallable(Integer,[],{Arguments:{t:Tuple,a:{Rest:{t:Empty},First:{t:Integer},Element:{t:Integer}}},Return:{t:Integer}})].reifyCeylonType({Absent:{t:Null},Element:{t:Callable,a:{Arguments:{t:Tuple,a:{Rest:{t:Empty},First:{t:Integer},Element:{t:Integer}}},Return:{t:Integer}}}})),by([String$("Gavin",5)].reifyCeylonType({Absent:{t:Null},Element:{t:String$}})),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Integral']};
...
NegativeNumberException.$$metamodel$$={mod:$$METAMODEL$$,'super':{t:Exception},satisfies:[],$an:function(){return[doc(String$("Thrown when a negative number is not allowed.",45)),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['NegativeNumberException']};
...
OverflowException.$$metamodel$$={mod:$$METAMODEL$$,'super':{t:Exception},satisfies:[],$an:function(){return[doc(String$("Thrown when a mathematical operation caused a number to overflow from its bounds.",81)),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['OverflowException']};
...
InitializationException.$$metamodel$$={mod:$$METAMODEL$$,'super':{t:Exception},satisfies:[],$an:function(){return[doc(String$("Thrown when a problem was detected with value initialization.\n\nPossible problems include:\n\n* when a value could not be initialized due to recursive access during initialization, \n* an attempt to use a `late` value before it was initialized, \n* an attempt to assign to a `late` but non-`variable` value after it was initialized.",327)),see([$JsCallable(late,[],{Arguments:{t:Empty},Return:{t:Late}})].reifyCeylonType({Absent:{t:Null},Element:{t:Callable,a:{Arguments:{t:Empty},Return:{t:Late}}}})),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['InitializationException']};
...
Set.$$metamodel$$={mod:$$METAMODEL$$,$tp:{Element:{'var':'out','satisfies':[{t:Object$}]}},satisfies:[{t:Collection,a:{Element:'Element'}},{t:Cloneable,a:{Clone:{t:Set,a:{Element:'Element'}}}}],$an:function(){return[doc(String$("A collection of unique elements.\n\nA `Set` is a `Collection` of its elements.\n\nSets may be the subject of the binary union, \nintersection, exclusive union, and complement operators \n`|`, `&`, `^`, and `~`.",204)),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Set']};
exports.Set=Set;
function $init$Set(){
    if (Set.$$===undefined){
        ...
        (function($$set){
            $$set.superset=function superset(set$295){
            ...
            };$$set.superset.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:Boolean$},$ps:[{$nm:'set',$mt:'prm',$t:{t:Set,a:{Element:{t:Object$}}}}],$an:function(){return[doc(String$("Determines if this `Set` is a superset of the \nspecified Set, that is, if this `Set` contains all \nof the elements in the specified `Set`.",138)),shared(),$default()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Set']['$m']['superset']};$$set.subset=function subset(set$298){
                var $$set=this;
            ...
            };$$set.subset.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:Boolean$},$ps:[{$nm:'set',$mt:'prm',$t:{t:Set,a:{Element:{t:Object$}}}}],$an:function(){return[doc(String$("Determines if this `Set` is a subset of the given \n`Set`, that is, if the given set contains all of \nthe elements in this set.",126)),shared(),$default()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Set']['$m']['subset']};$$set.equals=function equals(that$301){
                var $$set=this;
                var that$302;
                ...
                return false;
            };$$set.equals.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:Boolean$},$ps:[{$nm:'that',$mt:'prm',$t:{t:Object$}}],$an:function(){return[doc(String$("Two `Set`s are considered equal if they have the \nsame size and if every element of the first set is\nalso an element of the second set, as determined\nby `contains()`.",166)),shared(),actual(),$default()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Set']['$m']['equals']};defineAttr($$set,'hash',function()/*anotaciones:ceylon.language::Shared,ceylon.language::Actual,ceylon.language::Default,*/{
                var $$set=this;
                var hashCode$305=(1);
...
Range.$$metamodel$$={mod:$$METAMODEL$$,'super':{t:Object$},$tp:{Element:{'satisfies':[{t:Ordinal,a:{Other:'Element'}},{t:Comparable,a:{Other:'Element'}}]}},satisfies:[{t:Sequence,a:{Element:'Element'}},{t:Cloneable,a:{Clone:{t:Range,a:{Element:'Element'}}}}],$an:function(){return[doc(String$("Represents the range of totally ordered, ordinal values \ngenerated by two endpoints of type `Ordinal` and \n`Comparable`. If the first value is smaller than the\nlast value, the range is increasing. If the first value\nis larger than the last value, the range is decreasing.\nIf the two values are equal, the range contains exactly\none element. The range is always nonempty, containing \nat least one value.\n\nA range may be produced using the `..` operator:\n\n    for (i in min..max) { ... }\n    if (char in `A`..`Z`) { ... }\n",520)),by([String$("Gavin",5)].reifyCeylonType({Absent:{t:Null},Element:{t:String$}})),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Range']};
exports.Range=Range;
function $init$Range(){
    if (Range.$$===undefined){
        ...
        (function($$range){
            ...
            defineAttr($$range,'rest',function()/*anotaciones:ceylon.language::Doc,ceylon.language::Shared,ceylon.language::Actual,*/{
                ...
                return x$328;
            };$$range.get.$$metamodel$$={mod:$$METAMODEL$$,$t:{ t:'u', l:[{t:Null},'Element']},$ps:[{$nm:'n',$mt:'prm',$t:{t:Integer}}],$an:function(){return[doc(String$("The element of the range that occurs `n` values after\nthe start of the range. Note that this operation \nis inefficient for large ranges.",136)),shared(),actual()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Range']['$m']['get']};$$range.iterator=function iterator(){
                var $$range=this;
                ...
                $init$RangeIterator$330();
                return RangeIterator$330();
            };$$range.iterator.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:Iterator,a:{Element:'Element'}},$ps:[],$an:function(){return[doc(String$("An iterator for the elements of the range.",42)),shared(),actual()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Range']['$m']['iterator']};$$range.by=function by(step$336){
                var $$range=this;
            ...
            };$$range.contains.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:Boolean$},$ps:[{$nm:'element',$mt:'prm',$t:{t:Object$}}],$an:function(){return[doc(String$("Determines if the range includes the given object.",50)),shared(),actual()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Range']['$m']['contains']};$$range.count=function count(selecting$341){
                var $$range=this;
            ...
            $$range.includes.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:Boolean$},$ps:[{$nm:'x',$mt:'prm',$t:'Element'}],$an:function(){return[doc(String$("Determines if the range includes the given value.",49)),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Range']['$m']['includes']};
            ...
            };$$range.equals.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:Boolean$},$ps:[{$nm:'that',$mt:'prm',$t:{t:Object$}}],$an:function(){return[doc(String$("Determines if two ranges are the same by comparing\ntheir endpoints.",67)),shared(),actual()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Range']['$m']['equals']};defineAttr($$range,'clone',function(){
                var $$range=this;
                return $$range;
            });
...
Singleton.$$metamodel$$={mod:$$METAMODEL$$,'super':{t:Object$},$tp:{Element:{'var':'out',}},satisfies:[{t:Sequence,a:{Element:'Element'}}],$an:function(){return[doc(String$("A sequence with exactly one element, which may be null.",55)),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Singleton']};
...
function $init$Singleton(){
    if (Singleton.$$===undefined){
        ...
        (function($$singleton){
            ...
            };$$singleton.get.$$metamodel$$={mod:$$METAMODEL$$,$t:{ t:'u', l:[{t:Null},'Element']},$ps:[{$nm:'index',$mt:'prm',$t:{t:Integer}}],$an:function(){return[doc(String$("Returns the contained element, if the specified \nindex is `0`.",62)),shared(),actual()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Singleton']['$m']['get']};defineAttr($$singleton,'clone',function(){
                var $$singleton=this;
                return $$singleton;
            });
            ...
            $$singleton.segment.$$metamodel$$={mod:$$METAMODEL$$,$t:{ t:'u', l:[{t:Empty},{t:Singleton,a:{Element:'Element'}}]},$ps:[{$nm:'from',$mt:'prm',$t:{t:Integer}},{$nm:'length',$mt:'prm',$t:{t:Integer}}],$an:function(){return[doc(String$("Returns a `Singleton` if the given starting index \nis `0` and the given `length` is greater than `0`.\nOtherwise, returns an instance of `Empty`.",144)),shared(),actual()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Singleton']['$m']['segment']};
            ...
            $$singleton.span.$$metamodel$$={mod:$$METAMODEL$$,$t:{ t:'u', l:[{t:Empty},{t:Singleton,a:{Element:'Element'}}]},$ps:[{$nm:'from',$mt:'prm',$t:{t:Integer}},{$nm:'to',$mt:'prm',$t:{t:Integer}}],$an:function(){return[doc(String$("Returns a `Singleton` if the given starting index \nis `0`. Otherwise, returns an instance of `Empty`.",101)),shared(),actual()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Singleton']['$m']['span']};
            ...
            $$singleton.equals=function equals(that$412){
                ...
                return false;
            };$$singleton.equals.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:Boolean$},$ps:[{$nm:'that',$mt:'prm',$t:{t:Object$}}],$an:function(){return[doc(String$("A `Singleton` can be equal to another `List` if \nthat `List` has only one element which is equal to \nthis `Singleton`\'s element.",128)),shared(),actual()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Singleton']['$m']['equals']};defineAttr($$singleton,'hash',function(){
                var $$singleton=this;
            ...
            $$singleton.contains=function contains(element$418){
                ...
                return false;
            };$$singleton.contains.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:Boolean$},$ps:[{$nm:'element',$mt:'prm',$t:{t:Object$}}],$an:function(){return[doc(String$("Returns `true` if the specified element is this \n`Singleton`\'s element.",71)),shared(),actual()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Singleton']['$m']['contains']};$$singleton.count=function (selecting$420){
                var $$singleton=this;
                return (opt$421=(selecting$420($$singleton.element$395)?(1):null),opt$421!==null?opt$421:(0));
            };
            $$singleton.count.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:Integer},$ps:[{$nm:'selecting',$mt:'prm',$t:{t:Boolean$}}],$an:function(){return[doc(String$("Returns `1` if this `Singleton`\'s element\nsatisfies the predicate, or `0` otherwise.",84)),shared(),actual()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Singleton']['$m']['count']};
...
AssertionException.$$metamodel$$={mod:$$METAMODEL$$,'super':{t:Exception},satisfies:[],$an:function(){return[doc(String$("An exception that occurs when an assertion fails, that\nis, when a condition in an `assert` statement evaluates\nto false at runtime.",131)),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['AssertionException']};
...
function $init$Map(){
    if (Map.$$===undefined){
        ...
        (function($$map){
            ...
            };$$map.equals.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:Boolean$},$ps:[{$nm:'that',$mt:'prm',$t:{t:Object$}}],$an:function(){return[doc(String$("Two `Map`s are considered equal iff they have the \nsame _entry sets_. The entry set of a `Map` is the\nset of `Entry`s belonging to the map. Therefore, the\nmaps are equal iff they have same set of `keys`, and \nfor every key in the key set, the maps have equal\nitems.",265)),shared(),actual(),$default()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Map']['$m']['equals']};defineAttr($$map,'hash',function()/*anotaciones:ceylon.language::Shared,ceylon.language::Actual,ceylon.language::Default,*/{
                var $$map=this;
                var hashCode$443=(1);
            ...
            $$map.mapItems.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:Map,a:{Key:'Key',Item:'Result'}},$ps:[{$nm:'mapping',$mt:'prm',$t:'Result'}],$tp:{Result:{'satisfies':[{t:Object$}]}},$an:function(){return[doc(String$("Returns a `Map` with the same keys as this map. For\nevery key, the item is the result of applying the\ngiven transformation function.",132)),shared(),$default()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['Map']['$m']['mapItems']};
        })(Map.$$.prototype);
    }
    return Map;
}
...
LazyMap.$$metamodel$$={mod:$$METAMODEL$$,'super':{t:Basic},$tp:{Key:{'var':'out','satisfies':[{t:Object$}]},Item:{'var':'out','satisfies':[{t:Object$}]}},satisfies:[{t:Map,a:{Key:'Key',Item:'Item'}}],$an:function(){return[doc(String$("A Map implementation that wraps an `Iterable` of \nentries. All operations, such as lookups, size, etc. \nare performed on the `Iterable`.",136)),by([String$("Enrique Zamudio",15)].reifyCeylonType({Absent:{t:Null},Element:{t:String$}})),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['LazyMap']};
...
LazyList.$$metamodel$$={mod:$$METAMODEL$$,'super':{t:Basic},$tp:{Element:{'var':'out',}},satisfies:[{t:List,a:{Element:'Element'}}],$an:function(){return[doc(String$("An implementation of List that wraps an `Iterable` of\nelements. All operations on this List are performed on \nthe Iterable.",123)),by([String$("Enrique Zamudio",15)].reifyCeylonType({Absent:{t:Null},Element:{t:String$}})),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['LazyList']};
...
LazySet.$$metamodel$$={mod:$$METAMODEL$$,'super':{t:Basic},$tp:{Element:{'var':'out','satisfies':[{t:Object$}]}},satisfies:[{t:Set,a:{Element:'Element'}}],$an:function(){return[doc(String$("An implementation of Set that wraps an `Iterable` of\nelements. All operations on this Set are performed\non the `Iterable`.",122)),by([String$("Enrique Zamudio",15)].reifyCeylonType({Absent:{t:Null},Element:{t:String$}})),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['LazySet']};
...
;
byDecreasing.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:Comparison},$ps:[{$nm:'comparable',$mt:'prm',$t:'Value'}],$tp:{Element:{},Value:{'satisfies':[{t:Comparable,a:{Other:'Value'}}]}},$an:function(){return[doc(String$("A comparator which orders elements in decreasing order \naccording to the `Comparable` returned by the given \n`comparable()` function.",133)),see([byIncreasing].reifyCeylonType({Absent:{t:Null},Element:{t:Anything}})),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['byDecreasing']};
...
;
byIncreasing.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:Comparison},$ps:[{$nm:'comparable',$mt:'prm',$t:'Value'}],$tp:{Element:{},Value:{'satisfies':[{t:Comparable,a:{Other:'Value'}}]}},$an:function(){return[doc(String$("A comparator which orders elements in increasing order \naccording to the `Comparable` returned by the given \n`comparable()` function.",133)),see([byDecreasing].reifyCeylonType({Absent:{t:Null},Element:{t:Anything}})),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['byIncreasing']};
...
;
byItem.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:Comparison},$ps:[{$nm:'comparing',$mt:'prm',$t:{t:Comparison}}],$tp:{Item:{'satisfies':[{t:Object$}]}},$an:function(){return[doc(String$("A comparator for `Entry`s which compares their items \naccording to the given `comparing()` function.",100)),see([byKey].reifyCeylonType({Absent:{t:Null},Element:{t:Anything}})),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['byItem']};
...
;
byKey.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:Comparison},$ps:[{$nm:'comparing',$mt:'prm',$t:{t:Comparison}}],$tp:{Key:{'satisfies':[{t:Object$}]}},$an:function(){return[doc(String$("A comparator for `Entry`s which compares their keys \naccording to the given `comparing()` function.",99)),see([byItem].reifyCeylonType({Absent:{t:Null},Element:{t:Anything}})),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['byKey']};
exports.byKey=byKey;
var coalesce=function (values$589,$$$mptypes){
    return values$589.coalesced;
};
coalesce.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:Iterable,a:{Absent:{t:Null},Element:{ t:'i', l:['Element',{t:Object$}]}}},$ps:[{$nm:'values',$mt:'prm',$t:{t:Iterable,a:{Absent:{t:Null},Element:'Element'}}}],$tp:{Element:{}},$an:function(){return[doc(String$("Return a sequence containing the given values which are\nnot null. If there are no values which are not null,\nreturn an empty sequence.",134)),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['coalesce']};
...
entries.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:Iterable,a:{Absent:{t:Null},Element:{t:Entry,a:{Key:{t:Integer},Item:{ t:'i', l:['Element',{t:Object$}]}}}}},$ps:[{$nm:'elements',$mt:'prm',$t:{t:Iterable,a:{Absent:{t:Null},Element:'Element'}}}],$tp:{Element:{}},$an:function(){return[doc(String$("Produces a sequence of each index to element `Entry` \nfor the given sequence of values.",87)),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['entries']};
...
;
equalTo.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:Boolean$},$ps:[{$nm:'val',$mt:'prm',$t:'Element'}],$tp:{Element:{'satisfies':[{t:Object$}]}},$an:function(){return[doc(String$("Returns a partial function that will compare an element\nto any other element and returns true if they\'re equal.\nThis is useful in conjunction with methods that receive\na predicate function.",189)),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['equalTo']};
...
exports.every=every;
every.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:Boolean$},$ps:[{$nm:'values',$mt:'prm',$t:{t:Iterable,a:{Absent:{t:Null},Element:{t:Boolean$}}}}],$an:function(){return[doc(String$("Determines if every one of the given boolean values \n(usually a comprehension) is `true`.",89)),see([$JsCallable(any,[{$nm:'values',$mt:'prm',$t:{t:Iterable,a:{Absent:{t:Null},Element:{t:Boolean$}}}}],{Arguments:{t:Tuple,a:{Rest:{t:Empty},First:{t:Iterable,a:{Absent:{t:Null},Element:{t:Boolean$}}},Element:{t:Iterable,a:{Absent:{t:Null},Element:{t:Boolean$}}}}},Return:{t:Boolean$}})].reifyCeylonType({Absent:{t:Null},Element:{t:Callable,a:{Arguments:{t:Tuple,a:{Rest:{t:Empty},First:{t:Iterable,a:{Absent:{t:Null},Element:{t:Boolean$}}},Element:{t:Iterable,a:{Absent:{t:Null},Element:{t:Boolean$}}}}},Return:{t:Boolean$}}}})),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['every']};//every.$$targs$$={Arguments:{t:Tuple,a:{Rest:{t:Empty},First:{t:Iterable,a:{Absent:{t:Null},Element:{t:Boolean$}}},Element:{t:Iterable,a:{Absent:{t:Null},Element:{t:Boolean$}}}}},Return:{t:Boolean$}};
...
exports.first=first;
first.$$metamodel$$={mod:$$METAMODEL$$,$t:{ t:'u', l:['Absent','Value']},$ps:[{$nm:'values',$mt:'prm',$t:{t:Iterable,a:{Absent:'Absent',Element:'Value'}}}],$tp:{Value:{},Absent:{'satisfies':[{t:Null}]}},$an:function(){return[doc(String$("The first of the given elements (usually a comprehension),\nif any.",66)),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['first']};//first.$$targs$$={Arguments:{t:Tuple,a:{Rest:{t:Empty},First:{t:Iterable,a:{Absent:$$$mptypes.Absent,Element:$$$mptypes.Value}},Element:{t:Iterable,a:{Absent:$$$mptypes.Absent,Element:$$$mptypes.Value}}}},Return:{ t:'u', l:[$$$mptypes.Absent,$$$mptypes.Value]}};
...
;
forItem.$$metamodel$$={mod:$$METAMODEL$$,$t:'Result',$ps:[{$nm:'resulting',$mt:'prm',$t:'Result'}],$tp:{Item:{'satisfies':[{t:Object$}]},Result:{}},$an:function(){return[doc(String$("A function that returns the result of the given `resulting()` function \non the item of a given `Entry`.",103)),see([forKey].reifyCeylonType({Absent:{t:Null},Element:{t:Anything}})),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['forItem']};
...
;
forKey.$$metamodel$$={mod:$$METAMODEL$$,$t:'Result',$ps:[{$nm:'resulting',$mt:'prm',$t:'Result'}],$tp:{Key:{'satisfies':[{t:Object$}]},Result:{}},$an:function(){return[doc(String$("A function that returns the result of the given `resulting()` function \non the key of a given `Entry`.",102)),see([forItem].reifyCeylonType({Absent:{t:Null},Element:{t:Anything}})),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['forKey']};
...
;
greaterThan.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:Boolean$},$ps:[{$nm:'val',$mt:'prm',$t:'Element'}],$tp:{Element:{'satisfies':[{t:Comparable,a:{Other:'Element'}}]}},$an:function(){return[doc(String$("Returns a partial function that will compare an element\nto any other element and returns true if the compared\nelement is greater than its element.\nThis is useful in conjunction with methods that receive\na predicate function.",224)),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['greaterThan']};
...
join.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:Sequential,a:{Element:'Element'}},$ps:[{$nm:'iterables',$mt:'prm',seq:1,$t:{t:Sequential,a:{Element:{t:Iterable,a:{Absent:{t:Null},Element:'Element'}}}}}],$tp:{Element:{}},$an:function(){return[doc(String$("Given a list of iterable objects, return a new sequence \nof all elements of the all given objects. If there are\nno arguments, or if none of the arguments contains any\nelements, return the empty sequence.",203)),see([SequenceBuilder].reifyCeylonType({Absent:{t:Null},Element:{t:Anything}})),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['join']};
exports.join=join;
...
largest.$$metamodel$$={mod:$$METAMODEL$$,$t:'Element',$ps:[{$nm:'x',$mt:'prm',$t:'Element'},{$nm:'y',$mt:'prm',$t:'Element'}],$tp:{Element:{'satisfies':[{t:Comparable,a:{Other:'Element'}}]}},$an:function(){return[doc(String$("Given two `Comparable` values, return largest of the\ntwo.",57)),see([Comparable,smallest,max].reifyCeylonType({Absent:{t:Null},Element:{t:Anything}})),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['largest']};
...
;
lessThan.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:Boolean$},$ps:[{$nm:'val',$mt:'prm',$t:'Element'}],$tp:{Element:{'satisfies':[{t:Comparable,a:{Other:'Element'}}]}},$an:function(){return[doc(String$("Returns a partial function that will compare an element\nto any other element and returns true if the compared\nelement is less than its element.\nThis is useful in conjunction with methods that receive\na predicate function.",221)),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['lessThan']};
...
exports.max=max;
max.$$metamodel$$={mod:$$METAMODEL$$,$t:{ t:'u', l:['Absent','Value']},$ps:[{$nm:'values',$mt:'prm',$t:{t:Iterable,a:{Absent:'Absent',Element:'Value'}}}],$tp:{Value:{'satisfies':[{t:Comparable,a:{Other:'Value'}}]},Absent:{'satisfies':[{t:Null}]}},$an:function(){return[doc(String$("Given a nonempty sequence of `Comparable` values, \nreturn the largest value in the sequence.",92)),see([Comparable,min,largest].reifyCeylonType({Absent:{t:Null},Element:{t:Anything}})),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['max']};//max.$$targs$$={Arguments:{t:Tuple,a:{Rest:{t:Empty},First:{t:Iterable,a:{Absent:$$$mptypes.Absent,Element:$$$mptypes.Value}},Element:{t:Iterable,a:{Absent:$$$mptypes.Absent,Element:$$$mptypes.Value}}}},Return:{ t:'u', l:[$$$mptypes.Absent,$$$mptypes.Value]}};
...
exports.min=min;
min.$$metamodel$$={mod:$$METAMODEL$$,$t:{ t:'u', l:['Absent','Value']},$ps:[{$nm:'values',$mt:'prm',$t:{t:Iterable,a:{Absent:'Absent',Element:'Value'}}}],$tp:{Value:{'satisfies':[{t:Comparable,a:{Other:'Value'}}]},Absent:{'satisfies':[{t:Null}]}},$an:function(){return[doc(String$("Given a nonempty sequence of `Comparable` values, \nreturn the smallest value in the sequence.",93)),see([Comparable,max,smallest].reifyCeylonType({Absent:{t:Null},Element:{t:Anything}})),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['min']};//min.$$targs$$={Arguments:{t:Tuple,a:{Rest:{t:Empty},First:{t:Iterable,a:{Absent:$$$mptypes.Absent,Element:$$$mptypes.Value}},Element:{t:Iterable,a:{Absent:$$$mptypes.Absent,Element:$$$mptypes.Value}}}},Return:{ t:'u', l:[$$$mptypes.Absent,$$$mptypes.Value]}};
...
smallest.$$metamodel$$={mod:$$METAMODEL$$,$t:'Element',$ps:[{$nm:'x',$mt:'prm',$t:'Element'},{$nm:'y',$mt:'prm',$t:'Element'}],$tp:{Element:{'satisfies':[{t:Comparable,a:{Other:'Element'}}]}},$an:function(){return[doc(String$("Given two `Comparable` values, return smallest of the\ntwo.",58)),see([Comparable,largest,min].reifyCeylonType({Absent:{t:Null},Element:{t:Anything}})),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['smallest']};
...
exports.sum=sum;
sum.$$metamodel$$={mod:$$METAMODEL$$,$t:'Value',$ps:[{$nm:'values',$mt:'prm',$t:{t:Iterable,a:{Absent:{t:Nothing},Element:'Value'}}}],$tp:{Value:{'satisfies':[{t:Summable,a:{Other:'Value'}}]}},$an:function(){return[doc(String$("Given a nonempty sequence of `Summable` values, return \nthe sum of the values.",78)),see([product].reifyCeylonType({Absent:{t:Null},Element:{t:Anything}})),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['sum']};//sum.$$targs$$={Arguments:{t:Tuple,a:{Rest:{t:Empty},First:{t:Iterable,a:{Absent:{t:Nothing},Element:$$$mptypes.Value}},Element:{t:Iterable,a:{Absent:{t:Nothing},Element:$$$mptypes.Value}}}},Return:$$$mptypes.Value};
...
product.$$metamodel$$={mod:$$METAMODEL$$,$t:'Value',$ps:[{$nm:'values',$mt:'prm',$t:{t:Iterable,a:{Absent:{t:Nothing},Element:'Value'}}}],$tp:{Value:{'satisfies':[{t:Numeric,a:{Other:'Value'}}]}},$an:function(){return[doc(String$("Given a nonempty sequence of `Numeric` values, return \nthe product of the values.",81)),see([sum].reifyCeylonType({Absent:{t:Null},Element:{t:Anything}})),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['product']};//product.$$targs$$={Arguments:{t:Tuple,a:{Rest:{t:Empty},First:{t:Iterable,a:{Absent:{t:Nothing},Element:$$$mptypes.Value}},Element:{t:Iterable,a:{Absent:{t:Nothing},Element:$$$mptypes.Value}}}},Return:$$$mptypes.Value};
...
exports.print=print;
print.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:Anything},$ps:[{$nm:'line',$mt:'prm',$t:{t:Anything}}],$an:function(){return[doc(String$("Print a line to the standard output of the virtual \nmachine process, printing the given value\'s `string`, \nor `«null»` if the value is `null`.\n\nThis method is a shortcut for:\n\n    process.writeLine(line?.string else \"«null»\")\n\nand is intended mainly for debugging purposes.",273)),see([$JsCallable((opt$669=getProcess(),JsCallable(opt$669,opt$669!==null?opt$669.writeLine:null)),[{$nm:'line',$mt:'prm',$def:1,$t:{t:String$}}],{Arguments:{ t:'u', l:[{t:Empty},{t:Tuple,a:{Rest:{t:Empty},First:{t:String$},Element:{t:String$}}}]},Return:{t:Anything}})].reifyCeylonType({Absent:{t:Null},Element:{t:Callable,a:{Arguments:{ t:'u', l:[{t:Empty},{t:Tuple,a:{Rest:{t:Empty},First:{t:String$},Element:{t:String$}}}]},Return:{t:Anything}}}})),by([String$("Gavin",5)].reifyCeylonType({Absent:{t:Null},Element:{t:String$}})),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['print']};//print.$$targs$$={Arguments:{t:Tuple,a:{Rest:{t:Empty},First:{t:Anything},Element:{t:Anything}}},Return:{t:Anything}};
var opt$669;
var getNothing=function()/*anotaciones:ceylon.language::Doc,ceylon.language::Shared,*/{
    throw Exception();
}
exports.getNothing=getNothing;
var identical=function (x$670,y$671){
    return (x$670===y$671);
};
identical.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:Boolean$},$ps:[{$nm:'x',$mt:'prm',$t:{t:Identifiable}},{$nm:'y',$mt:'prm',$t:{t:Identifiable}}],$an:function(){return[doc(String$("Determine if the arguments are identical. Equivalent to\n`x===y`. Only instances of `Identifiable` have \nwell-defined identity.",126)),see([$JsCallable(identityHash,[{$nm:'x',$mt:'prm',$t:{t:Identifiable}}],{Arguments:{t:Tuple,a:{Rest:{t:Empty},First:{t:Identifiable},Element:{t:Identifiable}}},Return:{t:Integer}})].reifyCeylonType({Absent:{t:Null},Element:{t:Callable,a:{Arguments:{t:Tuple,a:{Rest:{t:Empty},First:{t:Identifiable},Element:{t:Identifiable}}},Return:{t:Integer}}}})),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['identical']};
exports.identical=identical;
var compose=function (x$672,y$673,$$$mptypes){
    return flatten($JsCallable(function (args$674){
        return x$672(unflatten($JsCallable(y$673,[],{Arguments:$$$mptypes.Args,Return:$$$mptypes.Y}),{Args:$$$mptypes.Args,Return:$$$mptypes.Y})(args$674));
...
var shuffle=function (f$675,$$$mptypes){
    return flatten($JsCallable(function (secondArgs$676){
        return flatten($JsCallable(function (firstArgs$677){
            return unflatten($JsCallable(unflatten($JsCallable(f$675,[],{Arguments:$$$mptypes.FirstArgs,Return:{t:Callable,a:{Arguments:$$$mptypes.SecondArgs,Return:$$$mptypes.Result}}}),{Args:$$$mptypes.FirstArgs,Return:{t:Callable,a:{Arguments:$$$mptypes.SecondArgs,Return:$$$mptypes.Result}}})(firstArgs$677),[],{Arguments:$$$mptypes.SecondArgs,Return:$$$mptypes.Result}),{Args:$$$mptypes.SecondArgs,Return:$$$mptypes.Result})(secondArgs$676);
...
var plus=function (x$678,y$679,$$$mptypes){
    return x$678.plus(y$679);
};
plus.$$metamodel$$={mod:$$METAMODEL$$,$t:'Value',$ps:[{$nm:'x',$mt:'prm',$t:'Value'},{$nm:'y',$mt:'prm',$t:'Value'}],$tp:{Value:{'satisfies':[{t:Summable,a:{Other:'Value'}}]}},$an:function(){return[doc(String$("Add the given `Summable` values.",32)),see([times,sum].reifyCeylonType({Absent:{t:Null},Element:{t:Anything}})),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['plus']};
exports.plus=plus;
var times=function (x$680,y$681,$$$mptypes){
    return x$680.times(y$681);
};
times.$$metamodel$$={mod:$$METAMODEL$$,$t:'Value',$ps:[{$nm:'x',$mt:'prm',$t:'Value'},{$nm:'y',$mt:'prm',$t:'Value'}],$tp:{Value:{'satisfies':[{t:Numeric,a:{Other:'Value'}}]}},$an:function(){return[doc(String$("Multiply the given `Numeric` values.",36)),see([plus,product].reifyCeylonType({Absent:{t:Null},Element:{t:Anything}})),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['times']};
exports.times=times;
function combine(combination$682,elements$683,otherElements$684,$$$mptypes){
    function iterable$685($$targs$$){
        var $$iterable$685=new iterable$685.$$;
        $$iterable$685.$$targs$$=$$targs$$;
        Iterable($$iterable$685);
        return $$iterable$685;
    }
    function $init$iterable$685(){
        if (iterable$685.$$===undefined){
            initTypeProto(iterable$685,'ceylon.language::combine.iterable',Basic,$init$Iterable());
        }
        return iterable$685;
    }
    $init$iterable$685();
    (function($$iterable$685){
        $$iterable$685.iterator=function iterator(){
            var $$iterable$685=this;
            function iterator$686($$targs$$){
                var $$iterator$686=new iterator$686.$$;
                $$iterator$686.$$targs$$=$$targs$$;
                Iterator($$iterator$686);
                $$iterator$686.iter$687_=/*anotaciones:*/elements$683.iterator();
                $$iterator$686.otherIter$688_=/*anotaciones:*/otherElements$684.iterator();
                return $$iterator$686;
            }
            function $init$iterator$686(){
                if (iterator$686.$$===undefined){
                    initTypeProto(iterator$686,'ceylon.language::combine.iterable.iterator.iterator',Basic,$init$Iterator());
                }
                return iterator$686;
            }
            $init$iterator$686();
            (function($$iterator$686){
                defineAttr($$iterator$686,'iter$687',function(){return this.iter$687_;});
                defineAttr($$iterator$686,'otherIter$688',function(){return this.otherIter$688_;});
                $$iterator$686.next=function next(){
                    var $$iterator$686=this;
                    var elem$689=$$iterator$686.iter$687.next();
                    var otherElem$690=$$iterator$686.otherIter$688.next();
                    var elem$691;
                    var otherElem$692;
                    if(!isOfType((elem$691=elem$689),{t:Finished})&&!isOfType((otherElem$692=otherElem$690),{t:Finished})){
                        return combination$682(elem$691,otherElem$692);
                    }else {
                        return getFinished();
                    }
                };$$iterator$686.next.$$metamodel$$={mod:$$METAMODEL$$,$t:{ t:'u', l:['Result',{t:Finished}]},$ps:[],$an:function(){return[shared(),actual()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['combine']['$o']['iterable']['$m']['iterator']['$o']['iterator']['$m']['next']};
            })(iterator$686.$$.prototype);
            var iterator$693=iterator$686({Element:$$$mptypes.Result});
            var getIterator$693=function(){
                return iterator$693;
            }
            return getIterator$693();
        };$$iterable$685.iterator.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:Iterator,a:{Element:'Result'}},$ps:[],$an:function(){return[shared(),actual()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['combine']['$o']['iterable']['$m']['iterator']};
    })(iterable$685.$$.prototype);
    var iterable$694=iterable$685({Absent:$$$mptypes.Absent,Element:$$$mptypes.Result});
    var getIterable$694=function(){
        return iterable$694;
    }
    return getIterable$694();
}
exports.combine=combine;
combine.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:Iterable,a:{Absent:'Absent',Element:'Result'}},$ps:[{$nm:'combination',$mt:'prm',$t:'Result'},{$nm:'elements',$mt:'prm',$t:{t:Iterable,a:{Absent:'Absent',Element:'Element'}}},{$nm:'otherElements',$mt:'prm',$t:{t:Iterable,a:{Absent:'Absent',Element:'OtherElement'}}}],$tp:{Result:{},Absent:{'satisfies':[{t:Null}]},Element:{},OtherElement:{}},$an:function(){return[doc(String$("Applies a function to each element of two `Iterable`s\nand returns an `Iterable` with the results.",97)),by([String$("Gavin",5),String$("Enrique Zamudio",15),String$("Tako",4)].reifyCeylonType({Absent:{t:Null},Element:{t:String$}})),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['combine']};//combine.$$targs$$={Arguments:{t:Tuple,a:{Rest:{t:Empty},First:{t:Iterable,a:{Absent:$$$mptypes.Absent,Element:$$$mptypes.OtherElement}},Element:{t:Iterable,a:{Absent:$$$mptypes.Absent,Element:$$$mptypes.OtherElement}}}},Return:{t:Iterable,a:{Absent:$$$mptypes.Absent,Element:$$$mptypes.Result}}};
var sort=function (elements$695,$$$mptypes){
    return internalSort($JsCallable(byIncreasing($JsCallable(function (e$696){
        return e$696;
    },[{$nm:'e',$mt:'prm',$t:'Element'}],{Arguments:{t:Tuple,a:{Rest:{t:Empty},First:$$$mptypes.Element,Element:$$$mptypes.Element}},Return:$$$mptypes.Element}),{Value:$$$mptypes.Element,Element:$$$mptypes.Element}),[{$nm:'p1',$mt:'prm',$t:'Element'},{$nm:'p2',$mt:'prm',$t:'Element'}],{Arguments:{t:Tuple,a:{Rest:{t:Tuple,a:{Rest:{t:Empty},First:$$$mptypes.Element,Element:$$$mptypes.Element}},First:$$$mptypes.Element,Element:$$$mptypes.Element}},Return:{t:Comparison}}),elements$695,{Element:$$$mptypes.Element});
};
sort.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:Sequential,a:{Element:'Element'}},$ps:[{$nm:'elements',$mt:'prm',$t:{t:Iterable,a:{Absent:{t:Null},Element:'Element'}}}],$tp:{Element:{'satisfies':[{t:Comparable,a:{Other:'Element'}}]}},$an:function(){return[doc(String$("Sort the given elements, returning a new sequence.",50)),see([Comparable].reifyCeylonType({Absent:{t:Null},Element:{t:Anything}})),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['sort']};
exports.sort=sort;
function Annotated$metamodel($$annotated){
}
Annotated$metamodel.$$metamodel$$={mod:$$METAMODEL$$,satisfies:[],$an:function(){return[doc(String$("A program element that can\nbe annotated.",40)),shared()];},pkg:'ceylon.language.metamodel',d:$$METAMODEL$$['ceylon.language.metamodel']['Annotated']};
...
Annotation$metamodel.$$metamodel$$={mod:$$METAMODEL$$,$tp:{Value:{'var':'out','satisfies':[{t:Annotation$metamodel,a:{Value:'Value'}}]}},satisfies:[],$an:function(){return[doc(String$("An annotation.",14)),shared()];},pkg:'ceylon.language.metamodel',d:$$METAMODEL$$['ceylon.language.metamodel']['Annotation']};
...
function $init$ConstrainedAnnotation$metamodel(){
    if (ConstrainedAnnotation$metamodel.$$===undefined){
        ...
        (function($$constrainedAnnotation){
            $$constrainedAnnotation.occurs=function occurs(programElement$697){
...
function sequencedAnnotations$metamodel(annotationType$698,programElement$699,$$$mptypes){
    return annotations$metamodel(annotationType$698,programElement$699,{Values:{t:Sequential,a:{Element:$$$mptypes.Value}},Value:$$$mptypes.Value,ProgramElement:$$$mptypes.ProgramElement});
}
...
function annotations$metamodel(annotationType$700,programElement$701,$$$mptypes){
    throw Exception();
}
...
function nothingType$702$metamodel(){
    var $$nothingType=new nothingType$702$metamodel.$$;
    Type$metamodel($$nothingType);
    return $$nothingType;
}
function $init$nothingType$702$metamodel(){
    if (nothingType$702$metamodel.$$===undefined){
        initTypeProto(nothingType$702$metamodel,'ceylon.language.metamodel::nothingType',Basic,$init$Type$metamodel());
    }
    return nothingType$702$metamodel;
}
exports.$init$nothingType$702$metamodel=$init$nothingType$702$metamodel;
$init$nothingType$702$metamodel();
var nothingType$703$metamodel=nothingType$702$metamodel();
var getNothingType$metamodel=function(){
    return nothingType$703$metamodel;
}
...
function nothingType$706$metamodel$declaration(){
    var $$nothingType=new nothingType$706$metamodel$declaration.$$;
    OpenType$metamodel$declaration($$nothingType);
    return $$nothingType;
}
function $init$nothingType$706$metamodel$declaration(){
    if (nothingType$706$metamodel$declaration.$$===undefined){
        initTypeProto(nothingType$706$metamodel$declaration,'ceylon.language.metamodel.declaration::nothingType',Basic,$init$OpenType$metamodel$declaration());
    }
    return nothingType$706$metamodel$declaration;
}
exports.$init$nothingType$706$metamodel$declaration=$init$nothingType$706$metamodel$declaration;
$init$nothingType$706$metamodel$declaration();
var nothingType$707$metamodel$declaration=nothingType$706$metamodel$declaration();
var getNothingType$metamodel$declaration=function(){
    return nothingType$707$metamodel$declaration;
}
