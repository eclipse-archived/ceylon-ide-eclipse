...
function $init$Exception(){
    if (Exception.$$===undefined){
        ...
        (function($$exception){
            ...
            },undefined,function(){return{mod:$$METAMODEL$$,$t:{t:String$},$cont:Exception,$an:function(){return[doc(String$("A message describing the problem. This default \nimplementation returns the description, if any, or \notherwise the message of the cause, if any.",143)),see([$init$OpenValue()('cause',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),false,Exception.$$.prototype.$prop$getCause)].reifyCeylonType({Absent:{t:Null},Element:{t:ValueDeclaration$model$declaration}})),shared(),$default()];},d:['ceylon.language','Exception','$at','message']};});
...
Iterable.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$tp:{Element:{'var':'out'},Absent:{'var':'out','satisfies':[{t:Null}],'def':{t:Null}}},satisfies:[{t:Container,a:{Absent:'Absent',Element:'Element'}}],$an:function(){return[doc(String$("Abstract supertype of containers whose elements may be \niterated. An iterable container need not be finite, but\nits elements must at least be countable. There may not\nbe a well-defined iteration order, and so the order of\niterated elements may not be stable.\n\nThe type `Iterable<Element,Null>`, usually abbreviated\n`{Element*}` represents a possibly-empty iterable \ncontainer. The type `Iterable<Element,Nothing>`, \nusually abbreviated `{Element+}` represents a nonempty \niterable container.\n\nAn instance of `Iterable` may be constructed by \nsurrounding a value list in braces:\n\n    {String+} words = { \"hello\", \"world\" };\n\nAn instance of `Iterable` may be iterated using a `for`\nloop:\n\n    for (c in \"hello world\") { ... }\n\n`Iterable` and its subtypes define various operations\nthat return other iterable objects. Such operations \ncome in two flavors:\n\n- _Lazy_ operations return a *view* of the receiving\n  iterable object. If the underlying iterable object is\n  mutable, then changes to the underlying object will\n  be reflected in the resulting view. Lazy operations\n  are usually efficient, avoiding memory allocation or\n  iteration of the receiving iterable object.\n- _Eager_ operations return an immutable object. If the\n  receiving iterable object is mutable, changes to this\n  object will not be reflected in the resulting \n  immutable object. Eager operations are often \n  expensive, involving memory allocation and iteration\n  of the receiving iterable object.\n\nLazy operations are preferred, because they can be \nefficiently chained. For example:\n\n    string.filter((Character c) => c.letter)\n          .map((Character c) => c.uppercased)\n\nis much less expensive than:\n\n    string.select((Character c) => c.letter)\n          .collect((Character c) => c.uppercased)\n\nFurthermore, it is always easy to produce a new \nimmutable iterable object given the view produced by a\nlazy operation. For example:\n\n    [ *string.filter((Character c) => c.letter)\n          .map((Character c) => c.uppercased) ]\n\nLazy operations normally return an instance of \n`Iterable` or `Map`.\n\nHowever, there are certain scenarios where an eager \noperation is more useful, more convenient, or no more \nexpensive than a lazy operation, including:\n\n- sorting operations, which are eager by nature,\n- operations which preserve emptiness/nonemptiness of\n  the receiving iterable object.\n\nEager operations normally return a sequence.",2413)),see([$init$OpenInterface()('Collection',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),true,Collection)].reifyCeylonType({Absent:{t:Null},Element:{t:InterfaceDeclaration$model$declaration}})),by([String$("Gavin",5)].reifyCeylonType({Absent:{t:Null},Element:{t:String$}})),shared()];},d:['ceylon.language','Iterable']};};
    ...
    if (Iterable.$$===undefined){
        ...
        (function($$iterable){
            ...
            $$iterable.longerThan=function longerThan(length$7){
                ...
                return false;
            };$$iterable.longerThan.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$t:{t:Boolean$},$ps:[{$nm:'length',$mt:'prm',$t:{t:Integer},$an:function(){return[];}}],$cont:Iterable,$an:function(){return[doc(String$("Determines if this iterable object has more elements\nthan the given length. This is an efficient operation \nfor iterable objects with many elements.",148)),see([$init$OpenValue()('size',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),false,Iterable.$$.prototype.$prop$getSize)].reifyCeylonType({Absent:{t:Null},Element:{t:ValueDeclaration$model$declaration}})),shared(),$default()];},d:['ceylon.language','Iterable','$m','longerThan']};};
            $$iterable.shorterThan=function shorterThan(length$13){
                ...
                return true;
            };$$iterable.shorterThan.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$t:{t:Boolean$},$ps:[{$nm:'length',$mt:'prm',$t:{t:Integer},$an:function(){return[];}}],$cont:Iterable,$an:function(){return[doc(String$("Determines if this iterable object has fewer elements\nthan the given length. This is an efficient operation \nfor iterable objects with many elements.",149)),see([$init$OpenValue()('size',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),false,Iterable.$$.prototype.$prop$getSize)].reifyCeylonType({Absent:{t:Null},Element:{t:ValueDeclaration$model$declaration}})),shared(),$default()];},d:['ceylon.language','Iterable','$m','shorterThan']};};
            ...
            $$iterable.$filter.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$t:{t:Iterable,a:{Absent:{t:Null},Element:'Element'}},$ps:[{$nm:'selecting',$mt:'prm',$pt:'f',$t:{t:Boolean$},$an:function(){return[doc("The predicate the elements must satisfy.")];}}],$cont:Iterable,$an:function(){return[doc(String$("An `Iterable` containing the elements of this \ncontainer that satisfy the given predicate.",90)),see([$init$OpenFunction()('select',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),false,Iterable.$$.prototype.select)].reifyCeylonType({Absent:{t:Null},Element:{t:FunctionDeclaration$model$declaration}})),shared(),$default()];},d:['ceylon.language','Iterable','$m','filter']};};
            ...
            $$iterable.select.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$t:{t:Sequential,a:{Element:'Element'}},$ps:[{$nm:'selecting',$mt:'prm',$pt:'f',$t:{t:Boolean$},$an:function(){return[doc("The predicate the elements must satisfy.")];}}],$cont:Iterable,$an:function(){return[doc(String$("A sequence containing the elements of this \ncontainer that satisfy the given predicate. An \neager counterpart to `filter()`.",124)),see([$init$OpenFunction()('filter',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),false,Iterable.$$.prototype.$filter)].reifyCeylonType({Absent:{t:Null},Element:{t:FunctionDeclaration$model$declaration}})),shared(),$default()];},d:['ceylon.language','Iterable','$m','select']};};
            ...
            },undefined,function(){return{mod:$$METAMODEL$$,$t:{t:Iterable,a:{Absent:'Absent',Element:'Element'}},$cont:Iterable,$an:function(){return[doc(String$("A non-finite iterable object that produces the elements \nof this iterable object, repeatedly.",93)),see([$init$OpenFunction()('cycle',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),false,Iterable.$$.prototype.cycle)].reifyCeylonType({Absent:{t:Null},Element:{t:FunctionDeclaration$model$declaration}})),shared(),$default()];},d:['ceylon.language','Iterable','$at','cycled']};});$$iterable.cycle=function cycle(times$170){
                var $$iterable=this;
            ...
            };$$iterable.repeat.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$t:{t:List,a:{Element:'Element'}},$ps:[{$nm:'times',$mt:'prm',$t:{t:Integer},$an:function(){return[];}}],$cont:Iterable,$an:function(){return[doc(String$("Returns a list formed by repeating the elements of this\niterable object the given number of times, or an empty \nlist if `times<=0`. An eager counterpart to `cycle()`.",166)),see([$init$OpenFunction()('cycle',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),false,Iterable.$$.prototype.cycle)].reifyCeylonType({Absent:{t:Null},Element:{t:FunctionDeclaration$model$declaration}})),shared(),$default()];},d:['ceylon.language','Iterable','$m','repeat']};};
        })(Iterable.$$.prototype);
    }
    return Iterable;
}
...
Sequence.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$tp:{Element:{'var':'out'}},satisfies:[{t:Sequential,a:{Element:'Element'}},{t:Iterable,a:{Absent:{t:Nothing},Element:'Element'}},{t:Cloneable,a:{Clone:{t:Sequence,a:{Element:'Element'}}}}],$an:function(){return[doc(String$("A nonempty, immutable sequence of values. The type \n`Sequence<Element>`, may be abbreviated `[Element+]`.\n\nGiven a possibly-empty sequence of type `[Element*]`, \nthe `if (nonempty ...)` construct, or, alternatively,\nthe `assert (nonempty ...)` construct, may be used to \nnarrow to a nonempty sequence type:\n\n    [Integer*] nums = ... ;\n    if (nonempty nums) {\n        Integer first = nums.first;\n        Integer max = max(nums);\n        [Integer+] squares = nums.collect((Integer i) => i**2));\n        [Integer+] sorted = nums.sort(byIncreasing((Integer i) => i));\n    }\n\nOperations like `first`, `max()`, `collect()`, and \n`sort()`, which polymorphically produce a nonempty or \nnon-null output when given a nonempty input are called \n_emptiness-preserving_.",759)),see([$init$OpenInterface()('Empty',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),true,Empty)].reifyCeylonType({Absent:{t:Null},Element:{t:InterfaceDeclaration$model$declaration}})),by([String$("Gavin",5)].reifyCeylonType({Absent:{t:Null},Element:{t:String$}})),shared()];},d:['ceylon.language','Sequence']};};
...
Empty.$$metamodel$$=function(){return{mod:$$METAMODEL$$,satisfies:[{t:Sequential,a:{Element:{t:Nothing}}},{t:Ranged,a:{Index:{t:Integer},Span:{t:Empty}}},{t:Cloneable,a:{Clone:{t:Empty}}}],$an:function(){return[doc(String$("A sequence with no elements. The type `Empty` may be\nabbreviated `[]`, and an instance is produced by the \nexpression `[]`. That is, in the following expression,\n`e` has type `[]` and refers to the value `[]`:\n\n    [] none = [];\n\n(Whether the syntax `[]` refers to the type or the \nvalue depends upon how it occurs grammatically.)",330)),see([$init$OpenInterface()('Sequence',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),true,Sequence)].reifyCeylonType({Absent:{t:Null},Element:{t:InterfaceDeclaration$model$declaration}})),shared()];},d:['ceylon.language','Empty']};};
exports.Empty=Empty;
function $init$Empty(){
    if (Empty.$$===undefined){
...
exports.getEmpty.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$t:{t:empty$244},$an:function(){return[doc(String$("A sequence with no elements, abbreviated `[]`. The \nunique instance of the type `[]`.",85)),shared()];},d:['ceylon.language','empty']};};
...
exports.getEmptyIterator.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$t:{t:emptyIterator$246},$an:function(){return[doc(String$("An iterator that returns no elements.",37)),shared()];},d:['ceylon.language','emptyIterator']};};
...
function $init$Correspondence(){
    if (Correspondence.$$===undefined){
        ...
        (function($$correspondence){
            ...
            $$correspondence.defines.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$t:{t:Boolean$},$ps:[{$nm:'key',$mt:'prm',$t:'Key',$an:function(){return[];}}],$cont:Correspondence,$an:function(){return[doc(String$("Determines if there is a value defined for the \ngiven key.",58)),see([$init$OpenFunction()('definesAny',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),false,Correspondence.$$.prototype.definesAny),$init$OpenFunction()('definesEvery',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),false,Correspondence.$$.prototype.definesEvery),$init$OpenValue()('keys',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),false,Correspondence.$$.prototype.$prop$getKeys)].reifyCeylonType({Absent:{t:Null},Element:{ t:'u', l:[{t:FunctionDeclaration$model$declaration},{t:ValueDeclaration$model$declaration}]}})),shared(),$default()];},d:['ceylon.language','Correspondence','$m','defines']};};
            ...
            },undefined,function(){return{mod:$$METAMODEL$$,$t:{t:Category},$cont:Correspondence,$an:function(){return[doc(String$("The `Category` of all keys for which a value is \ndefined by this `Correspondence`.",82)),see([$init$OpenFunction()('defines',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),false,Correspondence.$$.prototype.defines)].reifyCeylonType({Absent:{t:Null},Element:{t:FunctionDeclaration$model$declaration}})),shared(),$default()];},d:['ceylon.language','Correspondence','$at','keys']};});
            ...
            };$$correspondence.definesAny.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$t:{t:Boolean$},$ps:[{$nm:'keys',$mt:'prm',$t:{t:Iterable,a:{Absent:{t:Null},Element:'Key'}},$an:function(){return[];}}],$cont:Correspondence,$an:function(){return[doc(String$("Determines if this `Correspondence` defines a value\nfor any one of the given keys.",82)),see([$init$OpenFunction()('defines',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),false,Correspondence.$$.prototype.defines)].reifyCeylonType({Absent:{t:Null},Element:{t:FunctionDeclaration$model$declaration}})),shared(),$default()];},d:['ceylon.language','Correspondence','$m','definesAny']};};
...
Finished.$$metamodel$$=function(){return{mod:$$METAMODEL$$,'super':{t:Basic},satisfies:[],$an:function(){return[doc(String$("The type of the value that indicates that \nan `Iterator` is exhausted and has no more \nvalues to return.",104)),see([$init$OpenInterface()('Iterator',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),true,Iterator)].reifyCeylonType({Absent:{t:Null},Element:{t:InterfaceDeclaration$model$declaration}})),shared(),abstract()];},d:['ceylon.language','Finished']};};
...
exports.getFinished.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$t:{t:finished$263},$an:function(){return[doc(String$("A value that indicates that an `Iterator`\nis exhausted and has no more values to \nreturn.",89)),see([$init$OpenInterface()('Iterator',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),true,Iterator)].reifyCeylonType({Absent:{t:Null},Element:{t:InterfaceDeclaration$model$declaration}})),shared()];},d:['ceylon.language','finished']};};
function Binary($$targs$$,$$binary){
    set_type_args($$binary,$$targs$$);
    $$binary.set$defs$bit=function(index$265,bit$266){return true;};
}
Binary.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$tp:{Other:{'satisfies':[{t:Binary,a:{Other:'Other'}}]}},satisfies:[],$an:function(){return[doc(String$("Abstraction of numeric types like `Integer` that may be \nrepresented as a sequence of bits, and may be the subject\nof bitwise operations.",137)),see([$init$OpenClass()('Integer',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),true,Integer)].reifyCeylonType({Absent:{t:Null},Element:{t:ClassDeclaration$model$declaration}})),by([String$("Stef",4)].reifyCeylonType({Absent:{t:Null},Element:{t:String$}})),shared()];},d:['ceylon.language','Binary']};};
...
Category.$$metamodel$$=function(){return{mod:$$METAMODEL$$,satisfies:[],$an:function(){return[doc(String$("Abstract supertype of objects that contain other \nvalues, called *elements*, where it is possible to \nefficiently determine if a given value is an element. \n`Category` does not satisfy `Container`, because it is \nconceptually possible to have a `Category` whose \nemptiness cannot be computed.\n\nThe `in` operator may be used to determine if a value\nbelongs to a `Category`:\n\n    if (\"hello\" in \"hello world\") { ... }\n    if (69 in 0..100) { ... }\n    if (key->value in { for (n in 0..100) n.string->n**2 }) { ... }\n\nOrdinarily, `x==y` implies that `x in cat == y in cat`.\nBut this contract is not required since it is possible\nto form a meaningful `Category` using a different\nequivalence relation. For example, an `IdentitySet` is\na meaningful `Category`.",755)),see([$init$OpenInterface()('Container',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),true,Container)].reifyCeylonType({Absent:{t:Null},Element:{t:InterfaceDeclaration$model$declaration}})),by([String$("Gavin",5)].reifyCeylonType({Absent:{t:Null},Element:{t:String$}})),shared()];},d:['ceylon.language','Category']};};
...
function $init$Category(){
    if (Category.$$===undefined){
        ...
        (function($$category){
            ...
            };$$category.containsEvery.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$t:{t:Boolean$},$ps:[{$nm:'elements',$mt:'prm',$t:{t:Iterable,a:{Absent:{t:Null},Element:{t:Object$}}},$an:function(){return[];}}],$cont:Category,$an:function(){return[doc(String$("Determines if every one of the given values belongs\nto this `Category`.",71)),see([$init$OpenFunction()('contains',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),false,Category.$$.prototype.contains)].reifyCeylonType({Absent:{t:Null},Element:{t:FunctionDeclaration$model$declaration}})),shared(),$default()];},d:['ceylon.language','Category','$m','containsEvery']};};
            ...
            };$$category.containsAny.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$t:{t:Boolean$},$ps:[{$nm:'elements',$mt:'prm',$t:{t:Iterable,a:{Absent:{t:Null},Element:{t:Object$}}},$an:function(){return[];}}],$cont:Category,$an:function(){return[doc(String$("Determines if any one of the given values belongs \nto this `Category`",69)),see([$init$OpenFunction()('contains',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),false,Category.$$.prototype.contains)].reifyCeylonType({Absent:{t:Null},Element:{t:FunctionDeclaration$model$declaration}})),shared(),$default()];},d:['ceylon.language','Category','$m','containsAny']};};
        })(Category.$$.prototype);
    }
    return Category;
}
...
List.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$tp:{Element:{'var':'out'}},satisfies:[{t:Collection,a:{Element:'Element'}},{t:Correspondence,a:{Key:{t:Integer},Item:'Element'}},{t:Ranged,a:{Index:{t:Integer},Span:{t:List,a:{Element:'Element'}}}},{t:Cloneable,a:{Clone:{t:List,a:{Element:'Element'}}}}],$an:function(){return[doc(String$("Represents a collection in which every element has a \nunique non-negative integer index.\n\nA `List` is a `Collection` of its elements, and a \n`Correspondence` from indices to elements.\n\nDirect access to a list element by index produces a\nvalue of optional type. The following idiom may be\nused instead of upfront bounds-checking, as long as \nthe list element type is a non-`null` type:\n\n    value char = \"hello world\"[index];\n    if (exists char) { /*do something*/ }\n    else { /*out of bounds*/ }\n\nTo iterate the indexes of a `List`, use the following\nidiom:\n\n    for (i->char in \"hello world\".indexed) { ... }",611)),see([$init$OpenInterface()('Sequence',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),true,Sequence),$init$OpenInterface()('Empty',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),true,Empty),$init$OpenClass()('Array',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),true,Array)].reifyCeylonType({Absent:{t:Null},Element:{ t:'u', l:[{t:InterfaceDeclaration$model$declaration},{t:ClassDeclaration$model$declaration}]}})),shared()];},d:['ceylon.language','List']};};
exports.List=List;
function $init$List(){
    if (List.$$===undefined){
        ...
        (function($$list){
            ...
            },undefined,function(){return{mod:$$METAMODEL$$,$t:{t:Integer},$cont:List,$an:function(){return[doc(String$("The number of elements in this sequence, always\n`sequence.lastIndex+1`.",71)),see([$init$OpenValue()('lastIndex',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),false,List.$$.prototype.$prop$getLastIndex)].reifyCeylonType({Absent:{t:Null},Element:{t:ValueDeclaration$model$declaration}})),shared(),actual(),$default()];},d:['ceylon.language','List','$at','size']};});
            ...
            defineAttr($$list,'last',function(){
                ...
                return seq$314;
            };$$list.withLeading.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$t:{t:Sequence,a:{Element:{ t:'u', l:['Element','Other']}}},$ps:[{$nm:'element',$mt:'prm',$t:'Other',$an:function(){return[doc("The first element of the resulting sequence.")];}}],$cont:List,$tp:{Other:{}},$an:function(){return[doc(String$("Returns a new `List` that starts with the specified\nelement, followed by the elements of this `List`.",101)),see([$init$OpenFunction()('following',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),false,Iterable.$$.prototype.following)].reifyCeylonType({Absent:{t:Null},Element:{t:FunctionDeclaration$model$declaration}})),shared(),$default()];},d:['ceylon.language','List','$m','withLeading']};};
            ...
            $$list.initial.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$t:{t:List,a:{Element:'Element'}},$ps:[{$nm:'length',$mt:'prm',$t:{t:Integer},$an:function(){return[];}}],$cont:List,$an:function(){return[doc(String$("Select the first elements of this list, returning a \nlist no longer than the given length. If this list is \nshorter than the given length, return this list. \nOtherwise return a list of the given length.",202)),see([$init$OpenFunction()('terminal',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),false,List.$$.prototype.terminal)].reifyCeylonType({Absent:{t:Null},Element:{t:FunctionDeclaration$model$declaration}})),shared(),$default()];},d:['ceylon.language','List','$m','initial']};};
            ...
            };$$list.terminal.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$t:{t:List,a:{Element:'Element'}},$ps:[{$nm:'length',$mt:'prm',$t:{t:Integer},$an:function(){return[];}}],$cont:List,$an:function(){return[doc(String$("Select the last elements of the list, returning a list \nno longer than the given length. If this list is \nshorter than the given length, return this list. \nOtherwise return a list of the given length.",200)),see([$init$OpenFunction()('initial',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),false,List.$$.prototype.initial)].reifyCeylonType({Absent:{t:Null},Element:{t:FunctionDeclaration$model$declaration}})),shared(),$default()];},d:['ceylon.language','List','$m','terminal']};};
        })(List.$$.prototype);
    }
    return List;
}
...
Invertable.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$tp:{Inverse:{'var':'out','satisfies':[{t:Invertable,a:{Inverse:'Inverse'}}]}},satisfies:[],$an:function(){return[doc(String$("Abstraction of types which support a unary additive inversion\noperation. For a numeric type, this should return the \nnegative of the argument value. Note that the type \nparameter of this interface is not restricted to be a \nself type, in order to accommodate the possibility of \ntypes whose additive inverse can only be expressed in terms of \na wider type.",356)),see([$init$OpenClass()('Integer',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),true,Integer),$init$OpenClass()('Float',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),true,Float)].reifyCeylonType({Absent:{t:Null},Element:{t:ClassDeclaration$model$declaration}})),by([String$("Gavin",5)].reifyCeylonType({Absent:{t:Null},Element:{t:String$}})),shared()];},d:['ceylon.language','Invertable']};};
...
Numeric.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$tp:{Other:{'satisfies':[{t:Numeric,a:{Other:'Other'}}]}},satisfies:[{t:Summable,a:{Other:'Other'}},{t:Invertable,a:{Inverse:'Other'}}],$an:function(){return[doc(String$("Abstraction of numeric types supporting addition,\nsubtraction, multiplication, and division, including\n`Integer` and `Float`. Additionally, a numeric type \nis expected to define a total order via an \nimplementation of `Comparable`.",231)),see([$init$OpenClass()('Integer',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),true,Integer),$init$OpenClass()('Float',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),true,Float),$init$OpenInterface()('Comparable',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),true,Comparable)].reifyCeylonType({Absent:{t:Null},Element:{ t:'u', l:[{t:ClassDeclaration$model$declaration},{t:InterfaceDeclaration$model$declaration}]}})),by([String$("Gavin",5)].reifyCeylonType({Absent:{t:Null},Element:{t:String$}})),shared()];},d:['ceylon.language','Numeric']};};
...
Scalar.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$tp:{Other:{'satisfies':[{t:Scalar,a:{Other:'Other'}}]}},satisfies:[{t:Numeric,a:{Other:'Other'}},{t:Comparable,a:{Other:'Other'}},{t:Number$}],$an:function(){return[doc(String$("Abstraction of numeric types representing scalar\nvalues, including `Integer` and `Float`.",89)),see([$init$OpenClass()('Integer',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),true,Integer),$init$OpenClass()('Float',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),true,Float)].reifyCeylonType({Absent:{t:Null},Element:{t:ClassDeclaration$model$declaration}})),by([String$("Gavin",5)].reifyCeylonType({Absent:{t:Null},Element:{t:String$}})),shared()];},d:['ceylon.language','Scalar']};};
...
Exponentiable.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$tp:{This:{'satisfies':[{t:Exponentiable,a:{Other:'Other',This:'This'}}]},Other:{'satisfies':[{t:Numeric,a:{Other:'Other'}}]}},satisfies:[{t:Numeric,a:{Other:'This'}}],$an:function(){return[doc(String$("Abstraction of numeric types that may be raised to a\npower. Note that the type of the exponent may be\ndifferent to the numeric type which can be \nexponentiated.",160)),see([$init$OpenClass()('Integer',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),true,Integer),$init$OpenClass()('Float',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),true,Float)].reifyCeylonType({Absent:{t:Null},Element:{t:ClassDeclaration$model$declaration}})),shared()];},d:['ceylon.language','Exponentiable']};};
...
Integral.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$tp:{Other:{'satisfies':[{t:Integral,a:{Other:'Other'}}]}},satisfies:[{t:Numeric,a:{Other:'Other'}},{t:Enumerable,a:{Other:'Other'}}],$an:function(){return[doc(String$("Abstraction of integral numeric types. That is, types \nwith no fractional part, including `Integer`. The \ndivision operation for integral numeric types results \nin a remainder. Therefore, integral numeric types have \nan operation to determine the remainder of any division \noperation.",284)),see([$init$OpenClass()('Integer',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),true,Integer)].reifyCeylonType({Absent:{t:Null},Element:{t:ClassDeclaration$model$declaration}})),by([String$("Gavin",5)].reifyCeylonType({Absent:{t:Null},Element:{t:String$}})),shared()];},d:['ceylon.language','Integral']};};
...
InitializationException.$$metamodel$$=function(){return{mod:$$METAMODEL$$,'super':{t:Exception},satisfies:[],$an:function(){return[doc(String$("Thrown when a problem was detected with value initialization.\n\nPossible problems include:\n\n* when a value could not be initialized due to recursive access during initialization, \n* an attempt to use a `late` value before it was initialized, \n* an attempt to assign to a `late` but non-`variable` value after it was initialized.",327)),see([$init$OpenFunction()('late',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),true,late)].reifyCeylonType({Absent:{t:Null},Element:{t:FunctionDeclaration$model$declaration}})),shared()];},d:['ceylon.language','InitializationException']};};
...
exports.getEmptySet.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$t:{t:emptySet$481},$an:function(){return[doc(String$("A [[Set]] with no elements.",27)),shared()];},d:['ceylon.language','emptySet']};};
...
exports.getEmptyMap.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$t:{t:emptyMap$685},$an:function(){return[doc(String$("A [[Map]] with no entries.",26)),shared()];},d:['ceylon.language','emptyMap']};};
...
exports.any=any;
any.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$t:{t:Boolean$},$ps:[{$nm:'values',$mt:'prm',$t:{t:Iterable,a:{Absent:{t:Null},Element:{t:Boolean$}}},$an:function(){return[];}}],$an:function(){return[doc(String$("Determines if any one of the given boolean values \n(usually a comprehension) is `true`.",87)),see([$init$OpenFunction()('every',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),true,every)].reifyCeylonType({Absent:{t:Null},Element:{t:FunctionDeclaration$model$declaration}})),shared()];},d:['ceylon.language','any']};};
...
;
byDecreasing.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$t:{t:Comparison},$ps:[{$nm:'comparable',$mt:'prm',$pt:'f',$t:'Value',$an:function(){return[];}}],$tp:{Element:{},Value:{'satisfies':[{t:Comparable,a:{Other:'Value'}}]}},$an:function(){return[doc(String$("A comparator which orders elements in decreasing order \naccording to the `Comparable` returned by the given \n`comparable()` function.",133)),see([$init$OpenFunction()('byIncreasing',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),true,byIncreasing)].reifyCeylonType({Absent:{t:Null},Element:{t:FunctionDeclaration$model$declaration}})),shared()];},d:['ceylon.language','byDecreasing']};};
...
;
byIncreasing.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$t:{t:Comparison},$ps:[{$nm:'comparable',$mt:'prm',$pt:'f',$t:'Value',$an:function(){return[];}}],$tp:{Element:{},Value:{'satisfies':[{t:Comparable,a:{Other:'Value'}}]}},$an:function(){return[doc(String$("A comparator which orders elements in increasing order \naccording to the `Comparable` returned by the given \n`comparable()` function.",133)),see([$init$OpenFunction()('byDecreasing',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),true,byDecreasing)].reifyCeylonType({Absent:{t:Null},Element:{t:FunctionDeclaration$model$declaration}})),shared()];},d:['ceylon.language','byIncreasing']};};
...
;
byItem.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$t:{t:Comparison},$ps:[{$nm:'comparing',$mt:'prm',$pt:'f',$t:{t:Comparison},$an:function(){return[];}}],$tp:{Item:{'satisfies':[{t:Object$}]}},$an:function(){return[doc(String$("A comparator for `Entry`s which compares their items \naccording to the given `comparing()` function.",100)),see([$init$OpenFunction()('byKey',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),true,byKey)].reifyCeylonType({Absent:{t:Null},Element:{t:FunctionDeclaration$model$declaration}})),shared()];},d:['ceylon.language','byItem']};};
...
;
byKey.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$t:{t:Comparison},$ps:[{$nm:'comparing',$mt:'prm',$pt:'f',$t:{t:Comparison},$an:function(){return[];}}],$tp:{Key:{'satisfies':[{t:Object$}]}},$an:function(){return[doc(String$("A comparator for `Entry`s which compares their keys \naccording to the given `comparing()` function.",99)),see([$init$OpenFunction()('byItem',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),true,byItem)].reifyCeylonType({Absent:{t:Null},Element:{t:FunctionDeclaration$model$declaration}})),shared()];},d:['ceylon.language','byKey']};};
exports.byKey=byKey;
...
emptyOrSingleton.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$t:{t:Sequential,a:{Element:'Element'}},$ps:[{$nm:'element',$mt:'prm',$t:{ t:'u', l:[{t:Null},'Element']},$an:function(){return[];}}],$tp:{Element:{'satisfies':[{t:Object$}]}},$an:function(){return[doc(String$("A `Singleton` if the given element is non-null, otherwise `Empty`.",66)),see([$init$OpenClass()('Singleton',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),true,Singleton),$init$OpenInterface()('Empty',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),true,Empty)].reifyCeylonType({Absent:{t:Null},Element:{ t:'u', l:[{t:ClassDeclaration$model$declaration},{t:InterfaceDeclaration$model$declaration}]}})),shared()];},d:['ceylon.language','emptyOrSingleton']};};
...
exports.every=every;
every.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$t:{t:Boolean$},$ps:[{$nm:'values',$mt:'prm',$t:{t:Iterable,a:{Absent:{t:Null},Element:{t:Boolean$}}},$an:function(){return[];}}],$an:function(){return[doc(String$("Determines if every one of the given boolean values \n(usually a comprehension) is `true`.",89)),see([$init$OpenFunction()('any',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),true,any)].reifyCeylonType({Absent:{t:Null},Element:{t:FunctionDeclaration$model$declaration}})),shared()];},d:['ceylon.language','every']};};
...
;
forItem.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$t:'Result',$ps:[{$nm:'resulting',$mt:'prm',$pt:'f',$t:'Result',$an:function(){return[];}}],$tp:{Item:{'satisfies':[{t:Object$}]},Result:{}},$an:function(){return[doc(String$("A function that returns the result of the given `resulting()` function \non the item of a given `Entry`.",103)),see([$init$OpenFunction()('forKey',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),true,forKey)].reifyCeylonType({Absent:{t:Null},Element:{t:FunctionDeclaration$model$declaration}})),shared()];},d:['ceylon.language','forItem']};};
...
;
forKey.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$t:'Result',$ps:[{$nm:'resulting',$mt:'prm',$pt:'f',$t:'Result',$an:function(){return[];}}],$tp:{Key:{'satisfies':[{t:Object$}]},Result:{}},$an:function(){return[doc(String$("A function that returns the result of the given `resulting()` function \non the key of a given `Entry`.",102)),see([$init$OpenFunction()('forItem',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),true,forItem)].reifyCeylonType({Absent:{t:Null},Element:{t:FunctionDeclaration$model$declaration}})),shared()];},d:['ceylon.language','forKey']};};
...
join.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$t:{t:Sequential,a:{Element:'Element'}},$ps:[{$nm:'iterables',$mt:'prm',seq:1,$t:{t:Sequential,a:{Element:{t:Iterable,a:{Absent:{t:Null},Element:'Element'}}}},$an:function(){return[doc("The iterable objects to join.")];}}],$tp:{Element:{}},$an:function(){return[doc(String$("Given a list of iterable objects, return a new sequence \nof all elements of the all given objects. If there are\nno arguments, or if none of the arguments contains any\nelements, return the empty sequence.",203)),see([$init$OpenClass()('SequenceBuilder',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),true,SequenceBuilder)].reifyCeylonType({Absent:{t:Null},Element:{t:ClassDeclaration$model$declaration}})),shared()];},d:['ceylon.language','join']};};
exports.join=join;
...
plus.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$t:'Value',$ps:[{$nm:'x',$mt:'prm',$t:'Value',$an:function(){return[];}},{$nm:'y',$mt:'prm',$t:'Value',$an:function(){return[];}}],$tp:{Value:{'satisfies':[{t:Summable,a:{Other:'Value'}}]}},$an:function(){return[doc(String$("Add the given `Summable` values.",32)),see([$init$OpenFunction()('times',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),true,times),$init$OpenFunction()('sum',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),true,sum)].reifyCeylonType({Absent:{t:Null},Element:{t:FunctionDeclaration$model$declaration}})),shared()];},d:['ceylon.language','plus']};};
exports.plus=plus;
var times=function (x$918,y$919,$$$mptypes){
    return x$918.times(y$919);
};
times.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$t:'Value',$ps:[{$nm:'x',$mt:'prm',$t:'Value',$an:function(){return[];}},{$nm:'y',$mt:'prm',$t:'Value',$an:function(){return[];}}],$tp:{Value:{'satisfies':[{t:Numeric,a:{Other:'Value'}}]}},$an:function(){return[doc(String$("Multiply the given `Numeric` values.",36)),see([$init$OpenFunction()('plus',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),true,plus),$init$OpenFunction()('product',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),true,product)].reifyCeylonType({Absent:{t:Null},Element:{t:FunctionDeclaration$model$declaration}})),shared()];},d:['ceylon.language','times']};};
exports.times=times;
...
formatInteger.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$t:{t:String$},$ps:[{$nm:'integer',$mt:'prm',$t:{t:Integer},$an:function(){return[];}},{$nm:'radix',$mt:'prm',$def:1,$t:{t:Integer},$an:function(){return[];}}],$an:function(){return[doc(String$("The string representation of `integer` in the `radix` base.\n`radix` must be between `minRadix` and `maxRadix` included.\n\nIf `integer` is negative, returned string will start by character `-`",190)),$throws($init$OpenClass()('AssertionException',getModules$model().find('ceylon.language','0.6').findPackage('ceylon.language'),true,AssertionException),String$("if `radix` is not between `minRadix` and `maxRadix`",51)),shared()];},d:['ceylon.language','formatInteger']};};
function Annotated$model($$annotated){
}
Annotated$model.$$metamodel$$=function(){return{mod:$$METAMODEL$$,satisfies:[],$an:function(){return[doc(String$("A program element that can\nbe annotated.",40)),shared()];},d:['ceylon.language.model','Annotated']};};
...
Annotation$model.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$tp:{Value:{'var':'out','satisfies':[{t:Annotation$model,a:{Value:'Value'}}]}},satisfies:[],$an:function(){return[doc(String$("An annotation.",14)),shared()];},d:['ceylon.language.model','Annotation']};};
...
function $init$ConstrainedAnnotation$model(){
    if (ConstrainedAnnotation$model.$$===undefined){
        ...
        (function($$constrainedAnnotation){
            ...
            $$constrainedAnnotation.occurs.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$t:{t:Boolean},$ps:[{$nm:'programElement',$mt:'prm',$t:{t:Annotated$model},$an:function(){return[];}}],$cont:ConstrainedAnnotation$model,$an:function(){return[doc(String$("Can this annotation can occur on the given program \nelement?",60)),shared()];},d:['ceylon.language.model','ConstrainedAnnotation','$m','occurs']};};
...
function TypeApplicationException$model(message$1002, $$typeApplicationException){
    $init$TypeApplicationException$model();
    if ($$typeApplicationException===undefined)$$typeApplicationException=new TypeApplicationException$model.$$;
    $$typeApplicationException.message$1002_=message$1002;
    Exception($$typeApplicationException.message$1002,undefined,$$typeApplicationException);
    return $$typeApplicationException;
}
TypeApplicationException$model.$$metamodel$$=function(){return{mod:$$METAMODEL$$,'super':{t:Exception},satisfies:[],$an:function(){return[shared()];},d:['ceylon.language.model','TypeApplicationException']};};
exports.TypeApplicationException$model=TypeApplicationException$model;
function $init$TypeApplicationException$model(){
    if (TypeApplicationException$model.$$===undefined){
        initTypeProto(TypeApplicationException$model,'ceylon.language.model::TypeApplicationException',Exception);
        (function($$typeApplicationException){
            defineAttr($$typeApplicationException,'message$1002',function(){return this.message$1002_;},undefined,function(){return{mod:$$METAMODEL$$,$t:{t:String},$cont:TypeApplicationException$model,d:['ceylon.language.model','TypeApplicationException','$at','message']};});
        })(TypeApplicationException$model.$$.prototype);
    }
    return TypeApplicationException$model;
}
exports.$init$TypeApplicationException$model=$init$TypeApplicationException$model;
$init$TypeApplicationException$model();
function Generic$model($$generic){
}
Generic$model.$$metamodel$$=function(){return{mod:$$METAMODEL$$,satisfies:[],$an:function(){return[shared()];},d:['ceylon.language.model','Generic']};};
exports.Generic$model=Generic$model;
function $init$Generic$model(){
    if (Generic$model.$$===undefined){
        initTypeProto(Generic$model,'ceylon.language.model::Generic');
        (function($$generic){
        })(Generic$model.$$.prototype);
    }
    return Generic$model;
}
exports.$init$Generic$model=$init$Generic$model;
$init$Generic$model();
...
function ValueDeclaration$model$declaration($$valueDeclaration){
    ...
    $$valueDeclaration.apply$defs$instance=function(instance$1003){return null;};
}
...
Module$model$declaration.$$metamodel$$=function(){return{mod:$$METAMODEL$$,satisfies:[{t:Identifiable},{t:AnnotatedDeclaration$model$declaration}],$an:function(){return[doc(String$("Model of a `module` declaration\nfrom a `module.ceylon` compilation unit",71)),shared()];},d:['ceylon.language.model.declaration','Module']};};
...
Import$model$declaration.$$metamodel$$=function(){return{mod:$$METAMODEL$$,satisfies:[{t:Identifiable},{t:Annotated$model}],$an:function(){return[doc(String$("Model of an `import` declaration \nwithin a module declaration.",62)),shared()];},d:['ceylon.language.model.declaration','Import']};};
...
Package$model$declaration.$$metamodel$$=function(){return{mod:$$METAMODEL$$,satisfies:[{t:Identifiable},{t:AnnotatedDeclaration$model$declaration}],$an:function(){return[doc(String$("Model of a `package` declaration \nfrom a `package.ceylon` compilation unit",74)),shared()];},d:['ceylon.language.model.declaration','Package']};};
...
SetterDeclaration$model$declaration.$$metamodel$$=function(){return{mod:$$METAMODEL$$,satisfies:[{t:Annotated$model}],$an:function(){return[doc(String$("Model of the setter of a `VariableDeclaration`.",47)),shared()];},d:['ceylon.language.model.declaration','SetterDeclaration']};};
...
VariableDeclaration$model$declaration.$$metamodel$$=function(){return{mod:$$METAMODEL$$,satisfies:[{t:ValueDeclaration$model$declaration}],$an:function(){return[doc(String$("Model of an attribute that is `variable` or has an `assign` block.",66)),shared()];},d:['ceylon.language.model.declaration','VariableDeclaration']};};
...
function nothingType$1004$model$declaration(){
    var $$nothingType=new nothingType$1004$model$declaration.$$;
    OpenType$model$declaration($$nothingType);
    return $$nothingType;
}
function $init$nothingType$1004$model$declaration(){
    if (nothingType$1004$model$declaration.$$===undefined){
        initTypeProto(nothingType$1004$model$declaration,'ceylon.language.model.declaration::nothingType',Basic,$init$OpenType$model$declaration());
    }
    return nothingType$1004$model$declaration;
}
exports.$init$nothingType$1004$model$declaration=$init$nothingType$1004$model$declaration;
$init$nothingType$1004$model$declaration();
(function($$nothingType){
    defineAttr($$nothingType,'string',function(){
        var $$nothingType=this;
        return String$("Nothing",7);
    },undefined,function(){return{mod:$$METAMODEL$$,$t:{t:String},$cont:nothingType$1004$model$declaration,$an:function(){return[shared(),actual()];},d:['ceylon.language.model.declaration','nothingType','$at','string']};});
})(nothingType$1004$model$declaration.$$.prototype);
var nothingType$1005$model$declaration=nothingType$1004$model$declaration();
var getNothingType$model$declaration=function(){
    return nothingType$1005$model$declaration;
}
exports.getNothingType$model$declaration=getNothingType$model$declaration;
exports.getNothingType$model$declaration.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$t:{t:nothingType$1004$model$declaration},$an:function(){return[shared()];},d:['ceylon.language.model.declaration','nothingType']};};
...
annotation.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$t:{t:Annotation},$ps:[],$an:function(){return[doc(String$("Annotation to mark a class as an annotation class, or a \nmethod as an annotation method.",88)),shared(),annotation()];},d:['ceylon.language','annotation']};};
exports.annotation=annotation;
...
shared.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$t:{t:Shared},$ps:[],$an:function(){return[doc(String$("Annotation to mark a type or member as shared. A `shared` \nmember is visible outside the block of code in which it is \ndeclared.",128)),shared(),annotation()];},d:['ceylon.language','shared']};};
exports.shared=shared;
...
Variable.$$metamodel$$=function(){return{mod:$$METAMODEL$$,'super':{t:Basic},satisfies:[{t:OptionalAnnotation$model,a:{Value:{t:Variable},ProgramElement:{t:ValueDeclaration$model$declaration}}}],$an:function(){return[doc(String$("The annotation class for [[variable]].",38)),shared(),$final(),annotation()];},d:['ceylon.language','Variable']};};
...
variable.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$t:{t:Variable},$ps:[],$an:function(){return[doc(String$("Annotation to mark an value as variable. A `variable` value \nmay be assigned multiple times.",92)),shared(),annotation()];},d:['ceylon.language','variable']};};
exports.variable=variable;
...
Abstract.$$metamodel$$=function(){return{mod:$$METAMODEL$$,'super':{t:Basic},satisfies:[{t:OptionalAnnotation$model,a:{Value:{t:Abstract},ProgramElement:{t:ClassDeclaration$model$declaration}}}],$an:function(){return[doc(String$("The annotation class for [[abstract]].",38)),shared(),$final(),annotation()];},d:['ceylon.language','Abstract']};};
...
abstract.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$t:{t:Abstract},$ps:[],$an:function(){return[doc(String$("Annotation to mark a class as abstract. An `abstract` class \nmay not be directly instantiated. An `abstract` class may \nhave enumerated cases.",142)),shared(),annotation()];},d:['ceylon.language','abstract']};};
exports.abstract=abstract;
...
Final.$$metamodel$$=function(){return{mod:$$METAMODEL$$,'super':{t:Basic},satisfies:[{t:OptionalAnnotation$model,a:{Value:{t:Final},ProgramElement:{t:ClassDeclaration$model$declaration}}}],$an:function(){return[doc(String$("The annotation class for [[final]].",35)),shared(),$final(),annotation()];},d:['ceylon.language','Final']};};
exports.Final=Final;
function $init$Final(){
    if (Final.$$===undefined){
...
$final.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$t:{t:Final},$ps:[],$an:function(){return[doc(String$("Annotation to mark a class as final. A `final` class may \nnot be extended. Marking a class as final affects disjoint\ntype analysis.",131)),shared(),annotation()];},d:['ceylon.language','final']};};
exports.$final=$final;
...
actual.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$t:{t:Actual},$ps:[],$an:function(){return[doc(String$("Annotation to mark a member of a type as refining a member \nof a supertype.",75)),shared(),annotation()];},d:['ceylon.language','actual']};};
exports.actual=actual;
...
formal.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$t:{t:Formal},$ps:[],$an:function(){return[doc(String$("Annotation to mark a member whose implementation must be \nprovided by subtypes.",79)),shared(),annotation()];},d:['ceylon.language','formal']};};
exports.formal=formal;
...
$default.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$t:{t:Default},$ps:[],$an:function(){return[doc(String$("Annotation to mark a member whose implementation may be \nrefined by subtypes. Non-`default` declarations may not be \nrefined.",125)),shared(),annotation()];},d:['ceylon.language','default']};};
exports.$default=$default;
function Late($$late){
    $init$Late();
...
Late.$$metamodel$$=function(){return{mod:$$METAMODEL$$,'super':{t:Basic},satisfies:[{t:OptionalAnnotation$model,a:{Value:{t:Late},ProgramElement:{t:ValueDeclaration$model$declaration}}}],$an:function(){return[doc(String$("The annotation class for [[late]].",34)),shared(),$final(),annotation()];},d:['ceylon.language','Late']};};
exports.Late=Late;
function $init$Late(){
    if (Late.$$===undefined){
...
late.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$t:{t:Late},$ps:[],$an:function(){return[doc(String$("Annotation to disable definite initialization analysis for \na reference.",72)),shared(),annotation()];},d:['ceylon.language','late']};};
exports.late=late;
...
Native.$$metamodel$$=function(){return{mod:$$METAMODEL$$,'super':{t:Basic},satisfies:[{t:OptionalAnnotation$model,a:{Value:{t:Native},ProgramElement:{t:Annotated$model}}}],$an:function(){return[doc(String$("The annotation class for [[native]].",36)),shared(),$final(),annotation()];},d:['ceylon.language','Native']};};
...
$native.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$t:{t:Native},$ps:[],$an:function(){return[doc(String$("Annotation to mark a member whose implementation is defined \nin platform-native code.",85)),shared(),annotation()];},d:['ceylon.language','native']};};
exports.$native=$native;
...
Doc.$$metamodel$$=function(){return{mod:$$METAMODEL$$,'super':{t:Basic},satisfies:[{t:OptionalAnnotation$model,a:{Value:{t:Doc},ProgramElement:{t:Annotated$model}}}],$an:function(){return[doc(String$("The annotation class for the [[doc]] annotation.",48)),shared(),$final(),annotation()];},d:['ceylon.language','Doc']};};
exports.Doc=Doc;
function $init$Doc(){
    if (Doc.$$===undefined){
...
$init$Doc();
var doc=function (description$1006){
    return Doc(description$1006);
};
doc.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$t:{t:Doc},$ps:[{$nm:'description',$mt:'prm',$t:{t:String$},$an:function(){return[];}}],$an:function(){return[doc(String$("Annotation to specify API documentation of a program\nelement.",61)),shared(),annotation()];},d:['ceylon.language','doc']};};
exports.doc=doc;
...
$init$See();
var see=function (programElements$1007){
    if(programElements$1007===undefined){programElements$1007=getEmpty();}
    return See(programElements$1007);
};
see.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$t:{t:See},$ps:[{$nm:'programElements',$mt:'prm',seq:1,$t:{t:Sequential,a:{Element:{t:Declaration$model$declaration}}},$an:function(){return[];}}],$an:function(){return[doc(String$("Annotation to specify API references to other related \nprogram elements.",72)),shared(),annotation()];},d:['ceylon.language','see']};};
exports.see=see;
...
Authors.$$metamodel$$=function(){return{mod:$$METAMODEL$$,'super':{t:Basic},satisfies:[{t:OptionalAnnotation$model,a:{Value:{t:Authors},ProgramElement:{t:Annotated$model}}}],$an:function(){return[doc(String$("The annotation class for [[by]].",32)),shared(),$final(),annotation()];},d:['ceylon.language','Authors']};};
...
$init$Authors();
var by=function (authors$1008){
    if(authors$1008===undefined){authors$1008=getEmpty();}
    return Authors(authors$1008);
};
by.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$t:{t:Authors},$ps:[{$nm:'authors',$mt:'prm',seq:1,$t:{t:Sequential,a:{Element:{t:String$}}},$an:function(){return[];}}],$an:function(){return[doc(String$("Annotation to specify API authors.",34)),shared(),annotation()];},d:['ceylon.language','by']};};
exports.by=by;
...
$init$ThrownException();
var $throws=function (type$1009,when$1010){
    if(when$1010===undefined){when$1010=String$("",0);}
    return ThrownException(type$1009,when$1010);
};
$throws.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$t:{t:ThrownException},$ps:[{$nm:'type',$mt:'prm',$t:{t:Declaration$model$declaration},$an:function(){return[];}},{$nm:'when',$mt:'prm',$def:1,$t:{t:String$},$an:function(){return[];}}],$an:function(){return[doc(String$("Annotation to mark a program element that throws an \nexception.",63)),shared(),annotation()];},d:['ceylon.language','throws']};};
...
Deprecation.$$metamodel$$=function(){return{mod:$$METAMODEL$$,'super':{t:Basic},satisfies:[{t:OptionalAnnotation$model,a:{Value:{t:Deprecation},ProgramElement:{t:Annotated$model}}}],$an:function(){return[doc(String$("The annotation class for [[deprecated]].",40)),shared(),$final(),annotation()];},d:['ceylon.language','Deprecation']};};
...
$init$Deprecation();
var deprecated=function (reason$1011){
    if(reason$1011===undefined){reason$1011=String$("",0);}
    return Deprecation(reason$1011);
};
deprecated.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$t:{t:Deprecation},$ps:[{$nm:'reason',$mt:'prm',$def:1,$t:{t:String$},$an:function(){return[];}}],$an:function(){return[doc(String$("Annotation to mark program elements which should not be \nused anymore.",70)),shared(),annotation()];},d:['ceylon.language','deprecated']};};
...
Tags.$$metamodel$$=function(){return{mod:$$METAMODEL$$,'super':{t:Basic},satisfies:[{t:OptionalAnnotation$model,a:{Value:{t:Tags},ProgramElement:{t:Annotated$model}}}],$an:function(){return[doc(String$("The annotation class for [[tagged]].",36)),shared(),$final(),annotation()];},d:['ceylon.language','Tags']};};
exports.Tags=Tags;
function $init$Tags(){
    if (Tags.$$===undefined){
...
$init$Tags();
var tagged=function (tags$1012){
    if(tags$1012===undefined){tags$1012=getEmpty();}
    return Tags(tags$1012);
};
tagged.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$t:{t:Tags},$ps:[{$nm:'tags',$mt:'prm',seq:1,$t:{t:Sequential,a:{Element:{t:String$}}},$an:function(){return[];}}],$an:function(){return[doc(String$("Annotation to categorize the API by tag.",40)),shared(),annotation()];},d:['ceylon.language','tagged']};};
...
License.$$metamodel$$=function(){return{mod:$$METAMODEL$$,'super':{t:Basic},satisfies:[{t:OptionalAnnotation$model,a:{Value:{t:License},ProgramElement:{t:Module$model$declaration}}}],$an:function(){return[doc(String$("The annotation class for [[license]].",37)),shared(),$final(),annotation()];},d:['ceylon.language','License']};};
...
$init$License();
var license=function (url$1013){
    return License(url$1013);
};
license.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$t:{t:License},$ps:[{$nm:'url',$mt:'prm',$t:{t:String$},$an:function(){return[];}}],$an:function(){return[doc(String$("Annotation to specify the URL of the license of a module or \npackage.",69)),shared(),annotation()];},d:['ceylon.language','license']};};
exports.license=license;
...
Optional.$$metamodel$$=function(){return{mod:$$METAMODEL$$,'super':{t:Basic},satisfies:[{t:OptionalAnnotation$model,a:{Value:{t:Optional},ProgramElement:{t:Import$model$declaration}}}],$an:function(){return[doc(String$("The annotation class for [[optional]].",38)),shared(),$final(),annotation()];},d:['ceylon.language','Optional']};};
...
optional.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$t:{t:Optional},$ps:[],$an:function(){return[doc(String$("Annotation to specify that a module can be executed even if \nthe annotated dependency is not available.",103)),shared(),annotation()];},d:['ceylon.language','optional']};};
exports.optional=optional;
function Number$(wat) {
    return wat;
}
...
exports.$mod$ans$=function(){return[doc(String$("The Ceylon language module containing the core types \nreferred to in the language specification.",96)),by([String$("Gavin King",10),String$("Tom Bentley",11),String$("Tako Schotanus",14),String$("Stephane Epardaud",17),String$("Enrique Zamudio",15)].reifyCeylonType({Absent:{t:Null},Element:{t:String$}})),license(String$("http://www.apache.org/licenses/LICENSE-2.0.html",47))];};
exports.$pkg$ans$ceylon$language=function(){return[doc(String$("The Ceylon language package.",28)),by([String$("Gavin King",10),String$("Tom Bentley",11),String$("Tako Schotanus",14),String$("Stephane Epardaud",17),String$("Enrique Zamudio",15)].reifyCeylonType({Absent:{t:Null},Element:{t:String$}})),shared()];};
exports.$pkg$ans$ceylon$language$model=function(){return[doc(String$("The Ceylon metamodel package",28)),by([String$("Gavin King",10),String$("Stephane Epardaud",17)].reifyCeylonType({Absent:{t:Null},Element:{t:String}})),shared()];};
exports.$pkg$ans$ceylon$language$model$declaration=function(){return[doc(String$("The Ceylon metamodel untyped package",36)),by([String$("Gavin King",10),String$("Stephane Epardaud",17)].reifyCeylonType({Absent:{t:Null},Element:{t:String}})),shared()];};
