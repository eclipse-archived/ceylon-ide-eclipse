...
function ClassOrInterface$model($$targs$$,$$classOrInterface){
    ...
    Generic$model($$classOrInterface);
...
ClassOrInterface$model.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$tp:{Type:{'var':'out','def':{t:Anything}}},satisfies:[{t:Model$model},{t:Generic$model},{t:Type$model,a:{Type:'Type'}}],$an:function(){return[shared()];},d:['ceylon.language.model','ClassOrInterface']};};
...
function $init$ClassOrInterface$model(){
    if (ClassOrInterface$model.$$===undefined){
        initTypeProto(ClassOrInterface$model,'ceylon.language.model::ClassOrInterface',$init$Model$model(),$init$Generic$model(),$init$Type$model());
...
function FunctionModel$model($$targs$$,$$functionModel){
    ...
    Generic$model($$functionModel);
    set_type_args($$functionModel,$$targs$$);
}
FunctionModel$model.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$tp:{Type:{'var':'out','def':{t:Anything}},Arguments:{'var':'in','satisfies':[{t:Sequential,a:{Element:{t:Anything}}}],'def':{t:Nothing}}},satisfies:[{t:Model$model},{t:Generic$model}],$an:function(){return[shared()];},d:['ceylon.language.model','FunctionModel']};};
exports.FunctionModel$model=FunctionModel$model;
function $init$FunctionModel$model(){
    if (FunctionModel$model.$$===undefined){
        initTypeProto(FunctionModel$model,'ceylon.language.model::FunctionModel',$init$Model$model(),$init$Generic$model());
