...
var minRadix$696=(2);
var getMinRadix=function(){return minRadix$696;};
exports.getMinRadix=getMinRadix;
var maxRadix$697=(36);
var getMaxRadix=function(){return maxRadix$697;};
exports.getMaxRadix=getMaxRadix;
function parseInteger(string$698,radix$699){
    if(radix$699===undefined){radix$699=(10);}
    //assert at parseInteger.ceylon (32:4-32:49)
    if (!((radix$699.compare(getMinRadix())!==getSmaller())&&(radix$699.compare(getMaxRadix())!==getLarger()))) { throw AssertionException('Assertion failed: \'radix >= minRadix, radix <= maxRadix\' at parseInteger.ceylon (32:11-32:48)'); }
    var ii$700=(0);
    var setIi$700=function(ii$701){return ii$700=ii$701;};
    var max$702=getMinIntegerValue().divided(radix$699);
    var negative$703;
    var char$704;
    if((char$704=string$698.get(ii$700))!==null){
        if(char$704.equals(Character(45))){
            negative$703=true;
            (oldii$705=ii$700,ii$700=oldii$705.successor,oldii$705);
            var oldii$705;
        }else {
            if(char$704.equals(Character(43))){
                negative$703=false;
                (oldii$706=ii$700,ii$700=oldii$706.successor,oldii$706);
                var oldii$706;
            }else {
                negative$703=false;
            }
    ...
    var limit$707=(opt$708=(negative$703?getMinIntegerValue():null),opt$708!==null?opt$708:(-getMaxIntegerValue()));
    var opt$708;
    var length$709=string$698.size;
    var result$710=(0);
    var setResult$710=function(result$711){return result$710=result$711;};
    var sep$712=(-(1));
    var setSep$712=function(sep$713){return sep$712=sep$713;};
    var digitIndex$714=(0);
    var setDigitIndex$714=function(digitIndex$715){return digitIndex$714=digitIndex$715;};
    var groupingSize$716=(-(1));
    var setGroupingSize$716=function(groupingSize$717){return groupingSize$716=groupingSize$717;};
    while(ii$700.compare(length$709).equals(getSmaller())){
        var ch$718;
        var char$719;
        if((char$719=string$698.get(ii$700))!==null){
            ch$718=char$719;
        }else {
            return null;
        }
        if(ch$718.equals(Character(95))){
            if(sep$712.equals((-(1)))){
                var digitGroupSize$720;
                if((digitGroupSize$720=computeDigitGroupingSize(radix$699,digitIndex$714,string$698,ii$700))!==null&&(digitIndex$714.compare(digitGroupSize$720)!==getLarger())){
                    groupingSize$716=digitGroupSize$720;
                    sep$712=digitIndex$714;
                }else {
                    return null;
                }
            }else {
                if(digitIndex$714.minus(sep$712).equals(groupingSize$716)){
                    return null;
                }else {
                    sep$712=digitIndex$714;
                }
            ...
            if(((!sep$712.equals((-(1))))&&digitIndex$714.minus(sep$712).equals(groupingSize$716.plus((1))))){
                return null;
            }
            if(((ii$700.plus((1)).equals(length$709)&&radix$699.equals((10)))&&Tuple(Character(107),Tuple(Character(77),Tuple(Character(71),Tuple(Character(84),Tuple(Character(80),getEmpty(),{Rest:{t:Empty},First:{t:Character},Element:{t:Character}}),{Rest:{t:Tuple,a:{Rest:{t:Empty},First:{t:Character},Element:{t:Character}}},First:{t:Character},Element:{t:Character}}),{Rest:{t:Tuple,a:{Rest:{t:Tuple,a:{Rest:{t:Empty},First:{t:Character},Element:{t:Character}}},First:{t:Character},Element:{t:Character}}},First:{t:Character},Element:{t:Character}}),{Rest:{t:Tuple,a:{Rest:{t:Tuple,a:{Rest:{t:Tuple,a:{Rest:{t:Empty},First:{t:Character},Element:{t:Character}}},First:{t:Character},Element:{t:Character}}},First:{t:Character},Element:{t:Character}}},First:{t:Character},Element:{t:Character}}),{Rest:{t:Tuple,a:{Rest:{t:Tuple,a:{Rest:{t:Tuple,a:{Rest:{t:Tuple,a:{Rest:{t:Empty},First:{t:Character},Element:{t:Character}}},First:{t:Character},Element:{t:Character}}},First:{t:Character},Element:{t:Character}}},First:{t:Character},Element:{t:Character}}},First:{t:Character},Element:{t:Character}}).contains(ch$718))){
                var magnitude$721;
                if((magnitude$721=computeMagnitude(radix$699,string$698.get((oldii$722=ii$700,ii$700=oldii$722.successor,oldii$722))))!==null){
                    if(limit$707.divided(magnitude$721).compare(result$710).equals(getSmaller())){
                        (result$710=result$710.times(magnitude$721));
                        break;
                    }else {
                        return null;
                    }
                ...
                var digit$723;
                if((digit$723=parseDigit(ch$718,radix$699))!==null){
                    if(result$710.compare(max$702).equals(getSmaller())){
                        return null;
                    }
                    (result$710=result$710.times(radix$699));
                    if(result$710.compare(limit$707.plus(digit$723)).equals(getSmaller())){
                        return null;
                    }
                    (result$710=result$710.minus(digit$723));
                }else {
                    return null;
                }
            }
        }
        (oldii$724=ii$700,ii$700=oldii$724.successor,oldii$724);
        var oldii$724;
        (olddigitIndex$725=digitIndex$714,digitIndex$714=olddigitIndex$725.successor,olddigitIndex$725);
        var olddigitIndex$725;
    }
    if(((!sep$712.equals((-(1))))&&(!digitIndex$714.minus(sep$712).equals(groupingSize$716.plus((1)))))){
        return null;
    }
    if(digitIndex$714.equals((0))){
        return null;
    }
    return (opt$726=(negative$703?result$710:null),opt$726!==null?opt$726:(-result$710));
    var opt$726;
}
exports.parseInteger=parseInteger;
parseInteger.$$metamodel$$={mod:$$METAMODEL$$,$t:{ t:'u', l:[{t:Null},{t:Integer}]},$ps:[{$nm:'string',$mt:'prm',$t:{t:String$}},{$nm:'radix',$mt:'prm',$def:1,$t:{t:Integer}}],$an:function(){return[$throws($JsCallable(AssertionException,[],{Arguments:{t:Tuple,a:{Rest:{t:Empty},First:{t:String$},Element:{t:String$}}},Return:{t:AssertionException}}),String$("if `radix` is not between `minRadix` and `maxRadix`",51)),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['parseInteger']};//parseInteger.$$targs$$={Arguments:{t:Tuple,a:{Rest:{t:Empty},First:{t:Integer},Element:{t:Integer}}},Return:{ t:'u', l:[{t:Null},{t:Integer}]}};
function computeDigitGroupingSize(radix$727,digitIndex$728,string$729,ii$730){
    var groupingSize$731;
    if(radix$727.equals((2))){
        groupingSize$731=(4);
    }else {
        if(radix$727.equals((10))){
            groupingSize$731=(3);
        }else {
            if(radix$727.equals((16))){
                var char$732;
                if((digitIndex$728.compare((2))!==getLarger())&&(char$732=string$729.get(ii$730.plus((3))))!==null&&char$732.equals(Character(95))){
                    groupingSize$731=(2);
                }else {
                    groupingSize$731=(4);
                }
            }else {
                groupingSize$731=null;
            }
        }
    }
    return groupingSize$731;
};computeDigitGroupingSize.$$metamodel$$={mod:$$METAMODEL$$,$t:{ t:'u', l:[{t:Null},{t:Integer}]},$ps:[{$nm:'radix',$mt:'prm',$t:{t:Integer}},{$nm:'digitIndex',$mt:'prm',$t:{t:Integer}},{$nm:'string',$mt:'prm',$t:{t:String$}},{$nm:'ii',$mt:'prm',$t:{t:Integer}}],pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['computeDigitGroupingSize']};//computeDigitGroupingSize.$$targs$$={Arguments:{t:Tuple,a:{Rest:{t:Empty},First:{t:Integer},Element:{t:Integer}}},Return:{ t:'u', l:[{t:Null},{t:Integer}]}};
function computeMagnitude(radix$733,char$734){
    var power$735;
    var char$736;
    if((char$736=char$734)!==null){
        if(char$736.equals(Character(80))){
            power$735=(15);
        }else {
            if(char$736.equals(Character(84))){
                power$735=(12);
            }else {
                if(char$736.equals(Character(71))){
                    power$735=(9);
                }else {
                    if(char$736.equals(Character(77))){
                        power$735=(6);
                    }else {
                        if(char$736.equals(Character(107))){
                            power$735=(3);
                        }else {
                            power$735=null;
                        }
    ...
    var power$737;
    if((power$737=power$735)!==null){
        return radix$733.power(power$737);
    }
    return null;
};computeMagnitude.$$metamodel$$={mod:$$METAMODEL$$,$t:{ t:'u', l:[{t:Null},{t:Integer}]},$ps:[{$nm:'radix',$mt:'prm',$t:{t:Integer}},{$nm:'char',$mt:'prm',$t:{ t:'u', l:[{t:Null},{t:Character}]}}],pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['computeMagnitude']};//computeMagnitude.$$targs$$={Arguments:{t:Tuple,a:{Rest:{t:Empty},First:{ t:'u', l:[{t:Null},{t:Character}]},Element:{ t:'u', l:[{t:Null},{t:Character}]}}},Return:{ t:'u', l:[{t:Null},{t:Integer}]}};
var aInt$738=Character(97).integer;
var getAInt=function(){return aInt$738;};
exports.getAInt=getAInt;
var zeroInt$739=Character(48).integer;
var getZeroInt=function(){return zeroInt$739;};
exports.getZeroInt=getZeroInt;
function parseDigit(digit$740,radix$741){
    var figure$742;
    var digitInt$743=digit$740.integer;
    if((tmpvar$744=digitInt$743.minus(getZeroInt()),tmpvar$744.compare((0))!==getSmaller()&&tmpvar$744.compare((10))===getSmaller())){
        figure$742=digitInt$743.minus(getZeroInt());
    }else {
        if((tmpvar$745=digitInt$743.minus(getAInt()),tmpvar$745.compare((0))!==getSmaller()&&tmpvar$745.compare((26))===getSmaller())){
            figure$742=digitInt$743.minus(getAInt()).plus((10));
        }else {
            return null;
        }
    }
    return (figure$742.compare(radix$741).equals(getSmaller())?figure$742:null);
};parseDigit.$$metamodel$$={mod:$$METAMODEL$$,$t:{ t:'u', l:[{t:Null},{t:Integer}]},$ps:[{$nm:'digit',$mt:'prm',$t:{t:Character}},{$nm:'radix',$mt:'prm',$t:{t:Integer}}],pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['parseDigit']};//parseDigit.$$targs$$={Arguments:{t:Tuple,a:{Rest:{t:Empty},First:{t:Integer},Element:{t:Integer}}},Return:{ t:'u', l:[{t:Null},{t:Integer}]}};
function formatInteger(integer$746,radix$747){
    if(radix$747===undefined){radix$747=(10);}
    //assert at parseInteger.ceylon (195:4-195:49)
    if (!((radix$747.compare(getMinRadix())!==getSmaller())&&(radix$747.compare(getMaxRadix())!==getLarger()))) { throw AssertionException('Assertion failed: \'radix >= minRadix, radix <= maxRadix\' at parseInteger.ceylon (195:11-195:48)'); }
    if(integer$746.equals((0))){
        return String$("0",1);
    }
    var digits$748=StringBuilder();
    var insertIndex$749;
    var i$750;
    var setI$750=function(i$751){return i$750=i$751;};
    if(integer$746.compare((0)).equals(getSmaller())){
        digits$748.append(String$("-",1));
        insertIndex$749=(1);
        i$750=integer$746;
    }else {
        insertIndex$749=(0);
    ...
    while((!i$750.equals((0)))){
        var d$752=(-i$750.remainder(radix$747));
        var c$753;
        if((tmpvar$754=d$752,tmpvar$754.compare((0))!==getSmaller()&&tmpvar$754.compare((10))===getSmaller())){
            c$753=d$752.plus(getZeroInt()).character;
        }else {
            if((tmpvar$755=d$752,tmpvar$755.compare((10))!==getSmaller()&&tmpvar$755.compare((36))===getSmaller())){
                c$753=d$752.minus((10)).plus(getAInt()).character;
            }else {
        ...
        digits$748.insertCharacter(insertIndex$749,c$753);
        i$750=i$750.plus(d$752).divided(radix$747);
    }
    return digits$748.string;
}
exports.formatInteger=formatInteger;
formatInteger.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:String$},$ps:[{$nm:'integer',$mt:'prm',$t:{t:Integer}},{$nm:'radix',$mt:'prm',$def:1,$t:{t:Integer}}],$an:function(){return[$throws($JsCallable(AssertionException,[],{Arguments:{t:Tuple,a:{Rest:{t:Empty},First:{t:String$},Element:{t:String$}}},Return:{t:AssertionException}}),String$("if `radix` is not between `minRadix` and `maxRadix`",51)),shared()];},pkg:'ceylon.language',d:$$METAMODEL$$['ceylon.language']['formatInteger']};//formatInteger.$$targs$$={Arguments:{t:Tuple,a:{Rest:{t:Empty},First:{t:Integer},Element:{t:Integer}}},Return:{t:String$}};
...
function Class$metamodel($$class){
    ClassModel$metamodel($$class);
    Callable($$class);
}
Class$metamodel.$$metamodel$$={mod:$$METAMODEL$$,$tp:{Type:{'var':'out',},Arguments:{'var':'in','satisfies':[{t:Sequential,a:{Element:{t:Anything}}}]}},satisfies:[{t:ClassModel$metamodel,a:{Arguments:'Arguments',Type:'Type'}},{t:Callable,a:{Arguments:'Arguments',Return:'Type'}}],$an:function(){return[shared()];},pkg:'ceylon.language.metamodel',d:$$METAMODEL$$['ceylon.language.metamodel']['Class']};
exports.Class$metamodel=Class$metamodel;
function $init$Class$metamodel(){
    if (Class$metamodel.$$===undefined){
        initTypeProto(Class$metamodel,'ceylon.language.metamodel::Class',$init$ClassModel$metamodel(),$init$Callable());
    }
    return Class$metamodel;
}
exports.$init$Class$metamodel=$init$Class$metamodel;
$init$Class$metamodel();
function ClassModel$metamodel($$classModel){
    ClassOrInterface$metamodel($$classModel);
}
ClassModel$metamodel.$$metamodel$$={mod:$$METAMODEL$$,$tp:{Type:{'var':'out',},Arguments:{'var':'in','satisfies':[{t:Sequential,a:{Element:{t:Anything}}}]}},satisfies:[{t:ClassOrInterface$metamodel,a:{Type:'Type'}}],$an:function(){return[shared()];},pkg:'ceylon.language.metamodel',d:$$METAMODEL$$['ceylon.language.metamodel']['ClassModel']};
exports.ClassModel$metamodel=ClassModel$metamodel;
function $init$ClassModel$metamodel(){
    if (ClassModel$metamodel.$$===undefined){
        initTypeProto(ClassModel$metamodel,'ceylon.language.metamodel::ClassModel',$init$ClassOrInterface$metamodel());
        (function($$classModel){
        })(ClassModel$metamodel.$$.prototype);
    }
    return ClassModel$metamodel;
}
exports.$init$ClassModel$metamodel=$init$ClassModel$metamodel;
$init$ClassModel$metamodel();
function MemberClass$metamodel($$memberClass){
    ClassModel$metamodel($$memberClass);
    Member$metamodel($$memberClass);
    add_type_arg($$memberClass,'Kind',{t:Class$metamodel,a:{Arguments:$$memberClass.$$targs$$.Arguments,Type:$$memberClass.$$targs$$.Type}});
}
MemberClass$metamodel.$$metamodel$$={mod:$$METAMODEL$$,$tp:{Container:{'var':'in',},Type:{'var':'out',},Arguments:{'var':'in','satisfies':[{t:Sequential,a:{Element:{t:Anything}}}]}},satisfies:[{t:ClassModel$metamodel,a:{Arguments:'Arguments',Type:'Type'}},{t:Member$metamodel,a:{Type:'Container',Kind:{t:Class$metamodel,a:{Arguments:'Arguments',Type:'Type'}}}}],$an:function(){return[shared()];},pkg:'ceylon.language.metamodel',d:$$METAMODEL$$['ceylon.language.metamodel']['MemberClass']};
exports.MemberClass$metamodel=MemberClass$metamodel;
function $init$MemberClass$metamodel(){
    if (MemberClass$metamodel.$$===undefined){
        initTypeProto(MemberClass$metamodel,'ceylon.language.metamodel::MemberClass',$init$ClassModel$metamodel(),$init$Member$metamodel());
    }
    return MemberClass$metamodel;
}
exports.$init$MemberClass$metamodel=$init$MemberClass$metamodel;
$init$MemberClass$metamodel();
function ClassOrInterface$metamodel($$classOrInterface){
    Model$metamodel($$classOrInterface);
    Type$metamodel($$classOrInterface);
}
ClassOrInterface$metamodel.$$metamodel$$={mod:$$METAMODEL$$,$tp:{Type:{'var':'out',}},satisfies:[{t:Model$metamodel},{t:Type$metamodel}],$an:function(){return[shared()];},pkg:'ceylon.language.metamodel',d:$$METAMODEL$$['ceylon.language.metamodel']['ClassOrInterface']};
...
function $init$ClassOrInterface$metamodel(){
    if (ClassOrInterface$metamodel.$$===undefined){
        initTypeProto(ClassOrInterface$metamodel,'ceylon.language.metamodel::ClassOrInterface',$init$Model$metamodel(),$init$Type$metamodel());
...
function $init$ConstrainedAnnotation$metamodel(){
    if (ConstrainedAnnotation$metamodel.$$===undefined){
        ...
        (function($$constrainedAnnotation){
            $$constrainedAnnotation.occurs=function occurs(programElement$756){
...
function Model$metamodel($$model){
}
Model$metamodel.$$metamodel$$={mod:$$METAMODEL$$,satisfies:[],$an:function(){return[shared()];},pkg:'ceylon.language.metamodel',d:$$METAMODEL$$['ceylon.language.metamodel']['Model']};
exports.Model$metamodel=Model$metamodel;
function $init$Model$metamodel(){
    if (Model$metamodel.$$===undefined){
        initTypeProto(Model$metamodel,'ceylon.language.metamodel::Model');
        (function($$model){
        })(Model$metamodel.$$.prototype);
    }
    return Model$metamodel;
}
exports.$init$Model$metamodel=$init$Model$metamodel;
$init$Model$metamodel();
function Function$metamodel($$function){
    FunctionModel$metamodel($$function);
    Callable($$function);
}
Function$metamodel.$$metamodel$$={mod:$$METAMODEL$$,$tp:{Type:{'var':'out',},Arguments:{'var':'in','satisfies':[{t:Sequential,a:{Element:{t:Anything}}}]}},satisfies:[{t:FunctionModel$metamodel,a:{Arguments:'Arguments',Type:'Type'}},{t:Callable,a:{Arguments:'Arguments',Return:'Type'}}],$an:function(){return[shared()];},pkg:'ceylon.language.metamodel',d:$$METAMODEL$$['ceylon.language.metamodel']['Function']};
exports.Function$metamodel=Function$metamodel;
function $init$Function$metamodel(){
    if (Function$metamodel.$$===undefined){
        initTypeProto(Function$metamodel,'ceylon.language.metamodel::Function',$init$FunctionModel$metamodel(),$init$Callable());
    }
    return Function$metamodel;
}
exports.$init$Function$metamodel=$init$Function$metamodel;
$init$Function$metamodel();
function FunctionModel$metamodel($$functionModel){
    Model$metamodel($$functionModel);
}
FunctionModel$metamodel.$$metamodel$$={mod:$$METAMODEL$$,$tp:{Type:{'var':'out',},Arguments:{'var':'in','satisfies':[{t:Sequential,a:{Element:{t:Anything}}}]}},satisfies:[{t:Model$metamodel}],$an:function(){return[shared()];},pkg:'ceylon.language.metamodel',d:$$METAMODEL$$['ceylon.language.metamodel']['FunctionModel']};
exports.FunctionModel$metamodel=FunctionModel$metamodel;
function $init$FunctionModel$metamodel(){
    if (FunctionModel$metamodel.$$===undefined){
        initTypeProto(FunctionModel$metamodel,'ceylon.language.metamodel::FunctionModel',$init$Model$metamodel());
        (function($$functionModel){
        })(FunctionModel$metamodel.$$.prototype);
    }
    return FunctionModel$metamodel;
}
exports.$init$FunctionModel$metamodel=$init$FunctionModel$metamodel;
$init$FunctionModel$metamodel();
function Method$metamodel($$method){
    FunctionModel$metamodel($$method);
    Member$metamodel($$method);
    add_type_arg($$method,'Kind',{t:Function$metamodel,a:{Arguments:$$method.$$targs$$.Arguments,Type:$$method.$$targs$$.Type}});
}
Method$metamodel.$$metamodel$$={mod:$$METAMODEL$$,$tp:{Container:{'var':'in',},Type:{'var':'out',},Arguments:{'var':'in','satisfies':[{t:Sequential,a:{Element:{t:Anything}}}]}},satisfies:[{t:FunctionModel$metamodel,a:{Arguments:'Arguments',Type:'Type'}},{t:Member$metamodel,a:{Type:'Container',Kind:{t:Function$metamodel,a:{Arguments:'Arguments',Type:'Type'}}}}],$an:function(){return[shared()];},pkg:'ceylon.language.metamodel',d:$$METAMODEL$$['ceylon.language.metamodel']['Method']};
exports.Method$metamodel=Method$metamodel;
function $init$Method$metamodel(){
    if (Method$metamodel.$$===undefined){
        initTypeProto(Method$metamodel,'ceylon.language.metamodel::Method',$init$FunctionModel$metamodel(),$init$Member$metamodel());
    }
    return Method$metamodel;
}
exports.$init$Method$metamodel=$init$Method$metamodel;
$init$Method$metamodel();
function Interface$metamodel($$interface){
    InterfaceModel$metamodel($$interface);
}
Interface$metamodel.$$metamodel$$={mod:$$METAMODEL$$,$tp:{Type:{'var':'out',}},satisfies:[{t:InterfaceModel$metamodel,a:{Type:'Type'}}],$an:function(){return[shared()];},pkg:'ceylon.language.metamodel',d:$$METAMODEL$$['ceylon.language.metamodel']['Interface']};
exports.Interface$metamodel=Interface$metamodel;
function $init$Interface$metamodel(){
    if (Interface$metamodel.$$===undefined){
        initTypeProto(Interface$metamodel,'ceylon.language.metamodel::Interface',$init$InterfaceModel$metamodel());
    }
    return Interface$metamodel;
}
exports.$init$Interface$metamodel=$init$Interface$metamodel;
$init$Interface$metamodel();
function InterfaceModel$metamodel($$interfaceModel){
    ClassOrInterface$metamodel($$interfaceModel);
}
InterfaceModel$metamodel.$$metamodel$$={mod:$$METAMODEL$$,$tp:{Type:{'var':'out',}},satisfies:[{t:ClassOrInterface$metamodel,a:{Type:'Type'}}],$an:function(){return[shared()];},pkg:'ceylon.language.metamodel',d:$$METAMODEL$$['ceylon.language.metamodel']['InterfaceModel']};
exports.InterfaceModel$metamodel=InterfaceModel$metamodel;
function $init$InterfaceModel$metamodel(){
    if (InterfaceModel$metamodel.$$===undefined){
        initTypeProto(InterfaceModel$metamodel,'ceylon.language.metamodel::InterfaceModel',$init$ClassOrInterface$metamodel());
        (function($$interfaceModel){
        })(InterfaceModel$metamodel.$$.prototype);
    }
    return InterfaceModel$metamodel;
}
exports.$init$InterfaceModel$metamodel=$init$InterfaceModel$metamodel;
$init$InterfaceModel$metamodel();
function MemberInterface$metamodel($$memberInterface){
    InterfaceModel$metamodel($$memberInterface);
    Member$metamodel($$memberInterface);
    add_type_arg($$memberInterface,'Kind',{t:Interface$metamodel,a:{Type:$$memberInterface.$$targs$$.Type}});
}
MemberInterface$metamodel.$$metamodel$$={mod:$$METAMODEL$$,$tp:{Container:{'var':'in',},Type:{'var':'out',}},satisfies:[{t:InterfaceModel$metamodel,a:{Type:'Type'}},{t:Member$metamodel,a:{Type:'Container',Kind:{t:Interface$metamodel,a:{Type:'Type'}}}}],$an:function(){return[shared()];},pkg:'ceylon.language.metamodel',d:$$METAMODEL$$['ceylon.language.metamodel']['MemberInterface']};
exports.MemberInterface$metamodel=MemberInterface$metamodel;
function $init$MemberInterface$metamodel(){
    if (MemberInterface$metamodel.$$===undefined){
        initTypeProto(MemberInterface$metamodel,'ceylon.language.metamodel::MemberInterface',$init$InterfaceModel$metamodel(),$init$Member$metamodel());
    }
    return MemberInterface$metamodel;
}
exports.$init$MemberInterface$metamodel=$init$MemberInterface$metamodel;
$init$MemberInterface$metamodel();
...
Member$metamodel.$$metamodel$$={mod:$$METAMODEL$$,$tp:{Type:{'var':'in',},Kind:{'var':'out','satisfies':[{t:Model$metamodel}]}},satisfies:[{t:Callable,a:{Arguments:{t:Tuple,a:{Rest:{t:Empty},First:'Type',Element:'Type'}},Return:'Kind'}}],$an:function(){return[shared()];},pkg:'ceylon.language.metamodel',d:$$METAMODEL$$['ceylon.language.metamodel']['Member']};
...
function sequencedAnnotations$metamodel(annotationType$757,programElement$758,$$$mptypes){
    return annotations$metamodel(annotationType$757,programElement$758,{Values:{t:Sequential,a:{Element:$$$mptypes.Value}},Value:$$$mptypes.Value,ProgramElement:$$$mptypes.ProgramElement});
}
...
function Value$metamodel($$value){
    AttributeModel$metamodel($$value);
}
Value$metamodel.$$metamodel$$={mod:$$METAMODEL$$,$tp:{Type:{'var':'out',}},satisfies:[{t:AttributeModel$metamodel,a:{Type:'Type'}}],$an:function(){return[shared()];},pkg:'ceylon.language.metamodel',d:$$METAMODEL$$['ceylon.language.metamodel']['Value']};
exports.Value$metamodel=Value$metamodel;
function $init$Value$metamodel(){
    if (Value$metamodel.$$===undefined){
        initTypeProto(Value$metamodel,'ceylon.language.metamodel::Value',$init$AttributeModel$metamodel());
        (function($$value){
...
function Attribute$metamodel($$attribute){
    AttributeModel$metamodel($$attribute);
    Member$metamodel($$attribute);
    add_type_arg($$attribute,'Kind',{t:Value$metamodel,a:{Type:$$attribute.$$targs$$.Type}});
}
Attribute$metamodel.$$metamodel$$={mod:$$METAMODEL$$,$tp:{Container:{'var':'in',},Type:{'var':'out',}},satisfies:[{t:AttributeModel$metamodel,a:{Type:'Type'}},{t:Member$metamodel,a:{Type:'Container',Kind:{t:Value$metamodel,a:{Type:'Type'}}}}],$an:function(){return[shared()];},pkg:'ceylon.language.metamodel',d:$$METAMODEL$$['ceylon.language.metamodel']['Attribute']};
exports.Attribute$metamodel=Attribute$metamodel;
function $init$Attribute$metamodel(){
    if (Attribute$metamodel.$$===undefined){
        initTypeProto(Attribute$metamodel,'ceylon.language.metamodel::Attribute',$init$AttributeModel$metamodel(),$init$Member$metamodel());
    }
    return Attribute$metamodel;
}
exports.$init$Attribute$metamodel=$init$Attribute$metamodel;
$init$Attribute$metamodel();
function AttributeModel$metamodel($$attributeModel){
    Model$metamodel($$attributeModel);
}
AttributeModel$metamodel.$$metamodel$$={mod:$$METAMODEL$$,$tp:{Type:{'var':'out',}},satisfies:[{t:Model$metamodel}],$an:function(){return[shared()];},pkg:'ceylon.language.metamodel',d:$$METAMODEL$$['ceylon.language.metamodel']['AttributeModel']};
exports.AttributeModel$metamodel=AttributeModel$metamodel;
function $init$AttributeModel$metamodel(){
    if (AttributeModel$metamodel.$$===undefined){
        initTypeProto(AttributeModel$metamodel,'ceylon.language.metamodel::AttributeModel',$init$Model$metamodel());
        (function($$attributeModel){
        })(AttributeModel$metamodel.$$.prototype);
    }
    return AttributeModel$metamodel;
}
exports.$init$AttributeModel$metamodel=$init$AttributeModel$metamodel;
$init$AttributeModel$metamodel();
function Variable$metamodel($$variable){
    Value$metamodel($$variable);
}
Variable$metamodel.$$metamodel$$={mod:$$METAMODEL$$,$tp:{Type:{}},satisfies:[{t:Value$metamodel,a:{Type:'Type'}}],$an:function(){return[shared()];},pkg:'ceylon.language.metamodel',d:$$METAMODEL$$['ceylon.language.metamodel']['Variable']};
...
function VariableAttribute$metamodel($$variableAttribute){
    Member$metamodel($$variableAttribute);
    add_type_arg($$variableAttribute,'Kind',{t:Variable$metamodel,a:{Type:$$variableAttribute.$$targs$$.Type}});
    Attribute$metamodel($$variableAttribute);
}
VariableAttribute$metamodel.$$metamodel$$={mod:$$METAMODEL$$,$tp:{Container:{'var':'in',},Type:{}},satisfies:[{t:Member$metamodel,a:{Type:'Container',Kind:{t:Variable$metamodel,a:{Type:'Type'}}}},{t:Attribute$metamodel,a:{Type:'Type',Container:'Container'}}],$an:function(){return[shared()];},pkg:'ceylon.language.metamodel',d:$$METAMODEL$$['ceylon.language.metamodel']['VariableAttribute']};
exports.VariableAttribute$metamodel=VariableAttribute$metamodel;
function $init$VariableAttribute$metamodel(){
    if (VariableAttribute$metamodel.$$===undefined){
        initTypeProto(VariableAttribute$metamodel,'ceylon.language.metamodel::VariableAttribute',$init$Member$metamodel(),$init$Attribute$metamodel());
    }
    return VariableAttribute$metamodel;
}
exports.$init$VariableAttribute$metamodel=$init$VariableAttribute$metamodel;
$init$VariableAttribute$metamodel();
function annotations$metamodel(annotationType$759,programElement$760,$$$mptypes){
    throw Exception();
}
...
function nothingType$761$metamodel(){
    var $$nothingType=new nothingType$761$metamodel.$$;
    Type$metamodel($$nothingType);
    return $$nothingType;
}
function $init$nothingType$761$metamodel(){
    if (nothingType$761$metamodel.$$===undefined){
        initTypeProto(nothingType$761$metamodel,'ceylon.language.metamodel::nothingType',Basic,$init$Type$metamodel());
    }
    return nothingType$761$metamodel;
}
exports.$init$nothingType$761$metamodel=$init$nothingType$761$metamodel;
$init$nothingType$761$metamodel();
(function($$nothingType){
    defineAttr($$nothingType,'string',function(){
        var $$nothingType=this;
        return String$("Nothing",7);
    });
})(nothingType$761$metamodel.$$.prototype);
var nothingType$762$metamodel=nothingType$761$metamodel();
var getNothingType$metamodel=function(){
    return nothingType$762$metamodel;
}
...
function optionalAnnotation$metamodel(annotationType$763,programElement$764,$$$mptypes){
    return annotations$metamodel(annotationType$763,programElement$764,{Values:{ t:'u', l:[{t:Null},$$$mptypes.Value]},Value:$$$mptypes.Value,ProgramElement:$$$mptypes.ProgramElement});
}
exports.optionalAnnotation$metamodel=optionalAnnotation$metamodel;
...
function nothingType$765$metamodel$declaration(){
    var $$nothingType=new nothingType$765$metamodel$declaration.$$;
    OpenType$metamodel$declaration($$nothingType);
    return $$nothingType;
}
function $init$nothingType$765$metamodel$declaration(){
    if (nothingType$765$metamodel$declaration.$$===undefined){
        initTypeProto(nothingType$765$metamodel$declaration,'ceylon.language.metamodel.declaration::nothingType',Basic,$init$OpenType$metamodel$declaration());
    }
    return nothingType$765$metamodel$declaration;
}
exports.$init$nothingType$765$metamodel$declaration=$init$nothingType$765$metamodel$declaration;
$init$nothingType$765$metamodel$declaration();
(function($$nothingType){
    defineAttr($$nothingType,'string',function(){
        var $$nothingType=this;
        return String$("Nothing",7);
    });
})(nothingType$765$metamodel$declaration.$$.prototype);
var nothingType$766$metamodel$declaration=nothingType$765$metamodel$declaration();
var getNothingType$metamodel$declaration=function(){
    return nothingType$766$metamodel$declaration;
}
...
$init$Doc();
var doc=function (description$767){
    return Doc(description$767);
};
...
$init$See();
var see=function (programElements$768){
    if(programElements$768===undefined){programElements$768=getEmpty();}
    return See(programElements$768);
};
...
$init$Authors();
var by=function (authors$769){
    if(authors$769===undefined){authors$769=getEmpty();}
    return Authors(authors$769);
};
...
$init$ThrownException();
var $throws=function (type$770,when$771){
    if(when$771===undefined){when$771=String$("",0);}
    return ThrownException(type$770,when$771);
};
...
$init$Deprecation();
var deprecated=function (reason$772){
    if(reason$772===undefined){reason$772=String$("",0);}
    return Deprecation(reason$772);
};
...
$init$Tags();
var tagged=function (tags$773){
    if(tags$773===undefined){tags$773=getEmpty();}
    return Tags(tags$773);
};
...
$init$License();
var license=function (url$774){
    return License(url$774);
};
