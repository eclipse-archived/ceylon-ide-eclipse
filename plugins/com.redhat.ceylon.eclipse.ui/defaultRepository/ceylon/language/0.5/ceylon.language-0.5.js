    ...
    if (Collection.$$===undefined){
        ...
        (function($$collection){
            ...
            $$collection.contains=function contains(element$2){
                ...
                var elem$4;while ((elem$4=it$3.next())!==getExhausted()){
                    var elem$5;
                    if(isOfType((elem$5=elem$4),'ceylon.language::Object')&&elem$5.equals(element$2)){
                        return true;
                    }
                }
                if (getExhausted() === elem$4){
                    return false;
                }
    ...
    if (Category.$$===undefined){
        ...
        (function($$category){
            $$category.containsEvery=function containsEvery(elements$13){
                ...
                var element$15;while ((element$15=it$14.next())!==getExhausted()){
                    if((!$$category.contains(element$15))){
                        return false;
                    }
                }
                if (getExhausted() === element$15){
                    return true;
                }
                ...
                var element$18;while ((element$18=it$17.next())!==getExhausted()){
                    if($$category.contains(element$18)){
                        return true;
                    }
                }
                if (getExhausted() === element$18){
                    return false;
                }
            };
        })(Category.$$.prototype);
...
function $init$Tuple(){
    if (Tuple.$$===undefined){
        initTypeProto(Tuple,'ceylon.language::Tuple',Object$,$init$Sequence());
        (function($$tuple){
            ...
            $$tuple.getString=function getString(){
                ...
                var el$44;while ((el$44=it$43.next())!==getExhausted()){
                    if(first$41){
                        (first$41=false);
                    }else {
    ...
    if (ChainedIterator.$$===undefined){
        ...
        (function($$chainedIterator){
            ...
            $$chainedIterator.next=function next(){
                ...
                var f$54;
                if(isOfType((f$54=e$52),'ceylon.language::Finished')){
    ...
    if (Entry.$$===undefined){
        ...
        (function($$entry){
            ...
            $$entry.equals=function equals(that$59){
                var $$entry=this;
                var that$60;
                if(isOfType((that$60=that$59),'ceylon.language::Entry')){
...
function $init$Integral(){
    if (Integral.$$===undefined){
        initTypeProto(Integral,'ceylon.language::Integral',$init$Numeric(),$init$Ordinal());
        (function($$integral){
        })(Integral.$$.prototype);
    }
    return Integral;
...
function $init$LazyList(){
    if (LazyList.$$===undefined){
        initTypeProto(LazyList,'ceylon.language::LazyList',IdentifiableObject,$init$List());
        (function($$lazyList){
            $$lazyList.getLastIndex=function getLastIndex(){
                var $$lazyList=this;
                var c$69=$$lazyList.elems$68.count(function (e$70){
                    var $$lazyList=this;
                    return true;
                });
            ...
            $$lazyList.span=function span(from$73,to$74){
                ...
                var toIndex$75=largest(to$74,(0));
                var fromIndex$76=largest(from$73,(0));
                if((toIndex$75.compare(fromIndex$76)!==getSmaller())){
                    ...
                    var opt$78;
                    return LazyList/* REIFIED GENERICS SOON!! */(els$77.taking(toIndex$75.minus(fromIndex$76).plus((1))));
                }else {
                ...
                var $$lazyList=this;
                return (opt$82=(to$81.compare((0)).equals(getSmaller())?empty:null),opt$82!==null?opt$82:LazyList/* REIFIED GENERICS SOON!! */($$lazyList.elems$68.taking(to$81.plus((1)))));
                var opt$82;
            };$$lazyList.spanFrom=function spanFrom(from$83){
                var $$lazyList=this;
                return (opt$84=(from$83.compare((0)).equals(getLarger())?LazyList/* REIFIED GENERICS SOON!! */($$lazyList.elems$68.skipping(from$83)):null),opt$84!==null?opt$84:$$lazyList);
                var opt$84;
                ...
                if(length$86.compare((0)).equals(getLarger())){
                    ...
                    var opt$88;
                    return LazyList/* REIFIED GENERICS SOON!! */(els$87.taking(length$86));
                }else {
                    return empty;
                }
                ...
                var $$lazyList=this;
                var that$90;
                if(isOfType((that$90=that$89),'ceylon.language::List')){
                    var s$91=$$lazyList.elems$68.count(function (e$92){
                        var $$lazyList=this;
                        return true;
                    });
                    if(that$90.getSize().equals(s$91)){
                        var it$93 = Range((0),s$91.minus((1))).getIterator();
                        var i$94;while ((i$94=it$93.next())!==getExhausted()){
                ...
                var elem$103;while ((elem$103=it$102.next())!==getExhausted()){
                    (hash$100=hash$100.times((31)));
                    var elem$104;
                    if(isOfType((elem$104=elem$103),'ceylon.language::Object')){
    ...
    if (Set.$$===undefined){
        ...
        (function($$set){
            $$set.superset=function superset(set$106){
                ...
                var element$108;while ((element$108=it$107.next())!==getExhausted()){
                    if((!$$set.contains(element$108))){
                        return false;
                    }
                }
                if (getExhausted() === element$108){
                    return true;
                }
            };$$set.subset=function subset(set$109){
                var $$set=this;
                var it$110 = $$set.getIterator();
                var element$111;while ((element$111=it$110.next())!==getExhausted()){
                    if((!set$109.contains(element$111))){
                        return false;
                    }
                }
                if (getExhausted() === element$111){
                    return true;
                }
            };$$set.equals=function equals(that$112){
                var $$set=this;
                var that$113;
                if(isOfType((that$113=that$112),'ceylon.language::Set')&&that$113.getSize().equals($$set.getSize())){
                    var it$114 = $$set.getIterator();
                    var element$115;while ((element$115=it$114.next())!==getExhausted()){
                        if((!that$113.contains(element$115))){
                            return false;
                        }
                    }
                    if (getExhausted() === element$115){
                        return true;
                    }
                }
                return false;
                ...
                var elem$119;while ((elem$119=it$118.next())!==getExhausted()){
...
function $init$LazyMap(){
    if (LazyMap.$$===undefined){
        initTypeProto(LazyMap,'ceylon.language::LazyMap',IdentifiableObject,$init$Map());
        (function($$lazyMap){
            ...
            $$lazyMap.equals=function equals(that$125){
                var $$lazyMap=this;
                var that$126;
                if(isOfType((that$126=that$125),'ceylon.language::Map')){
                    if(that$126.getSize().equals($$lazyMap.getSize())){
                        var it$127 = $$lazyMap.getIterator();
                        var entry$128;while ((entry$128=it$127.next())!==getExhausted()){
                            var item$129;
                ...
                var elem$133;while ((elem$133=it$132.next())!==getExhausted()){
...
function zip(keys$134,items$135){
    ...
    return toTuple(Comprehension(function(){
        var item$139;
        var it$137=keys$134.getIterator();
        var key$138=getExhausted();
        var item$139;
        var next$key$138=function(){
            while((key$138=it$137.next())!==getExhausted()){
                if(!isOfType((item$139=iter$136.next()),'ceylon.language::Finished')){
                    return key$138;
                }
            }
            return getExhausted();
        ...
        next$key$138();
        return function(){
            if(key$138!==getExhausted()){
                var tmpvar$140=Entry(key$138,item$139);
                next$key$138();
                return tmpvar$140;
            }
            return getExhausted();
...
function max(values$141){
    ...
    if((first$144=first$143)!==null){
        ...
        var val$148;while ((val$148=it$147.next())!==getExhausted()){
...
var lessThan=function (val$160){
    return function(element$161){{
...
var equalTo=function (val$163){
    return function(element$164){{
...
var forKey=function (resulting$165){
...
var join=function (iterables$167){
    ...
    return toTuple(Comprehension(function(){
        ...
        var it$169=getExhausted();
        var next$it$169=function(){
            if((it$169=it$168.next())!==getExhausted()){
        ...
        var it$170;
        var val$171=getExhausted();
        var next$val$171=function(){return val$171=it$170.next();}
        next$it$169();
        return function(){
            do{
                if(val$171!==getExhausted()){
                    var tmpvar$172=val$171;
                    next$val$171();
                    return tmpvar$172;
                }
            }while(next$it$169()!==getExhausted());
            return getExhausted();
        }
    }));
};
...
function sum(values$174){
    ...
    var val$178;while ((val$178=it$177.next())!==getExhausted()){
        (sum$175=sum$175.plus(val$178));
    }
    return sum$175;
}
exports.sum=sum;
var print=function (line$179){
    return getProcess().writeLine((opt$180=(opt$181=line$179,opt$181!==null?opt$181.getString():null),opt$180!==null?opt$180:String("«null»",6)));
};
exports.print=print;
var opt$180,opt$181;
function any(values$182){
    ...
    var val$184;while ((val$184=it$183.next())!==getExhausted()){
        if(val$184){
            return true;
        }
    }
...
function min(values$185){
    ...
    if((first$188=first$187)!==null){
        ...
        var val$192;while ((val$192=it$191.next())!==getExhausted()){
...
function count(values$196){
    ...
    var val$200;while ((val$200=it$199.next())!==getExhausted()){
        if(val$200){
...
exports.count=count;
var greaterThan=function (val$202){
    return function(element$203){{
...
var largest=function (x$211,y$212){
...
function first(elements$217){
    ...
    var first$218;
    if(!isOfType((first$218=elements$217.getIterator().next()),'ceylon.language::Finished')){
        return first$218;
    }else {
        return null;
    }
...
function every(values$219){
    ...
    var val$221;while ((val$221=it$220.next())!==getExhausted()){
        if((!val$221)){
            return false;
        }
    }
...
function emptyOrSingleton(element$222){
    ...
    if((element$223=element$222)!==null){
        return Singleton/* REIFIED GENERICS SOON!! */(element$223);
    }else {
        return empty;
    }
}
