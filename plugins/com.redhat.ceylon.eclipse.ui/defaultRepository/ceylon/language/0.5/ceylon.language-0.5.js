...
function $init$Category(){
    if (Category.$$===undefined){
        ...
        (function($$category){
            $$category.containsEvery=function containsEvery(elements$2){
                var $$category=this;
                if(elements$2===undefined){elements$2=empty;}
                var it$3 = elements$2.getIterator();
                var element$4;while ((element$4=it$3.next())!==getFinished()){
                    if((!$$category.contains(element$4))){
                        return false;
                    }
                }
                if (getFinished() === element$4){
                    return true;
                }
            };$$category.containsAny=function containsAny(elements$5){
                var $$category=this;
                if(elements$5===undefined){elements$5=empty;}
                var it$6 = elements$5.getIterator();
                var element$7;while ((element$7=it$6.next())!==getFinished()){
                    if($$category.contains(element$7)){
                        return true;
                    }
                }
                if (getFinished() === element$7){
                    return false;
                }
            };
        })(Category.$$.prototype);
...
function $init$Collection(){
    if (Collection.$$===undefined){
        ...
        (function($$collection){
            ...
            $$collection.contains=function contains(element$8){
                var $$collection=this;
                var it$9 = $$collection.getIterator();
                var elem$10;while ((elem$10=it$9.next())!==getFinished()){
                    var elem$11;
                    if((elem$11=elem$10)!==null&&elem$11.equals(element$8)){
                        return true;
                    }
                }
                if (getFinished() === elem$10){
                    return false;
                }
            };$$collection.getElementsString$12=function getElementsString$12(){
                var $$collection=this;
                return String$(", ",2).join(Comprehension(function(){
                    var it$13=$$collection.getIterator();
                    var elem$14=getFinished();
                    var next$elem$14=function(){return elem$14=it$13.next();}
                    next$elem$14();
                    return function(){
                        if(elem$14!==getFinished()){
                            var tmpvar$15=(opt$16=(opt$17=elem$14,opt$17!==null?opt$17.getString():null),opt$16!==null?opt$16:String$("null",4));
                            next$elem$14();
                            return tmpvar$15;
                        }
                        return getFinished();
            ...
            $$collection.getString=function getString(){
                var $$collection=this;
                return (opt$18=($$collection.getEmpty()?String$("{}",2):null),opt$18!==null?opt$18:StringBuilder().appendAll([String$("{ ",2),$$collection.getElementsString$12().getString(),String$(" }",2)]).getString());
            };
...
$init$Iterator();
function ChainedIterator(first$19, second$20, $$targs$$,$$chainedIterator){
    $init$ChainedIterator();
    if ($$chainedIterator===undefined)$$chainedIterator=new ChainedIterator.$$;
    $$chainedIterator.$$targs$$=$$targs$$;
    $$chainedIterator.second$20=second$20;
    Iterator($$chainedIterator);
    $$chainedIterator.iter$21=first$19.getIterator();
    $$chainedIterator.more$22=true;
...
function $init$ChainedIterator(){
    if (ChainedIterator.$$===undefined){
        ...
        (function($$chainedIterator){
            $$chainedIterator.getIter$21=function getIter$21(){
                return this.iter$21;
            };
            $$chainedIterator.setIter$21=function setIter$21(iter$23){
                return this.iter$21=iter$23;
            };
            $$chainedIterator.getMore$22=function getMore$22(){
                return this.more$22;
            };
            $$chainedIterator.setMore$22=function setMore$22(more$24){
                return this.more$22=more$24;
            };
            $$chainedIterator.next=function next(){
                var $$chainedIterator=this;
                var e$25=$$chainedIterator.getIter$21().next();
                var setE$25=function(e$26){return e$25=e$26;};
                var f$27;
                if(isOfType((f$27=e$25),{t:Finished})){
                    if($$chainedIterator.getMore$22()){
                        $$chainedIterator.setIter$21($$chainedIterator.second$20.getIterator());
                        $$chainedIterator.setMore$22(false);
                        e$25=$$chainedIterator.getIter$21().next();
                    }
                }
                return e$25;
            };
...
$init$ChainedIterator();
function Tuple(first$28, rest$29, $$targs$$,$$tuple){
    $init$Tuple();
    ...
    Sequence($$tuple);
    Cloneable($$tuple);
    $$tuple.first$30=first$28;
    $$tuple.rest$31=rest$29;
    return $$tuple;
}
exports.Tuple=Tuple;
function $init$Tuple(){
    if (Tuple.$$===undefined){
        ...
        (function($$tuple){
            $$tuple.getFirst=function getFirst(){
                return this.first$30;
            };
            $$tuple.getRest=function getRest(){
                return this.rest$31;
            };
            $$tuple.item=function item(index$32){
                var $$tuple=this;
                
                var switch$33=index$32.compare((0));
                if (switch$33===getSmaller()) {
                    return null;
                }else if (switch$33===getEqual()) {
                    return $$tuple.getFirst();
                }else if (switch$33===getLarger()) {
                    return $$tuple.getRest().item(index$32.minus((1)));
                }
            };$$tuple.getLastIndex=function getLastIndex(){
                var $$tuple=this;
                var restLastIndex$34;
                if((restLastIndex$34=$$tuple.getRest().getLastIndex())!==null){
                    return restLastIndex$34.plus((1));
                }else {
                    return (0);
                }
                ...
                var $$tuple=this;
                var rest$35;
                if(nonempty((rest$35=$$tuple.getRest()))){
                    return rest$35.getLast();
                }else {
                    return $$tuple.getFirst();
                }
            ...
            $$tuple.segment=function segment(from$36,length$37){
                var $$tuple=this;
                if(length$37.compare((0)).equals(getSmaller())){
                    return empty;
                }
                var realFrom$38=(opt$39=(from$36.compare((0)).equals(getSmaller())?(0):null),opt$39!==null?opt$39:from$36);
                var opt$39;
                if(realFrom$38.equals((0))){
                    return (opt$40=(length$37.equals((1))?Tuple($$tuple.getFirst(),empty,[$$tuple.$$targs$$[1],$$tuple.$$targs$$[1],{t:Empty}]):null),opt$40!==null?opt$40:$$tuple.getRest().segment((0),length$37.plus(realFrom$38).minus((1))).withLeading($$tuple.getFirst(),[$$tuple.$$targs$$[1]]));
                    var opt$40;
                }
                return $$tuple.getRest().segment(realFrom$38.minus((1)),length$37);
            };$$tuple.span=function span(from$41,end$42){
                var $$tuple=this;
                var realFrom$43=(opt$44=(from$41.compare((0)).equals(getSmaller())?(0):null),opt$44!==null?opt$44:from$41);
                var opt$44;
                return (opt$45=((realFrom$43.compare(end$42)!==getLarger())?$$tuple.segment(from$41,end$42.minus(realFrom$43).plus((1))):null),opt$45!==null?opt$45:$$tuple.segment(end$42,realFrom$43.minus(end$42).plus((1))).getReversed().getSequence());
                var opt$45;
            };$$tuple.spanTo=function (to$46){
                var $$tuple=this;
                return (opt$47=(to$46.compare((0)).equals(getSmaller())?empty:null),opt$47!==null?opt$47:$$tuple.span((0),to$46));
            };
            $$tuple.spanFrom=function (from$48){
                var $$tuple=this;
                return $$tuple.span(from$48,$$tuple.getSize());
            };
            ...
            $$tuple.getString=function getString(){
                var $$tuple=this;
                var b$49=StringBuilder().append(String$("[ ",2));
                var first$50=true;
                var setFirst$50=function(first$51){return first$50=first$51;};
                var it$52 = $$tuple.getIterator();
                var el$53;while ((el$53=it$52.next())!==getFinished()){
                    if(first$50){
                        first$50=false;
                    }else {
                        b$49.append(String$(", ",2));
                    }
                    var el$54;
                    if((el$54=el$53)!==null){
                        b$49.append(el$54.getString());
                    }else {
                        b$49.append(String$("null",4));
                    }
                }
                return b$49.append(String$(" ]",2)).getString();
            };
        })(Tuple.$$.prototype);
    }
    return Tuple;
...
$init$LazyList();
function LazyMap(entries$120, $$targs$$,$$lazyMap){
    $init$LazyMap();
    ...
    if (LazyMap.$$===undefined){
        ...
        (function($$lazyMap){
            $$lazyMap.getFirst=function getFirst(){
                var $$lazyMap=this;
                return $$lazyMap.entries$120.getFirst();
            };
            $$lazyMap.getLast=function getLast(){
                var $$lazyMap=this;
                return $$lazyMap.entries$120.getLast();
            };
...
$init$LazyMap();
var opt$123;
function LazySet(elems$134, $$targs$$,$$lazySet){
    $init$LazySet();
    if ($$lazySet===undefined)$$lazySet=new LazySet.$$;
    $$lazySet.$$targs$$=$$targs$$;
    $$lazySet.elems$134=elems$134;
    Set($$lazySet);
    return $$lazySet;
}
    ...
    if (LazySet.$$===undefined){
        ...
        (function($$lazySet){
            ...
            $$lazySet.getSize=function getSize(){
                var $$lazySet=this;
                var c$135=(0);
                var setC$135=function(c$136){return c$135=c$136;};
                var sorted$137=$$lazySet.elems$134.$sort(byIncreasing(function (e$138){
                    var $$lazySet=this;
                    return e$138.getHash();
                },[$$lazySet.$$targs$$[0],{t:Integer}]));
                var l$139;
                if((l$139=sorted$137.getFirst())!==null){
                    c$135=(1);
                    var last$140=l$139;
                    var setLast$140=function(last$141){return last$140=last$141;};
                    var it$142 = sorted$137.getRest().getIterator();
                    var e$143;while ((e$143=it$142.next())!==getFinished()){
                        if((!e$143.equals(last$140))){
                            (oldc$144=c$135,c$135=oldc$144.getSuccessor(),oldc$144);
                            var oldc$144;
                            last$140=e$143;
                        }
                    }
                ...
                var $$lazySet=this;
                return $$lazySet.elems$134.getIterator();
            };
            $$lazySet.union=function (set$145,$$$mptypes){
                var $$lazySet=this;
                return LazySet($$lazySet.elems$134.chain(set$145,[$$$mptypes[0]]),[{ t:'u', l:[$$lazySet.$$targs$$[0],$$$mptypes[0]]}]);
            };
            $$lazySet.intersection=function (set$146,$$$mptypes){
                var $$lazySet=this;
                return LazySet(Comprehension(function(){
                    var e$149;
                    var it$147=set$146.getIterator();
                    var e$148=getFinished();
                    var e$149;
                    var next$e$148=function(){
                        while((e$148=it$147.next())!==getFinished()){
                            if(isOfType((e$149=e$148),$$lazySet.$$targs$$[0])&&$$lazySet.contains(e$149)){
                                return e$148;
                            }
                        }
                        return getFinished();
                    ...
                    return function(){
                        if(e$148!==getFinished()){
                            var tmpvar$150=e$149;
                            next$e$148();
                            return tmpvar$150;
                        }
                        return getFinished();
                    }
                },[{ t:'i', l:[$$$mptypes[0],$$lazySet.$$targs$$[0]]}]),[{ t:'i', l:[$$$mptypes[0],$$lazySet.$$targs$$[0]]}]);
            };
            $$lazySet.exclusiveUnion=function exclusiveUnion(other$151,$$$mptypes){
                var $$lazySet=this;
                var hereNotThere$152=Comprehension(function(){
                    var it$153=$$lazySet.elems$134.getIterator();
                    var e$154=getFinished();
                    var next$e$154=function(){
                        while((e$154=it$153.next())!==getFinished()){
                            if((!other$151.contains(e$154))){
                                return e$154;
                            }
                        }
                        return getFinished();
                    ...
                    next$e$154();
                    return function(){
                        if(e$154!==getFinished()){
                            var tmpvar$155=e$154;
                            next$e$154();
                            return tmpvar$155;
                        }
                        return getFinished();
                ...
                var thereNotHere$156=Comprehension(function(){
                    var it$157=other$151.getIterator();
                    var e$158=getFinished();
                    var next$e$158=function(){
                        while((e$158=it$157.next())!==getFinished()){
                            if((!$$lazySet.contains(e$158))){
                                return e$158;
                            }
                        }
                        return getFinished();
                    ...
                    next$e$158();
                    return function(){
                        if(e$158!==getFinished()){
                            var tmpvar$159=e$158;
                            next$e$158();
                            return tmpvar$159;
                        }
                        return getFinished();
                ...
                return LazySet(hereNotThere$152.chain(thereNotHere$156,[$$$mptypes[0]]),[{ t:'u', l:[$$lazySet.$$targs$$[0],$$$mptypes[0]]}]);
            };$$lazySet.complement=function (set$160,$$$mptypes){
                var $$lazySet=this;
                return LazySet(Comprehension(function(){
                    var it$161=$$lazySet.getIterator();
                    var e$162=getFinished();
                    var next$e$162=function(){
                        while((e$162=it$161.next())!==getFinished()){
                            if((!set$160.contains(e$162))){
                                return e$162;
                            }
                        }
                        return getFinished();
                    ...
                    next$e$162();
                    return function(){
                        if(e$162!==getFinished()){
                            var tmpvar$163=e$162;
                            next$e$162();
                            return tmpvar$163;
                        }
                        return getFinished();
                    }
                },[$$lazySet.$$targs$$[0]]),[$$lazySet.$$targs$$[0]]);
            };
            $$lazySet.equals=function equals(that$164){
                var $$lazySet=this;
                var that$165;
                if(isOfType((that$165=that$164),{t:Set,a:[{t:Object$}]})){
                    if(that$165.getSize().equals($$lazySet.getSize())){
                        var it$166 = $$lazySet.elems$134.getIterator();
                        var element$167;while ((element$167=it$166.next())!==getFinished()){
                            if((!that$165.contains(element$167))){
                                return false;
                            }
                        }
                        if (getFinished() === element$167){
                            return true;
                        }
                    }
                }
                ...
                var it$170 = $$lazySet.elems$134.getIterator();
...
function any(values$204){
    if(values$204===undefined){values$204=empty;}
    var it$205 = values$204.getIterator();
    var val$206;while ((val$206=it$205.next())!==getFinished()){
        if(val$206){
            return true;
        }
    }
...
exports.any=any;
function byDecreasing(comparable$207,$$$mptypes){
    return function(x$208,y$209,$$$mptypes){
        var cx$210;
        var cy$211;
        if((cx$210=comparable$207(x$208))!==null&&(cy$211=comparable$207(y$209))!==null){
            return cy$211.compare(cx$210);
        }else {
            return null;
        }
    }
...
function byIncreasing(comparable$212,$$$mptypes){
    return function(x$213,y$214,$$$mptypes){
        var cx$215;
        var cy$216;
        if((cx$215=comparable$212(x$213))!==null&&(cy$216=comparable$212(y$214))!==null){
            return cx$215.compare(cy$216);
        }else {
            return null;
        }
    }
...
var byItem=function (comparing$217){
    return function(x$218,y$219,$$$mptypes){{
        return comparing$217(x$218.getItem(),y$219.getItem());
    }
}
}
;
exports.byItem=byItem;
var byKey=function (comparing$220){
    return function(x$221,y$222,$$$mptypes){{
        return comparing$220(x$221.getKey(),y$222.getKey());
    }
}
}
;
exports.byKey=byKey;
var coalesce=function (values$223,$$$mptypes){
    if(values$223===undefined){values$223=empty;}
    return values$223.getCoalesced();
};
exports.coalesce=coalesce;
function count(values$224){
    if(values$224===undefined){values$224=empty;}
    var count$225=(0);
    var setCount$225=function(count$226){return count$225=count$226;};
    var it$227 = values$224.getIterator();
    var val$228;while ((val$228=it$227.next())!==getFinished()){
        if(val$228){
            (oldcount$229=count$225,count$225=oldcount$229.getSuccessor(),oldcount$229);
            var oldcount$229;
        }
    }
    return count$225;
...
exports.count=count;
var elements=function (elements$230,$$$mptypes){
    if(elements$230===undefined){elements$230=empty;}
    return elements$230;
};
exports.elements=elements;
function emptyOrSingleton(element$231,$$$mptypes){
    var element$232;
    if((element$232=element$231)!==null){
        return Singleton(element$232,[$$$mptypes[0]]);
    }else {
        return empty;
    }
}
exports.emptyOrSingleton=emptyOrSingleton;
var entries=function (elements$233,$$$mptypes){
    if(elements$233===undefined){elements$233=empty;}
    return elements$233.getIndexed();
};
exports.entries=entries;
var equalTo=function (val$234,$$$mptypes){
    return function(element$235,$$$mptypes){{
        return element$235.equals(val$234);
    }
}
}
;
exports.equalTo=equalTo;
function every(values$236){
    if(values$236===undefined){values$236=empty;}
    var it$237 = values$236.getIterator();
    var val$238;while ((val$238=it$237.next())!==getFinished()){
        if((!val$238)){
            return false;
        }
    }
...
exports.every=every;
function first(elements$239,$$$mptypes){
    if(elements$239===undefined){elements$239=empty;}
    var first$240;
    if(!isOfType((first$240=elements$239.getIterator().next()),{t:Finished})){
        return first$240;
    }else {
        return null;
    }
...
exports.first=first;
var forItem=function (resulting$241,$$$mptypes){
    return function(entry$242,$$$mptypes){{
        return resulting$241(entry$242.getItem());
    }
}
}
;
exports.forItem=forItem;
var forKey=function (resulting$243,$$$mptypes){
    return function(entry$244,$$$mptypes){{
        return resulting$243(entry$244.getKey());
    }
}
}
;
exports.forKey=forKey;
var greaterThan=function (val$245,$$$mptypes){
    return function(element$246,$$$mptypes){{
        return element$246.compare(val$245).equals(getLarger());
    }
}
}
;
exports.greaterThan=greaterThan;
var identical=function (x$247,y$248){
    return (x$247===y$248);
};
exports.identical=identical;
var join=function (iterables$249,$$$mptypes){
    if(iterables$249===undefined){iterables$249=empty;}
    return Comprehension(function(){
        var it$250=iterables$249.getIterator();
        var it$251=getFinished();
        var next$it$251=function(){
            if((it$251=it$250.next())!==getFinished()){
                it$252=it$251.getIterator();
                next$val$253();
                return it$251;
            }
            return getFinished();
        ...
        var it$252;
        var val$253=getFinished();
        var next$val$253=function(){return val$253=it$252.next();}
        next$it$251();
        return function(){
            do{
                if(val$253!==getFinished()){
                    var tmpvar$254=val$253;
                    next$val$253();
                    return tmpvar$254;
                }
            }while(next$it$251()!==getFinished());
            return getFinished();
        }
    },[$$$mptypes[0]]).getSequence();
};
exports.join=join;
var largest=function (x$255,y$256,$$$mptypes){
    return (opt$257=(x$255.compare(y$256).equals(getLarger())?x$255:null),opt$257!==null?opt$257:y$256);
};
exports.largest=largest;
var opt$257;
var lessThan=function (val$258,$$$mptypes){
    return function(element$259,$$$mptypes){{
        return element$259.compare(val$258).equals(getSmaller());
    }
}
}
;
exports.lessThan=lessThan;
function max(values$260,$$$mptypes){
    var first$261=values$260.getFirst();
    var first$262;
    if((first$262=first$261)!==null){
        var max$263=first$262;
        var setMax$263=function(max$264){return max$263=max$264;};
        var it$265 = values$260.getRest().getIterator();
        var val$266;while ((val$266=it$265.next())!==getFinished()){
            if(val$266.compare(max$263).equals(getLarger())){
                max$263=val$266;
            }
        }
        return max$263;
...
exports.max=max;
function min(values$267,$$$mptypes){
    var first$268=values$267.getFirst();
    var first$269;
    if((first$269=first$268)!==null){
        var min$270=first$269;
        var setMin$270=function(min$271){return min$270=min$271;};
        var it$272 = values$267.getRest().getIterator();
        var val$273;while ((val$273=it$272.next())!==getFinished()){
            if(val$273.compare(min$270).equals(getSmaller())){
                min$270=val$273;
            }
        }
        return min$270;
...
function print(line$274){
    getProcess().writeLine((opt$275=(opt$276=line$274,opt$276!==null?opt$276.getString():null),opt$275!==null?opt$275:String$("«null»",6)));
    var opt$275,opt$276;
}
exports.print=print;
var smallest=function (x$277,y$278,$$$mptypes){
    return (opt$279=(x$277.compare(y$278).equals(getSmaller())?x$277:null),opt$279!==null?opt$279:y$278);
};
exports.smallest=smallest;
var opt$279;
function sum(values$280,$$$mptypes){
    var sum$281=values$280.getFirst();
    var setSum$281=function(sum$282){return sum$281=sum$282;};
    var it$283 = values$280.getRest().getIterator();
    var val$284;while ((val$284=it$283.next())!==getFinished()){
        (sum$281=sum$281.plus(val$284));
    }
    return sum$281;
}
exports.sum=sum;
function zip(keys$285,items$286,$$$mptypes){
    var iter$287=items$286.getIterator();
    return Comprehension(function(){
        var item$290;
        var it$288=keys$285.getIterator();
        var key$289=getFinished();
        var item$290;
        var next$key$289=function(){
            while((key$289=it$288.next())!==getFinished()){
                if(!isOfType((item$290=iter$287.next()),{t:Finished})){
                    return key$289;
                }
            }
            return getFinished();
        ...
        next$key$289();
        return function(){
            if(key$289!==getFinished()){
                var tmpvar$291=Entry(key$289,item$290,[$$$mptypes[0],$$$mptypes[1]]);
                next$key$289();
                return tmpvar$291;
            }
            return getFinished();
        }
    },[{t:Entry,a:[$$$mptypes[0],$$$mptypes[1]]}]).getSequence();
}
exports.zip=zip;
