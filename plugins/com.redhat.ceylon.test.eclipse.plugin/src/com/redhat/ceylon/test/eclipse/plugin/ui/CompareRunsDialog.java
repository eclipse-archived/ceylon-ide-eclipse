...
import static com.redhat.ceylon.test.eclipse.plugin.CeylonTestImageRegistry.STATE_FIXED;
import static com.redhat.ceylon.test.eclipse.plugin.CeylonTestImageRegistry.STATE_REGRESSED_ERROR;
import static com.redhat.ceylon.test.eclipse.plugin.CeylonTestImageRegistry.STATE_REGRESSED_FAILURE;
import static com.redhat.ceylon.test.eclipse.plugin.CeylonTestImageRegistry.STATE_REMOVED;
import static com.redhat.ceylon.test.eclipse.plugin.CeylonTestImageRegistry.STATE_UNCHANGED;
...
import static com.redhat.ceylon.test.eclipse.plugin.CeylonTestMessages.compareRunsDlgElapsedTime;
...
import static com.redhat.ceylon.test.eclipse.plugin.CeylonTestMessages.compareRunsDlgRunName;
import static com.redhat.ceylon.test.eclipse.plugin.CeylonTestMessages.compareRunsDlgShowOnly;
import static com.redhat.ceylon.test.eclipse.plugin.CeylonTestMessages.compareRunsDlgStartDate;
        ...
        testsViewer.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                ...
                if (comparedElement != null) {
                    if (comparedElement.getTestElement1() != null && comparedElement.getTestElement1().getException() != null) {
                        exception1 = comparedElement.getTestElement1().getException();
                    }
                    if (comparedElement.getTestElement2() != null && comparedElement.getTestElement2().getException() != null) {
